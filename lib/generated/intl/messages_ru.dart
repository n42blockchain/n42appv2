...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(value) => "Это ${value}";

  static String m1(value) => "Участники чата (${value})";
  ...
  static String m4(value) => "Привязка успешна. Адрес привязки: ${value}";

  static String m5(value) => "В кошельке ${value} нет сети N42chain!";

  static String m6(value) => "Сопоставление успешно. Адрес:${value}.";
  ...
  static String m11(value) => "У вас недостаточно \"${value}\"";

  static String m12(value) => "Не удалось получить аккаунт \"${value}\"";

  static String m13(value) => "Минимум ${value} XRP для первого перевода";

  static String m14(value) => "Сеть ${value} не добавлена.";

  static String m15(value) =>
      "У ${value} есть незавершённые транзакции, попробуйте позже.";

  static String m16(value) => "Адрес для ${value} не найден.";

  static String m17(value) => "Недостаточный баланс ${value}.";
  ...
  static String m25(value) => "Заблокируйте ${value} N для запуска валидатора.";

  static String m26(value) => "Импорт не удался:${value}";

  static String m27(value, value1) =>
      "${value} N каждые ${value1} добытых блоков";

  static String m28(value) => "Должно быть ${value} символов";

  static String m29(value) => "Недостаточный баланс ${value}.";

  static String m30(value) => "${value} поступает...";
  ...
  static String m32(value) => "Максимум ${value} символов";

  static String m33(value) => "Сеть ${value} уже поддерживается приложением!";
  ...
  static String m38(value) => "Ошибка ввода пароля, осталось ${value} попыток";

  static String m39(value) => "Ошибка ввода пароля, осталась ${value} попытка";

  static String m40(value) => "Введите пароль ${value}";

  static String m41(value) => "0~${value} символов";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "address_Information":
            MessageLookupByLibrary.simpleMessage("Информация об адресе"),
        ...
        "email_code_input_error":
            MessageLookupByLibrary.simpleMessage("Ошибка кода подтверждения"),
        ...
        "g_app_share_key_2":
            MessageLookupByLibrary.simpleMessage("Сканируйте для получения"),
        "g_browser_key1":
        ...
        "g_browser_key12":
            MessageLookupByLibrary.simpleMessage("Очистить кэш браузера"),
        ...
        "g_browser_key4":
            MessageLookupByLibrary.simpleMessage("Закладки ещё не добавлены"),
        ...
        "g_chat_key_1":
            MessageLookupByLibrary.simpleMessage("Начать групповой чат"),
        "g_chat_key_10": m0,
        "g_chat_key_11":
            MessageLookupByLibrary.simpleMessage("Пригласить друзей"),
        "g_chat_key_12":
            MessageLookupByLibrary.simpleMessage("Выбрать контакт"),
        "g_chat_key_13": MessageLookupByLibrary.simpleMessage("Готово"),
        "g_chat_key_14":
            MessageLookupByLibrary.simpleMessage("Выберите минимум 2 контакта"),
        ...
        "g_chat_key_22":
            MessageLookupByLibrary.simpleMessage("Распустить группу"),
        "g_chat_key_23":
        ...
        "g_chat_key_28": MessageLookupByLibrary.simpleMessage(
            "Запрос на добавление в друзья"),
        "g_chat_key_29":
            MessageLookupByLibrary.simpleMessage("Запрос в друзья одобрен"),
        "g_chat_key_3": MessageLookupByLibrary.simpleMessage("Добавлен"),
        "g_chat_key_30":
            MessageLookupByLibrary.simpleMessage("Вы добавлены в друзья"),
        ...
        "g_chat_key_34":
            MessageLookupByLibrary.simpleMessage("Удалить историю чата?"),
        "g_chat_key_35":
        ...
        "g_chat_key_49":
            MessageLookupByLibrary.simpleMessage("Удалить на моём устройстве"),
        ...
        "g_chat_key_55":
            MessageLookupByLibrary.simpleMessage("Введите причину жалобы"),
        ...
        "g_chat_key_6": m2,
        "g_chat_key_60":
            MessageLookupByLibrary.simpleMessage("Контактов пока нет"),
        "g_chat_key_61": MessageLookupByLibrary.simpleMessage("Сегодня"),
        "g_chat_key_62":
            MessageLookupByLibrary.simpleMessage("Более 3 дней назад"),
        ...
        "g_chat_key_68":
            MessageLookupByLibrary.simpleMessage("Кто-то упомянул меня"),
        ...
        "g_connect_key11":
            MessageLookupByLibrary.simpleMessage("Доступные сети"),
        "g_connect_key12":
            MessageLookupByLibrary.simpleMessage("Подпись сообщения"),
        ...
        "g_face_match_key1":
            MessageLookupByLibrary.simpleMessage("Метод сопоставления лица"),
        "g_face_match_key10": m3,
        "g_face_match_key11": m4,
        "g_face_match_key12":
            MessageLookupByLibrary.simpleMessage("Перепривязать"),
        ...
        "g_face_match_key19":
            MessageLookupByLibrary.simpleMessage("Что такое привязка лица?"),
        ...
        "g_face_match_key22":
            MessageLookupByLibrary.simpleMessage("Зачем нужна привязка лица?"),
        ...
        "g_face_match_key3":
            MessageLookupByLibrary.simpleMessage("Сопоставление не удалось!"),
        "g_face_match_key30": MessageLookupByLibrary.simpleMessage("Понятно"),
        "g_face_match_key31":
            MessageLookupByLibrary.simpleMessage("Выберите адрес кошелька"),
        ...
        "g_face_match_key5":
            MessageLookupByLibrary.simpleMessage("Ошибка адреса!"),
        "g_face_match_key6": MessageLookupByLibrary.simpleMessage(
            "Привязка биометрических данных лица"),
        "g_face_match_key7":
            MessageLookupByLibrary.simpleMessage("Сопоставление лица"),
        "g_face_match_key8":
            MessageLookupByLibrary.simpleMessage("Выбрать заново"),
        "g_face_match_key9":
            MessageLookupByLibrary.simpleMessage("Сопоставить"),
        ...
        "g_key_179":
            MessageLookupByLibrary.simpleMessage("Это мой адрес кошелька"),
        ...
        "g_key_205":
            MessageLookupByLibrary.simpleMessage("Нет доступа к фотоальбому."),
        ...
        "g_key_208":
            MessageLookupByLibrary.simpleMessage("Синхронизация балансов..."),
        "g_key_209": MessageLookupByLibrary.simpleMessage("Приватный ключ"),
        "g_key_21":
            MessageLookupByLibrary.simpleMessage("Введите пароль кошелька"),
        "g_key_210":
            MessageLookupByLibrary.simpleMessage("Ошибка приватного ключа"),
        ...
        "g_key_41":
            MessageLookupByLibrary.simpleMessage("Введите адрес кошелька"),
        ...
        "g_key_error_1301":
            MessageLookupByLibrary.simpleMessage("Неверный аккаунт или пароль"),
        "g_key_error_14":
            MessageLookupByLibrary.simpleMessage("Ошибка запроса"),
        ...
        "g_key_error_17":
            MessageLookupByLibrary.simpleMessage("Сервис не реализован"),
        ...
        "g_key_error_24":
            MessageLookupByLibrary.simpleMessage("Слишком частые запросы"),
        "g_key_error_25":
            MessageLookupByLibrary.simpleMessage("Ошибка декодирования"),
        "g_key_error_26":
            MessageLookupByLibrary.simpleMessage("Транзакция уже в блокчейне"),
        ...
        "g_key_ex_keystore":
            MessageLookupByLibrary.simpleMessage("Экспорт Keystore"),
        ...
        "g_key_ex_keystore_12":
            MessageLookupByLibrary.simpleMessage("Копирование отменено"),
        "g_key_ex_keystore_13":
            MessageLookupByLibrary.simpleMessage("Идентификационный кошелёк"),
        "g_key_ex_keystore_15": MessageLookupByLibrary.simpleMessage(
            "Зашифрованный файл приватного ключа."),
        "g_key_ex_keystore_16":
            MessageLookupByLibrary.simpleMessage("Метод импорта"),
        "g_key_ex_keystore_17":
            MessageLookupByLibrary.simpleMessage("Файл Keystore"),
        "g_key_ex_keystore_18": MessageLookupByLibrary.simpleMessage(
            "Введите информацию Keystore."),
        "g_key_ex_keystore_19":
            MessageLookupByLibrary.simpleMessage("Экспорт приватного ключа"),
        ...
        "g_key_ex_keystore_5":
            MessageLookupByLibrary.simpleMessage("Сохранить офлайн"),
        ...
        "g_key_feedback_2":
            MessageLookupByLibrary.simpleMessage("Есть незагруженные вложения"),
        "g_key_feedback_3":
            MessageLookupByLibrary.simpleMessage("Отправка не удалась"),
        "g_key_feedback_4":
            MessageLookupByLibrary.simpleMessage("Успешно отправлено"),
        ...
        "g_key_feedback_8":
            MessageLookupByLibrary.simpleMessage("Нажмите для повтора"),
        "g_key_feedback_9":
        ...
        "g_key_m_2":
            MessageLookupByLibrary.simpleMessage("Рыночная капитализация"),
        "g_key_m_3": MessageLookupByLibrary.simpleMessage("Объём торгов"),
        "g_key_m_4":
            MessageLookupByLibrary.simpleMessage("Общий объём эмиссии"),
        ...
        "g_key_mnemonic":
            MessageLookupByLibrary.simpleMessage("Введите сид-фразу"),
        ...
        "g_key_nft_41":
            MessageLookupByLibrary.simpleMessage("Транзакция отправлена"),
        "g_key_nft_47": MessageLookupByLibrary.simpleMessage("Выбрать видео"),
        "g_key_personal_1":
            MessageLookupByLibrary.simpleMessage("Выбрать из галереи телефона"),
        "g_key_share_code":
            MessageLookupByLibrary.simpleMessage("Поделиться QR-кодом"),
        "g_key_share_link":
            MessageLookupByLibrary.simpleMessage("Поделиться ссылкой"),
        "g_key_share_method":
            MessageLookupByLibrary.simpleMessage("Способ распространения"),
        ...
        "g_key_squad_k25":
            MessageLookupByLibrary.simpleMessage("Поиск по email"),
        "g_key_t_1": MessageLookupByLibrary.simpleMessage("Завершено"),
        "g_key_t_15": MessageLookupByLibrary.simpleMessage("Цена газа"),
        "g_key_t_16":
            MessageLookupByLibrary.simpleMessage("Макс. комиссия за газ"),
        "g_key_t_17":
            MessageLookupByLibrary.simpleMessage("Макс. плата за единицу газа"),
        ...
        "g_key_t_34":
            MessageLookupByLibrary.simpleMessage("Неверный пароль кошелька"),
        "g_key_t_35": MessageLookupByLibrary.simpleMessage(
            "Пожалуйста, введите пароль кошелька"),
        "g_key_t_36":
            MessageLookupByLibrary.simpleMessage("Ставка комиссии за газ"),
        ...
        "g_key_t_45": m12,
        "g_key_t_46":
            MessageLookupByLibrary.simpleMessage("Проверка адреса получателя"),
        ...
        "g_key_u_12":
            MessageLookupByLibrary.simpleMessage("Типы пользователей"),
        "g_key_u_13": MessageLookupByLibrary.simpleMessage("Веб-сайт"),
        "g_key_u_14":
            MessageLookupByLibrary.simpleMessage("Ссылка на продукты"),
        ...
        "g_key_u_23":
            MessageLookupByLibrary.simpleMessage("Не удалось загрузить аватар"),
        "g_key_u_3": MessageLookupByLibrary.simpleMessage("Описание"),
        "g_key_u_5":
            MessageLookupByLibrary.simpleMessage("Информация об артисте"),
        "g_key_u_6":
            MessageLookupByLibrary.simpleMessage("Вы не являетесь артистом"),
        ...
        "g_key_user_p1":
            MessageLookupByLibrary.simpleMessage("Я прочитал и принимаю "),
        "g_key_user_p2":
        ...
        "g_key_v_k1":
            MessageLookupByLibrary.simpleMessage("Найдена последняя версия"),
        "g_key_v_k2": MessageLookupByLibrary.simpleMessage("Обновить сейчас"),
        "g_key_v_k3":
            MessageLookupByLibrary.simpleMessage("Найдена новая версия"),
        "g_key_v_k4":
            MessageLookupByLibrary.simpleMessage("У вас последняя версия"),
        "g_key_wallet_c10":
            MessageLookupByLibrary.simpleMessage("Просмотр сид-фразы"),
        ...
        "g_key_wallet_c13":
            MessageLookupByLibrary.simpleMessage("Импорт аккаунта"),
        "g_key_wallet_c14":
        ...
        "g_key_wallet_c21":
            MessageLookupByLibrary.simpleMessage("Создать напрямую"),
        "g_key_wallet_c22":
            MessageLookupByLibrary.simpleMessage("Успешно создано"),
        ...
        "g_key_wallet_c24":
            MessageLookupByLibrary.simpleMessage("Экспортировать keystore"),
        ...
        "g_key_wallet_c32":
            MessageLookupByLibrary.simpleMessage("Добавить кошелёк"),
        "g_key_wallet_c33": MessageLookupByLibrary.simpleMessage(
            "Создать кошелёк с помощью сид-фразы."),
        "g_key_wallet_c34":
            MessageLookupByLibrary.simpleMessage("Введите название кошелька"),
        ...
        "g_key_wallet_c37":
            MessageLookupByLibrary.simpleMessage("Установить пароль кошелька"),
        ...
        "g_key_wallet_c46":
            MessageLookupByLibrary.simpleMessage("Подтверждение сид-фразы"),
        "g_key_wallet_c47":
            MessageLookupByLibrary.simpleMessage("Информация о кошельке"),
        "g_key_wallet_c48":
            MessageLookupByLibrary.simpleMessage("Название кошелька"),
        "g_key_wallet_c49": MessageLookupByLibrary.simpleMessage(
            "Сначала сделайте резервную копию сид-фразы кошелька!"),
        "g_key_wallet_c6":
            MessageLookupByLibrary.simpleMessage("Проверка сид-фразы"),
        "g_key_wallet_c7": MessageLookupByLibrary.simpleMessage(
            "Теперь введите вашу сид-фразу."),
        "g_key_wallet_c8":
            MessageLookupByLibrary.simpleMessage("Установить фразу"),
        ...
        "g_key_wallet_edit":
            MessageLookupByLibrary.simpleMessage("Редактирование кошелька"),
        ...
        "g_key_wallet_m13":
            MessageLookupByLibrary.simpleMessage("Подтвердите выход"),
        ...
        "g_key_wallet_m22":
            MessageLookupByLibrary.simpleMessage("Импорт кошелька"),
        "g_key_wallet_m3": m16,
        "g_key_wallet_m4": MessageLookupByLibrary.simpleMessage(
            "Недостаточный баланс текущего токена."),
        "g_key_wallet_m5": m17,
        "g_key_wallet_m6":
            MessageLookupByLibrary.simpleMessage("Ошибка подписи"),
        "g_key_wallet_m8":
        ...
        "g_key_wallet_manage":
            MessageLookupByLibrary.simpleMessage("Управление кошельком"),
        ...
        "g_key_xml_11": m18,
        "g_key_xml_2":
            MessageLookupByLibrary.simpleMessage("Инкрементный резерв"),
        "g_key_xml_22": m19,
        ...
        "g_lock_key1":
            MessageLookupByLibrary.simpleMessage("Touch ID и Face ID"),
        ...
        "g_lock_key15":
            MessageLookupByLibrary.simpleMessage("Пароли и биометрия"),
        "g_lock_key16":
            MessageLookupByLibrary.simpleMessage("Графический пароль"),
        ...
        "g_lock_key21": m21,
        "g_lock_key22":
            MessageLookupByLibrary.simpleMessage("Сбросить графический пароль"),
        "g_lock_key23": MessageLookupByLibrary.simpleMessage(
            "Слишком много неверных попыток, сбросьте пароль"),
        "g_lock_key24":
            MessageLookupByLibrary.simpleMessage("Добавить пароль кошелька?"),
        "g_lock_key25": m22,
        ...
        "g_mining_key20":
            MessageLookupByLibrary.simpleMessage("Разблокировать N?"),
        ...
        "g_mining_key_10":
            MessageLookupByLibrary.simpleMessage("Сегодняшнее вознаграждение"),
        ...
        "g_mining_key_101":
            MessageLookupByLibrary.simpleMessage("Копировать данные"),
        "g_mining_key_102": MessageLookupByLibrary.simpleMessage("Неактивен"),
        "g_mining_key_103":
            MessageLookupByLibrary.simpleMessage("Список валидаторов"),
        "g_mining_key_104":
            MessageLookupByLibrary.simpleMessage("Импорт успешен"),
        ...
        "g_mining_key_11":
            MessageLookupByLibrary.simpleMessage("Вчерашние вознаграждения"),
        "g_mining_key_110":
            MessageLookupByLibrary.simpleMessage("Зашифрованные данные"),
        "g_mining_key_111":
            MessageLookupByLibrary.simpleMessage("Импорт файлов"),
        ...
        "g_mining_key_13":
            MessageLookupByLibrary.simpleMessage("Всего вознаграждений"),
        "g_mining_key_14":
            MessageLookupByLibrary.simpleMessage("Добытая стоимость"),
        ...
        "g_mining_key_35":
            MessageLookupByLibrary.simpleMessage("Дневной лимит"),
        "g_mining_key_36": MessageLookupByLibrary.simpleMessage("Скорость"),
        "g_mining_key_37":
            MessageLookupByLibrary.simpleMessage("Планы верификации"),
        "g_mining_key_38":
        ...
        "g_mining_key_5":
            MessageLookupByLibrary.simpleMessage("Статус верификации"),
        ...
        "g_mining_key_66":
            MessageLookupByLibrary.simpleMessage("Продвинутая нода"),
        "g_mining_key_67":
            MessageLookupByLibrary.simpleMessage("Начальная нода"),
        "g_mining_key_68": MessageLookupByLibrary.simpleMessage("Про нода"),
        "g_mining_key_69":
            MessageLookupByLibrary.simpleMessage("500 блоков/день~70 мин"),
        "g_mining_key_7": MessageLookupByLibrary.simpleMessage("Выберите план"),
        "g_mining_key_70":
            MessageLookupByLibrary.simpleMessage("100 блоков/день~15 мин"),
        "g_mining_key_71": m27,
        "g_mining_key_72":
            MessageLookupByLibrary.simpleMessage("128 секунд на проверку"),
        ...
        "g_mining_key_81":
            MessageLookupByLibrary.simpleMessage("Список валидаторов"),
        "g_mining_key_82":
            MessageLookupByLibrary.simpleMessage("Импорт валидатора"),
        "g_mining_key_83":
        ...
        "g_mining_key_89":
            MessageLookupByLibrary.simpleMessage("Советы по безопасности"),
        "g_mining_key_9":
            MessageLookupByLibrary.simpleMessage("Фоновая верификация"),
        ...
        "g_mining_key_95":
            MessageLookupByLibrary.simpleMessage("Подтвердить и сохранить"),
        "g_mining_key_96": MessageLookupByLibrary.simpleMessage(
            "Установить пароль и зашифровать"),
        "g_mining_key_97":
            MessageLookupByLibrary.simpleMessage("Введите пароль шифрования"),
        "g_mining_key_98": m28,
        ...
        "g_share_v3_key_4":
            MessageLookupByLibrary.simpleMessage("Получите до "),
        "g_share_v3_key_5": MessageLookupByLibrary.simpleMessage(
            " N, когда ваш реферал начнёт верификацию!"),
        "g_share_v3_key_6":
            MessageLookupByLibrary.simpleMessage("Пригласить через"),
        ...
        "g_swap_key_24":
            MessageLookupByLibrary.simpleMessage("Подтверждение платежа"),
        "g_swap_key_25":
            MessageLookupByLibrary.simpleMessage("К распределению"),
        ...
        "g_swap_key_5":
            MessageLookupByLibrary.simpleMessage("Предпросмотр обмена"),
        ...
        "g_token_m_key_12":
            MessageLookupByLibrary.simpleMessage("Поиск токена"),
        "g_token_m_key_13":
            MessageLookupByLibrary.simpleMessage("Название сети"),
        ...
        "g_token_m_key_16":
            MessageLookupByLibrary.simpleMessage("Десятичные знаки"),
        ...
        "g_token_m_key_20":
            MessageLookupByLibrary.simpleMessage("Добавить токены"),
        "g_token_m_key_21":
            MessageLookupByLibrary.simpleMessage("Ошибка формата!"),
        "g_token_m_key_22": m33,
        "g_token_m_key_23": m34,
        "g_token_m_key_24": m35,
        "g_token_m_key_3":
            MessageLookupByLibrary.simpleMessage("Импорт токенов"),
        "g_token_m_key_4": MessageLookupByLibrary.simpleMessage("Все сети"),
        "g_token_m_key_5":
            MessageLookupByLibrary.simpleMessage("Пользовательский токен"),
        "g_token_m_key_6": MessageLookupByLibrary.simpleMessage("Адрес токена"),
        "g_token_m_key_7":
            MessageLookupByLibrary.simpleMessage("Символ токена"),
        "g_token_m_key_8":
            MessageLookupByLibrary.simpleMessage("Десятичные знаки токена"),
        "g_token_m_key_9":
            MessageLookupByLibrary.simpleMessage("Импортировать"),
        "g_unlock_key10": m36,
        ...
        "g_unlock_key6": m38,
        "g_unlock_key7":
            MessageLookupByLibrary.simpleMessage("Аутентификация не удалась"),
        "g_unlock_key8": m39,
        "g_unlock_key9":
            MessageLookupByLibrary.simpleMessage("Вы также можете "),
        "google_verification":
            MessageLookupByLibrary.simpleMessage("Google Аутентификация"),
        "google_verification_message10":
            MessageLookupByLibrary.simpleMessage("Связать"),
        ...
        "google_verification_message12":
            MessageLookupByLibrary.simpleMessage("Инструкции"),
        ...
        "google_verification_message17":
            MessageLookupByLibrary.simpleMessage("Резервный ключ"),
        ...
        "google_verification_message8":
            MessageLookupByLibrary.simpleMessage("Скачать и установить"),
        ...
        "importantNotice":
            MessageLookupByLibrary.simpleMessage("Важное уведомление"),
        ...
        "login_invite_code":
            MessageLookupByLibrary.simpleMessage("Реферальный код"),
        ...
        "login_message_10":
            MessageLookupByLibrary.simpleMessage("Успешно создано"),
        "login_message_11":
            MessageLookupByLibrary.simpleMessage("Успешно сброшено"),
        "login_message_2":
            MessageLookupByLibrary.simpleMessage("Уже есть аккаунт? "),
        "login_message_6": MessageLookupByLibrary.simpleMessage(
            "Отправить код повторно через "),
        "login_message_7":
            MessageLookupByLibrary.simpleMessage("Код успешно отправлен"),
        "login_message_8":
            MessageLookupByLibrary.simpleMessage("E-mail не зарегистрирован"),
        "login_message_9":
        ...
        "rest_Verification_code":
            MessageLookupByLibrary.simpleMessage("OTP-код"),
        "rest_your_password":
        ...
        "s_key_12":
            MessageLookupByLibrary.simpleMessage("Использовать новый чат"),
        "s_key_13":
            MessageLookupByLibrary.simpleMessage("Включить улучшенный чат"),
