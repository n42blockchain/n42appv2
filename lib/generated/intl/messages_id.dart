...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(value) => "Mohon buka aplikasi ${value} di perangkat Anda";

  static String m18(value) => "${value} poin untuk tingkat berikutnya";
  ...
  static String m21(value) => "${value} hari tersisa";

  static String m22(value) => "${value} days remaining";

  static String m23(value) => "Anda tidak memiliki cukup \"${value}\"";

  static String m24(value) => "Gagal mendapatkan akun \"${value}\"";

  static String m25(value) => "Minimum ${value} XRP untuk transfer pertama";

  static String m26(value) => "Verification code sent to ${value}";

  static String m27(value) => "Jaringan ${value} belum ditambahkan.";

  static String m28(value) =>
      "${value} memiliki transaksi yang belum selesai, silakan coba lagi nanti.";

  static String m29(value) => "Tidak ditemukan alamat untuk ${value}.";
  ...
  static String m38(value) => "Kunci ${value} N untuk menjalankan validator.";

  static String m39(value) => "Impor gagal:${value}";
  ...
  static String m42(value) => "Harus ${value} karakter";

  static String m43(value) => "Saldo ${value} Tidak Mencukupi.";

  static String m44(value) => "${value} masuk...";
  ...
  static String m46(value) => "Maksimal ${value} karakter";

  static String m47(value) => "Jaringan ${value} sudah didukung APP!";

  static String m48(value) =>
      "Jaringan ${value} sudah didukung APP, apakah Anda ingin menambahkannya?";

  static String m49(value) => "Uji tautan alamat ${value} gagal!";

  static String m50(value) => "Aplikasi akan terbuka dalam ${value} detik.";
  ...
  static String m54(value) => "Masukkan kata sandi ${value}";

  static String m55(value) => "0~${value} karakter";
