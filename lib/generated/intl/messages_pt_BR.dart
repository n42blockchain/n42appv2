...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m29(amount, symbol, network) =>
      "Solicite ${amount} ${symbol} na ${network}";

  static String m30(value) =>
      "Remover rede personalizada ${value}? Os saldos nesta rede não serão mais exibidos. Seus ativos na cadeia não são afetados.";
  ...
  static String m75(value) =>
      "O RPC informa o ID de Rede ${value}, que não corresponde ao valor que você digitou.";
  ...
  static String m81(value) => "Linha ${value}: campos ausentes";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "g_aggregate_cached_balance": MessageLookupByLibrary.simpleMessage(
      "Saldo salvo · falha ao atualizar",
    ),
    ...
    "g_aggregate_mainnet_note": MessageLookupByLibrary.simpleMessage(
      "Apenas saldos da rede principal. Consultas de rede ausentes ou com falha não são contabilizadas como saldo zero.",
    ),
    ...
    "g_aggregate_unavailable": MessageLookupByLibrary.simpleMessage(
      "Este ativo não está mais disponível na carteira selecionada. Volte à carteira para escolher um ativo.",
    ),
    ...
    "g_audit_activity_local": MessageLookupByLibrary.simpleMessage(
      "Histórico local de transações em suas carteiras. Abra um ativo para sincronizar sua atividade mais recente.",
    ),
    ...
    "g_audit_manage_wallets": MessageLookupByLibrary.simpleMessage(
      "Crie, importe e gerencie carteiras",
    ),
    ...
    "g_dex_account_unavailable": MessageLookupByLibrary.simpleMessage(
      "Selecione uma carteira principal com fundos disponíveis para esta rede. Contas somente para visualização não podem assinar trocas.",
    ),
    ...
    "g_dex_history_record_failed": MessageLookupByLibrary.simpleMessage(
      "Troca enviada, mas o histórico não pôde ser atualizado. Não envie novamente.",
    ),
    ...
    "g_history_export_all": MessageLookupByLibrary.simpleMessage(
      "Exportar registros locais correspondentes (CSV)",
    ),
    ...
    "g_history_local_scope": MessageLookupByLibrary.simpleMessage(
      "Filtros e exportação CSV incluem todos os registros correspondentes salvos neste dispositivo. Abra o ativo para sincronizar atividades mais recentes na blockchain.",
    ),
    ...
    "g_key_aa_paymaster_unavailable": MessageLookupByLibrary.simpleMessage(
      "O financiamento de gás ainda não está disponível. Por favor, pague as taxas de gás com o saldo da sua conta.",
    ),
    ...
    "g_key_airdrop_expired": MessageLookupByLibrary.simpleMessage("Encerrado"),
    ...
    "g_key_airdrop_sources_hint": MessageLookupByLibrary.simpleMessage(
      "Abra Fontes para navegar nos diretórios de campanhas mantidos pelos provedores.",
    ),
    ...
    "g_key_dex_untrusted_router": MessageLookupByLibrary.simpleMessage(
      "Troca bloqueada: o endereço do roteador não é reconhecido. Por segurança, esta transação foi cancelada.",
    ),
    ...
    "g_key_msgsign_input_hint": MessageLookupByLibrary.simpleMessage(
      "Digite a mensagem para assinar",
    ),
    ...
    "g_key_msgsign_unsupported": MessageLookupByLibrary.simpleMessage(
      "Assinatura de mensagem ainda não é suportada para esta cadeia",
    ),
    ...
    "g_key_stake_broadcast_unsupported": MessageLookupByLibrary.simpleMessage(
      "Transação criada, mas o envio direto na carteira para esta rede ainda não é suportado.",
    ),
    ...
    "g_ui_algo_asset_add_fee": MessageLookupByLibrary.simpleMessage(
      "Adicionar este ativo exige uma taxa de rede. Toque em Adicionar para continuar.",
    ),
    ...
    "g_ui_backup_create_save": MessageLookupByLibrary.simpleMessage(
      "Criar e Salvar Backup",
    ),
    "g_ui_backup_empty": MessageLookupByLibrary.simpleMessage(
      "Nenhuma carteira encontrada no arquivo de backup",
    ),
    "g_ui_backup_encryption_hint": MessageLookupByLibrary.simpleMessage(
      "Seu backup está criptografado com AES-256 + PBKDF2. Apenas a senha correta pode restaurá-lo.",
    ),
    "g_ui_backup_enter_password": MessageLookupByLibrary.simpleMessage(
      "Por favor, insira a senha de backup",
    ),
    ...
    "g_ui_backup_import_failed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível restaurar o backup. Verifique a senha e o arquivo de backup, depois tente novamente.",
    ),
    ...
    "g_ui_backup_invalid_file": MessageLookupByLibrary.simpleMessage(
      "Não é um arquivo de backup válido da N42Wallet",
    ),
    ...
    "g_ui_backup_password_repeat": MessageLookupByLibrary.simpleMessage(
      "Digite novamente a senha de backup",
    ),
    "g_ui_backup_restore_hint": MessageLookupByLibrary.simpleMessage(
      "Restaure suas carteiras a partir de um backup criptografado armazenado no iCloud Drive ou no Google Drive.",
    ),
    ...
    "g_ui_backup_restore_password_hint": MessageLookupByLibrary.simpleMessage(
      "Insira a senha usada ao criar o backup",
    ),
    ...
    "g_ui_backup_warning": MessageLookupByLibrary.simpleMessage(
      "Este backup contém suas chaves privadas / frases mnemônicas, senhas da carteira e configurações da carteira. Mantenha o arquivo de backup e a senha em segurança. Nunca compartilhe com ninguém.",
    ),
    "g_ui_balance_value": m78,
    "g_ui_base_fee_value": m79,
    "g_ui_buy_n_description": MessageLookupByLibrary.simpleMessage(
      "Comprar N por meio do protocolo N42",
    ),
    ...
    "g_ui_camera_permission": MessageLookupByLibrary.simpleMessage(
      "É necessário permitir o uso da câmera para escanear um código.",
    ),
    ...
    "g_ui_csv_header_only": MessageLookupByLibrary.simpleMessage(
      "Nenhuma linha de dados encontrada (apenas o cabeçalho detectado).",
    ),
    ...
    "g_ui_email_code_sent": MessageLookupByLibrary.simpleMessage(
      "Solicitação de código de verificação enviada",
    ),
    ...
    "g_ui_expires_in": MessageLookupByLibrary.simpleMessage("Vence em:"),
    ...
    "g_ui_free_margin": MessageLookupByLibrary.simpleMessage("Livre"),
    ...
    "g_ui_mpc_intro": MessageLookupByLibrary.simpleMessage(
      "Faça login com sua conta social para criar uma carteira segura com MPC. Sua chave privada é dividida em partes criptografadas — sem frase de recuperação para perder.",
    ),
    ...
    "g_ui_mpc_security": MessageLookupByLibrary.simpleMessage(
      "Funciona com MPC-TSS. Sua chave é dividida em 3 partes criptografadas, distribuídas entre seu dispositivo, nossos servidores e um backup de recuperação.",
    ),
    ...
    "g_ui_no_cached_email": MessageLookupByLibrary.simpleMessage(
      "Nenhum e-mail está armazenado em cache neste dispositivo",
    ),
    ...
    "g_ui_read_only": MessageLookupByLibrary.simpleMessage("Somente leitura"),
    ...
    "g_ui_token_lookup": MessageLookupByLibrary.simpleMessage(
      "Procurando informações do token…",
    ),
    ...
    "g_ui_trade_delete_failed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível excluir a negociação. Tente novamente.",
    ),
    "g_ui_trade_save_failed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível salvar a negociação. Tente novamente.",
    ),
    ...
    "g_xrp_dest_tag_hint": MessageLookupByLibrary.simpleMessage(
      "Geralmente obrigatório ao enviar para uma corretora",
    ),
    ...
    "push_bg_delivery_dialog_content": MessageLookupByLibrary.simpleMessage(
      "Este dispositivo restringe aplicativos em segundo plano, portanto, você pode perder mensagens de chat e alertas de transferência quando o app estiver em segundo plano ou fechado.\n\nToque em \"Ir para Configurações\" para permitir atividade em segundo plano, depois habilite o Início Automático para este app.",
    ),
    "push_bg_delivery_dialog_title": MessageLookupByLibrary.simpleMessage(
      "Entrega em Segundo Plano Pode Ser Limitada",
    ),
    ...
    "push_permission_dialog_content": MessageLookupByLibrary.simpleMessage(
      "As notificações push estão desativadas. Você pode perder mensagens de chat e alertas de transferência.\n\nAtive as notificações para este aplicativo nas configurações do sistema.",
    ),
