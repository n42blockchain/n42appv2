...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(s) => "Tuma tena kwa ${s}s";

  static String m4(message) => "Ununuzi umeshindwa: ${message}";

  static String m5(productId) => "Ununuzi umefanikiwa: ${productId}";

  static String m6(productId) => "Imerudishwa: ${productId}";

  static String m7(value) => "Kiasi kikubwa kuliko ${value}.";

  static String m8(value) => "Pochi tayari ipo, jina la pochi ni \"${value}\"";

  static String m9(value) => "Weka kiasi zaidi ya ${value}.";

  static String m10(value) => "Nakala ya anwani katika safu mlalo ${value}";

  static String m11(value) =>
      "Salio lisilotosha: jumla ya kiasi kingezidi ${value} inayopatikana";

  static String m12(value) => "Anwani batili kwenye safu mlalo ${value}";

  static String m13(value) => "Kiasi kisicho sahihi katika safu mlalo ${value}";

  static String m14(value) => "Kiwango cha juu zaidi cha wapokeaji wa ${value}";

  static String m15(token) => "Idhinisha ${token} ili kuendelea";

  static String m16(impact) =>
      "Athari ya bei ya juu (${impact})! Endelea kwa tahadhari.";

  static String m17(secs) => "Muda wa Nukuu unaisha katika ${secs}s";

  static String m18(value) => "Pata hadi ${value}% APY";

  static String m19(value) => "Onyesha upya kiotomatiki kila sekunde ${value}";

  static String m20(address) => "Akaunti ${address} imeongezwa";

  static String m21(address, network) =>
      "Je, ungependa kufuatilia akaunti hii ya pochi ya maunzi?\n\nAnwani: ${address}\nMtandao: ${network}";

  static String m22(app) => "Programu ya sasa: ${app}";

  static String m23(days) => "${days} siku zilizopita";

  static String m24(value) => "Imeshindwa kuleta akaunti: ${value}";

  static String m25(date) => "Mara ya mwisho kuunganishwa: ${date}";
  ...
  static String m54(symbol) => "Kiasi (${symbol})";

  static String m55(amount, symbol) => "Salio: ${amount} ${symbol}";

  static String m56(label) =>
      "Tangaza “${label}” mshindi na utatue? Haiwezi kutenduliwa.";

  static String m57(n) => "dakika ${n}";

  static String m58(n) => "Tokeo ${n}";

  static String m59(label, pct) => "${label} inashinda (${pct}%)";

  static String m60(shares, avg, after) =>
      "Kadirio ${shares} hisa · wastani ${avg}% · baada ${after}%";

  static String m61(label) => "Tokeo: ${label}";

  static String m62(n) => "Uza ${n}";

  static String m63(value) => "${value} Salio Lililotosha.";

  static String m64(value) => "${value} zinazoingia...";
  ...
  static String m66(value) => "Upeo wa herufi ${value}";

  static String m67(value) => "${value} mnyororo APP tayari inatumika!";
  ...
  static String m70(value) => "0~${value} herufi";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "g_pred_close_only": MessageLookupByLibrary.simpleMessage("Funga tu"),
    "g_pred_closed_waiting": MessageLookupByLibrary.simpleMessage(
      "Imefungwa, inasubiri matokeo",
    ),
    ...
    "g_pred_processing": MessageLookupByLibrary.simpleMessage("Inachakata…"),
    "g_pred_publish": MessageLookupByLibrary.simpleMessage("Chapisha"),
    ...
    "g_pred_yes": MessageLookupByLibrary.simpleMessage("Ndiyo"),
