...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(value) => "${value} days left";

  static String m17(value) => "Duplicate address at row ${value}";

  static String m72(value) =>
      "Insufficient balance: total amount would exceed available ${value}";

  static String m18(value) => "Invalid address at row ${value}";

  static String m19(value) => "Invalid amount at row ${value}";

  static String m20(value) => "Maximum ${value} recipients";
  ...
  static String m26(value) => "Please open the ${value} app on your device";

  static String m27(value) => "Earn ${value} points";

  static String m28(value) => "Earn ${value} points for each friend who joins!";

  static String m29(value) => "${value} points to next tier";
  ...
  static String m34(value) => "${value} days left";
  ...
  static String m43(value) => "No ${value} chain added.";

  static String m44(value) =>
      "${value} has unfinished transactions, please try again later.";

  static String m45(value) => "No address found for ${value}.";

  static String m46(value) => "Insufficient balance of ${value}.";
  ...
  static String m54(value) => "Lock ${value} N to run a validator.";

  static String m55(value) => "Import failed:${value}";

  static String m56(value) =>
      "A staking balance of at least ${value} is required to earn rewards.";

  static String m57(value, value1) => "${value} N every ${value1} blocks mined";

  static String m58(value) => "Must be ${value} characters";

  static String m59(value) => "${value} Insufficient Balance.";

  static String m60(value) => "${value} incoming...";
  ...
  static String m62(value) => "Max ${value} characters";

  static String m63(value) => "${value} chain APP is already supported!";

  static String m64(value) =>
      "${value} chain APP is already supported, do you want to add it?";

  static String m65(value) => "${value} address test link failed!";
  ...
  static String m68(value) => "Password input error,you have ${value} chances";

  static String m69(value) => "Password input error,you have ${value} chance";

  static String m70(value) => "Enter ${value} password";

  static String m71(value) => "0~${value} characters";
