...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(value) => "I am ${value}";

  static String m4(value) => "Chat member(${value})";
  ...
  static String m9(value) => "Binding successful.Binding address: ${value}";

  static String m10(value) => "There is no N42chain in the ${value} wallet!";

  static String m11(value) => "Match successful.Address:${value}.";

  static String m12(message) => "Purchase failed: ${message}";

  static String m13(productId) => "Purchase successful: ${productId}";

  static String m14(productId) => "Restored: ${productId}";

  static String m15(value) => "Amount greater than ${value}.";

  static String m16(value) =>
      "The wallet already exists, the wallet name is \"${value}\"";

  static String m17(value) => "Enter an amount more than ${value}.";
  ...
  static String m23(value) => "${value} days left";

  static String m24(value) => "Duplicate address at row ${value}";

  static String m25(value) =>
      "Insufficient balance: total amount would exceed available ${value}";

  static String m26(value) => "Invalid address at row ${value}";

  static String m27(value) => "Invalid amount at row ${value}";

  static String m28(value) => "Maximum ${value} recipients";

  static String m29(token) => "Approve ${token} to continue";

  static String m30(impact) =>
      "High price impact (${impact})! Proceed with caution.";

  static String m31(secs) => "Quote expires in ${secs}s";

  static String m32(value) => "+${value} pts/day";

  static String m33(value) => "Earn up to ${value}% APY";

  static String m34(value) => "Congratulations! You now own ${value}";

  static String m35(value) => "Please wait ${value} seconds";

  static String m36(value) => "Auto-refresh every ${value} seconds";

  static String m37(address) => "Account ${address} added";

  static String m38(address, network) =>
      "Do you want to track this hardware wallet account?\n\nAddress: ${address}\nNetwork: ${network}";

  static String m39(app) => "Current app: ${app}";

  static String m40(days) => "${days} days ago";

  static String m41(value) => "Failed to import account: ${value}";

  static String m42(date) => "Last connected: ${date}";

  static String m43(value) => "Please open the ${value} app on your device";

  static String m44(app) => "Make sure the ${app} app is open on your Ledger";

  static String m45(name) =>
      "Are you sure you want to remove \"${name}\" from saved devices?";

  static String m46(value) => "Earn ${value} points";

  static String m47(value) => "Earn ${value} points for each friend who joins!";

  static String m48(value) => "${value} points to next tier";

  static String m96(time) => "Created: ${time}";

  static String m97(time) => "Last used: ${time}";

  static String m49(amount, token) => "≈ ${amount}${token}";

  static String m50(amount) => "≈ ${amount} USDT";

  static String m51(value) => "Est. gas: ~${value} units";

  static String m52(reason) => "Reason: ${reason}";
  ...
  static String m55(value) => "${value} days left";

  static String m56(value) => "${value} days remaining";

  static String m57(value) =>
      "Unstaking takes ${value} days. Your tokens will be locked during this period.";

  static String m58(value) => "You do not have enough \"${value}\"";

  static String m59(value) => "Failed to get \"${value}\" account";

  static String m60(value) => "Minimum ${value} XRP for first transfer";

  static String m61(value) => "${value}d ago";

  static String m62(value) => "${value}h ago";

  static String m63(value) => "${value}m ago";

  static String m64(count) => "Add (${count})";

  static String m65(count) =>
      "${Intl.plural(count, one: '1 new token detected', other: '${count} new tokens detected')} — tap to review";

  static String m66(value) => "Verification code sent to ${value}";

  static String m67(value) => "No ${value} chain added.";

  static String m68(value) =>
      "${value} has unfinished transactions, please try again later.";

  static String m69(value) => "No address found for ${value}.";

  static String m70(value) => "Insufficient balance of ${value}.";
  ...
  static String m79(value) => "Import failed:${value}";

  static String m80(value) =>
      "A staking balance of at least ${value} is required to earn rewards.";

  static String m81(value, value1) => "${value} N every ${value1} blocks mined";

  static String m82(value) => "Must be ${value} characters";

  static String m83(value) => "${value} Insufficient Balance.";

  static String m84(value) => "${value} incoming...";
  ...
  static String m86(value) => "Max ${value} characters";

  static String m87(value) => "${value} chain APP is already supported!";

  static String m88(value) =>
      "${value} chain APP is already supported, do you want to add it?";

  static String m89(value) => "${value} address test link failed!";
  ...
  static String m92(value) => "Password input error,you have ${value} chances";

  static String m93(value) => "Password input error,you have ${value} chance";

  static String m94(value) => "Enter ${value} password";

  static String m95(value) => "0~${value} characters";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "g_2fa_backup_share": MessageLookupByLibrary.simpleMessage("Share"),
    ...
    "g_key_aa_paymaster_sponsored_unavailable":
        MessageLookupByLibrary.simpleMessage("Sponsorship not available"),
    ...
    "g_key_aa_session_allowed": MessageLookupByLibrary.simpleMessage("Allowed"),
    ...
    "g_key_aa_session_blocked": MessageLookupByLibrary.simpleMessage("Blocked"),
    ...
    "g_key_gesture_medium": MessageLookupByLibrary.simpleMessage("Medium"),
    "g_key_gesture_strong": MessageLookupByLibrary.simpleMessage("Strong"),
    "g_key_gesture_too_simple": MessageLookupByLibrary.simpleMessage(
      "Pattern too simple, please use more nodes",
    ),
    "g_key_gesture_weak": MessageLookupByLibrary.simpleMessage("Weak"),
    ...
    "g_key_hw_cancel": MessageLookupByLibrary.simpleMessage("Cancel"),
