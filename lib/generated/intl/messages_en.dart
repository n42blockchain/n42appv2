...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(address) => "Account ${address} added";
  ...
  static String m32(value) => "Please open the ${value} app on your device";

  static String m33(app) => "Make sure the ${app} app is open on your Ledger";
  ...
  static String m37(value) => "${value} points to next tier";
  ...
  static String m42(value) => "${value} days left";
  ...
  static String m44(value) => "You do not have enough \"${value}\"";

  static String m45(value) => "Failed to get \"${value}\" account";

  static String m46(value) => "Minimum ${value} XRP for first transfer";
  ...
  static String m51(value) => "No ${value} chain added.";

  static String m52(value) =>
      "${value} has unfinished transactions, please try again later.";

  static String m53(value) => "No address found for ${value}.";

  static String m54(value) => "Insufficient balance of ${value}.";
  ...
  static String m62(value) => "Lock ${value} N to run a validator.";

  static String m63(value) => "Import failed:${value}";

  static String m64(value) =>
      "A staking balance of at least ${value} is required to earn rewards.";

  static String m65(value, value1) => "${value} N every ${value1} blocks mined";

  static String m66(value) => "Must be ${value} characters";

  static String m67(value) => "${value} Insufficient Balance.";

  static String m68(value) => "${value} incoming...";
  ...
  static String m70(value) => "Max ${value} characters";

  static String m71(value) => "${value} chain APP is already supported!";

  static String m72(value) =>
      "${value} chain APP is already supported, do you want to add it?";

  static String m73(value) => "${value} address test link failed!";
  ...
  static String m76(value) => "Password input error,you have ${value} chances";

  static String m77(value) => "Password input error,you have ${value} chance";

  static String m78(value) => "Enter ${value} password";

  static String m79(value) => "0~${value} characters";
