...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(deviceName, os) =>
      "آپ کا اکاؤنٹ ابھی ابھی ${deviceName} (${os}) پر لاگ ان ہوا تھا۔ اگر یہ آپ نہیں تھے تو ہم اپنا پاس ورڈ تبدیل کرنے کی تجویز کرتے ہیں۔";

  static String m1(price) => "موجودہ قیمت: \$${price}";
  ...
  static String m28(value) => "${value} پوائنٹس کمائیں";

  static String m29(amount, symbol, network) =>
      "${network} پر ${amount} ${symbol} کی درخواست کریں";

  static String m30(value) =>
      "کسٹم نیٹ ورک ${value} ہٹائیں؟ اس نیٹ ورک کے بیلنس اب نہیں دکھائے جائیں گے۔ چین پر موجود آپ کے اثاثے متاثر نہیں ہوں گے۔";

  static String m31(value) => "تخمینہ گیس: ~${value} یونٹس";

  static String m32(reason) => "وجہ: ${reason}";

  static String m33(value) => "${value}d انبانڈ";

  static String m34(value) => "${value} دن باقی ہیں۔";

  static String m35(value) =>
      "انسٹاک کرنے میں ${value} دن لگتے ہیں۔ اس مدت کے دوران آپ کے ٹوکن مقفل ہو جائیں گے۔";

  static String m36(value) => "آپ کے پاس کافی \"${value}\" نہیں ہے";

  static String m37(value) => "\"${value}\" اکاؤنٹ حاصل کرنے میں ناکام";

  static String m38(value) => "پہلی منتقلی کے لیے کم از کم ${value} XRP";

  static String m39(count) => "شامل کریں (${count})";

  static String m40(count) =>
      "${Intl.plural(count, one: '1 نئے ٹوکن کا پتہ چلا', other: '${count} نئے ٹوکنز کا پتہ چلا')} — جائزہ لینے کے لیے تھپتھپائیں۔";

  static String m41(value) => "کوئی ${value} سلسلہ شامل نہیں کیا گیا۔";

  static String m42(value) =>
      "${value} کے نامکمل لین دین ہیں، براہ کرم بعد میں دوبارہ کوشش کریں۔";

  static String m43(value) => "${value} کا کوئی پتہ نہیں ملا۔";

  static String m44(value) => "${value} کا ناکافی بیلنس۔";
  ...
  static String m48(message) => "روم میں داخلہ ناکام\n${message}";

  static String m49(value) => "غلط نمونہ، ${value} کوششیں باقی ہیں";

  static String m50(value) => "غلط نمونہ، ${value} کوشش باقی ہے";
  ...
  static String m54(value) => "درآمد ناکام:${value}";
  ...
  static String m57(value) => "${value} حروف کا ہونا ضروری ہے۔";

  static String m58(symbol) => "رقم (${symbol})";

  static String m59(amount, symbol) => "بیلنس: ${amount} ${symbol}";

  static String m60(label) =>
      "«${label}» کو فاتح قرار دے کر تصفیہ کریں؟ یہ واپس نہیں ہو سکتا۔";

  static String m61(n) => "${n} منٹ";

  static String m62(n) => "نتیجہ ${n}";

  static String m63(label, pct) => "${label} جیتتا ہے (${pct}%)";

  static String m64(shares, avg, after) =>
      "تخمینی ${shares} حصص · اوسط ${avg}% · بعد ${after}%";

  static String m65(reason) => "ریڈیم ناکام: ${reason}";

  static String m66(label) => "نتیجہ: ${label}";

  static String m67(n) => "فروخت ${n}";

  static String m68(value) => "${value} ناکافی بیلنس۔";

  static String m69(value) => "${value} آنے والی...";
  ...
  static String m71(value) => "زیادہ سے زیادہ ${value} حروف";

  static String m72(value) => "${value} چین اے پی پی پہلے ہی تعاون یافتہ ہے!";

  static String m73(value) =>
      "${value} چین ایپ پہلے سے ہی تعاون یافتہ ہے، کیا آپ اسے شامل کرنا چاہتے ہیں؟";

  static String m74(value) => "${value} ایڈریس ٹیسٹ لنک ناکام ہوگیا!";

  static String m75(value) =>
      "RPC کے مطابق Chain ID ${value} ہے، جو آپ کی درج کردہ قدر سے مختلف ہے۔";

  static String m76(asset, contract, address) =>
      "اثاثہ ${asset} (${contract}) اکاؤنٹ ${address} میں شامل نہیں کیا گیا۔";

  static String m77(imported, skipped) =>
      "درآمد شدہ والیٹس: ${imported}۔ چھوڑے گئے: ${skipped}۔";

  static String m78(value) => "بیلنس: ${value}";

  static String m79(value) => "بنیادی فیس: ${value} Gwei";

  static String m80(value) =>
      "کلپ بورڈ ${value} سیکنڈ بعد خود بخود صاف ہو جائے گا";

  static String m81(value) => "قطار ${value}: خانے نامکمل ہیں";

  static String m82(value) => "${value} دن";

  static String m83(value) => "${value} سے جڑ گیا";

  static String m84(value) => "گیس فیس: ${value}";

  static String m85(value) => "${value} گھنٹے";

  static String m86(value) => "درست وصول کنندگان درآمد کریں (${value})";

  static String m87(quote, base) => "حد قیمت (فی ${base}، ${quote} میں)";

  static String m88(value) => "حد قیمت ${value}";

  static String m89(value) => "مارکیٹس (${value})";

  static String m90(value) => "کم از کم بیلنس: ${value}";

  static String m91(value) => "آرڈرز (${value})";

  static String m92(value) => "پوزیشنز (${value})";

  static String m93(value) => "وصول کنندگان: ${value}";

  static String m94(value) => "ٹوکن مل گیا: ${value}";

  static String m95(value) => "ٹوکن: ${value}";

  static String m96(value) => "ٹرانزیکشن: ${value}";

  static String m97(valid, issues) => "درست: ${valid}۔ مسائل: ${issues}۔";

  static String m98(value) => "…اور مزید ${value} مسائل";

  static String m99(volume, interest) =>
      "تجارتی حجم: ${volume} · کھلے معاہدے: ${interest}";

  static String m100(value) => "والیٹ ${value}";

  static String m101(value) => "${value} گھنٹے پہلے اپ ڈیٹ ہوا";

  static String m102(value) => "${value} منٹ پہلے اپ ڈیٹ ہوا";

  static String m103(value) => "0~${value} حروف";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "copyAddress": MessageLookupByLibrary.simpleMessage("ایڈریس کاپی کریں۔"),
    "descO": MessageLookupByLibrary.simpleMessage("تفصیل (اختیاری)"),
    "device_login_change_password": MessageLookupByLibrary.simpleMessage(
      "پاس ورڈ تبدیل کریں۔",
    ),
    "device_login_dismiss": MessageLookupByLibrary.simpleMessage("سمجھ گیا"),
    ...
    "g_aggregate_cached_balance": MessageLookupByLibrary.simpleMessage(
      "محفوظ کردہ بیلنس · تازہ کرنے میں ناکامی",
    ),
    ...
    "g_aggregate_mainnet_note": MessageLookupByLibrary.simpleMessage(
      "صرف مین نیٹ کے بیلنس۔ نیٹ ورک کی نامکمل یا ناکام درخواستوں کا بیلنس صفر شمار نہیں کیا جاتا۔",
    ),
    "g_aggregate_network_balances": MessageLookupByLibrary.simpleMessage(
      "نیٹ ورک کے لحاظ سے بیلنس",
    ),
    "g_aggregate_no_mainnet": MessageLookupByLibrary.simpleMessage(
      "اس نیٹ ورک کے لیے کوئی فعال مین نیٹ اکاؤنٹ نہیں",
    ),
    ...
    "g_aggregate_unavailable": MessageLookupByLibrary.simpleMessage(
      "یہ اثاثہ منتخب والیٹ میں اب دستیاب نہیں۔ اثاثہ منتخب کرنے کے لیے والیٹ پر واپس جائیں۔",
    ),
    ...
    "g_alert_direction": MessageLookupByLibrary.simpleMessage(
      "قیمت کے وقت مجھے آگاہ کریں۔",
    ),
    "g_alert_enable": MessageLookupByLibrary.simpleMessage(
      "اس الرٹ کو فعال کریں۔",
    ),
    "g_alert_invalid_price": MessageLookupByLibrary.simpleMessage(
      "براہ کرم 0 سے زیادہ درست قیمت درج کریں۔",
    ),
    "g_alert_remove": MessageLookupByLibrary.simpleMessage("ہٹا دیں۔"),
    "g_alert_set": MessageLookupByLibrary.simpleMessage("الرٹ سیٹ کریں۔"),
    "g_alert_target_price": MessageLookupByLibrary.simpleMessage(
      "ہدف کی قیمت (USD)",
    ),
    "g_alert_title": m2,
    "g_alert_update": MessageLookupByLibrary.simpleMessage("اپ ڈیٹ الرٹ"),
    "g_app_share_key_1": MessageLookupByLibrary.simpleMessage(
      "ٹوکن صرف اسی نیٹ ورک کے اندر بھیجے جا سکتے ہیں۔ دوسرے نیٹ ورکس سے بھیجنے کے نتیجے میں نقصان ہو سکتا ہے۔",
    ),
    ...
    "g_audit_encrypted_backup": MessageLookupByLibrary.simpleMessage(
      "والیٹ کا مرموز بیک اپ برآمد کریں",
    ),
    "g_audit_funding": MessageLookupByLibrary.simpleMessage("موجودہ فنڈنگ ریٹ"),
    "g_audit_gas": MessageLookupByLibrary.simpleMessage("گیس فیس ٹریکر"),
    "g_audit_gas_desc": MessageLookupByLibrary.simpleMessage(
      "نیٹ ورک فیس اور قیمت کے الرٹس",
    ),
    "g_audit_hardware": MessageLookupByLibrary.simpleMessage("ہارڈویئر والیٹ"),
    "g_audit_load_more": MessageLookupByLibrary.simpleMessage("مزید لوڈ کریں"),
    "g_audit_mainnet": MessageLookupByLibrary.simpleMessage("مین نیٹ"),
    "g_audit_manage_settings": MessageLookupByLibrary.simpleMessage(
      "اپنے والیٹ اور ترجیحات کا انتظام کریں",
    ),
    "g_audit_manage_wallets": MessageLookupByLibrary.simpleMessage(
      "والیٹس بنائیں، درآمد کریں اور ان کا انتظام کریں",
    ),
    "g_audit_mark_price": MessageLookupByLibrary.simpleMessage("مارک پرائس"),
    ...
    "g_audit_network_desc": MessageLookupByLibrary.simpleMessage(
      "نیٹ ورکس اور RPC اینڈ پوائنٹس کا انتظام کریں",
    ),
    "g_audit_open_interest": MessageLookupByLibrary.simpleMessage(
      "کھلے معاہدوں کی مجموعی مالیت",
    ),
    "g_audit_oracle_price": MessageLookupByLibrary.simpleMessage(
      "اوریکل کی قیمت",
    ),
    "g_audit_protect_wallet": MessageLookupByLibrary.simpleMessage(
      "شناخت کی تصدیق اور والیٹ کی حفاظت",
    ),
    "g_audit_quote_changed": MessageLookupByLibrary.simpleMessage(
      "سواپ کی پیش کردہ قیمت بدل گئی ہے یا اس کی مدت ختم ہو گئی ہے۔ تصدیق سے پہلے تازہ ترین پیشکش دیکھیں۔",
    ),
    "g_audit_rate": MessageLookupByLibrary.simpleMessage(
      "N42 کی درجہ بندی کریں",
    ),
    "g_audit_rate_desc": MessageLookupByLibrary.simpleMessage(
      "ایپ اسٹور کھولیں",
    ),
    "g_audit_saved_addresses": MessageLookupByLibrary.simpleMessage(
      "وصول کنندگان کے محفوظ کردہ پتے",
    ),
    "g_audit_show_less": MessageLookupByLibrary.simpleMessage("کم دکھائیں"),
    "g_audit_testnet": MessageLookupByLibrary.simpleMessage("ٹیسٹ نیٹ"),
    "g_audit_theme_desc": MessageLookupByLibrary.simpleMessage(
      "ظاہری شکل اور ڈسپلے موڈ",
    ),
    "g_audit_volume": MessageLookupByLibrary.simpleMessage(
      "24 گھنٹے کا تجارتی حجم (USD)",
    ),
    ...
    "g_browser_key10": MessageLookupByLibrary.simpleMessage("تفصیل درج کریں۔"),
    "g_browser_key11": MessageLookupByLibrary.simpleMessage("براؤزر"),
    ...
    "g_browser_key18": MessageLookupByLibrary.simpleMessage("تاریخ"),
    "g_browser_key19": MessageLookupByLibrary.simpleMessage(
      "تمام تاریخ صاف کریں۔",
    ),
    "g_browser_key20": MessageLookupByLibrary.simpleMessage(
      "تمام براؤزنگ کی سرگزشت صاف کریں؟",
    ),
    "g_browser_key21": MessageLookupByLibrary.simpleMessage(
      "تاریخ صاف ہو گئی۔",
    ),
    "g_browser_key22": MessageLookupByLibrary.simpleMessage("آج"),
    "g_browser_key23": MessageLookupByLibrary.simpleMessage("کل"),
    "g_browser_key24": MessageLookupByLibrary.simpleMessage(
      "DApps دریافت کریں۔",
    ),
    "g_browser_key25": MessageLookupByLibrary.simpleMessage("مقبول"),
    "g_browser_key26": MessageLookupByLibrary.simpleMessage("ڈی ای ایکس"),
    "g_browser_key27": MessageLookupByLibrary.simpleMessage("ڈی فائی"),
    "g_browser_key28": MessageLookupByLibrary.simpleMessage("این ایف ٹی"),
    "g_browser_key29": MessageLookupByLibrary.simpleMessage("پل"),
    "g_browser_key3": MessageLookupByLibrary.simpleMessage("بک مارکس"),
    "g_browser_key30": MessageLookupByLibrary.simpleMessage("اوزار"),
    "g_browser_key4": MessageLookupByLibrary.simpleMessage(
      "ابھی تک کوئی بک مارکس شامل نہیں کیے گئے۔",
    ),
    "g_browser_key5": MessageLookupByLibrary.simpleMessage("بک مارک"),
    "g_browser_key6": MessageLookupByLibrary.simpleMessage("نام"),
    ...
    "g_connect_key12": MessageLookupByLibrary.simpleMessage("پیغام کا نشان"),
    "g_connect_key13": MessageLookupByLibrary.simpleMessage("جڑ رہا ہے۔"),
    "g_connect_key14": MessageLookupByLibrary.simpleMessage(
      "جوڑا بنا رہا ہے، براہ کرم انتظار کریں۔",
    ),
    "g_connect_key2": MessageLookupByLibrary.simpleMessage("منقطع کرنا"),
    "g_connect_key3": MessageLookupByLibrary.simpleMessage("رد کرنا"),
    ...
    "g_dex_account_unavailable": MessageLookupByLibrary.simpleMessage(
      "اس نیٹ ورک کے لیے ایسا مین نیٹ والیٹ منتخب کریں جس سے رقم خرچ کی جا سکے۔ صرف دیکھنے والے اکاؤنٹس سواپ پر دستخط نہیں کر سکتے۔",
    ),
    "g_dex_execution_invalid": MessageLookupByLibrary.simpleMessage(
      "ٹرانزیکشن کے پیرامیٹرز درست نہیں یا عمل ناکام ہو گیا۔ سواپ کی قیمت تازہ کریں اور دوبارہ کوشش کریں۔",
    ),
    "g_dex_history_record_failed": MessageLookupByLibrary.simpleMessage(
      "سواپ ارسال ہو گیا، لیکن ٹرانزیکشن کا ریکارڈ اپ ڈیٹ نہیں ہو سکا۔ اسے دوبارہ ارسال نہ کریں۔",
    ),
    "g_dex_smart_account_fees": MessageLookupByLibrary.simpleMessage(
      "نیٹ ورک فیس اس اسمارٹ اکاؤنٹ سے ادا کی جاتی ہے۔",
    ),
    "g_dex_spending_account": MessageLookupByLibrary.simpleMessage(
      "رقم خرچ کرنے والا اکاؤنٹ",
    ),
    "g_dex_use_smart_account": MessageLookupByLibrary.simpleMessage(
      "اسمارٹ اکاؤنٹ استعمال کریں",
    ),
    ...
    "g_google_auth_key7": MessageLookupByLibrary.simpleMessage(
      "Google Authenticator ترتیب نہیں دیا گیا",
    ),
    "g_google_auth_key8": MessageLookupByLibrary.simpleMessage("لنک کامیاب"),
    "g_history_clear_dates": MessageLookupByLibrary.simpleMessage(
      "تاریخیں صاف کریں",
    ),
    "g_history_export_all": MessageLookupByLibrary.simpleMessage(
      "مطابق مقامی ریکارڈ برآمد کریں (CSV)",
    ),
    "g_history_export_error": MessageLookupByLibrary.simpleMessage(
      "ٹرانزیکشن ہسٹری برآمد نہیں ہو سکی۔ دوبارہ کوشش کریں۔",
    ),
    "g_history_local_scope": MessageLookupByLibrary.simpleMessage(
      "فلٹرز اور CSV برآمد میں اس ڈیوائس پر محفوظ تمام مطابق ریکارڈ شامل ہیں۔ نئی آن چین سرگرمی حاصل کرنے کے لیے اثاثہ کھولیں۔",
    ),
    ...
    "g_home_market": MessageLookupByLibrary.simpleMessage("مارکیٹس"),
    "g_iap_cancelled": MessageLookupByLibrary.simpleMessage("منسوخ کر دیا"),
    ...
    "g_iap_retry": MessageLookupByLibrary.simpleMessage("دوبارہ کوشش کریں"),
    ...
    "g_key_108": MessageLookupByLibrary.simpleMessage("ایڈریس بک"),
    "g_key_11": MessageLookupByLibrary.simpleMessage("پرس درآمد کریں۔"),
    "g_key_110": MessageLookupByLibrary.simpleMessage("انتظام کریں۔"),
    "g_key_112": MessageLookupByLibrary.simpleMessage("نیا پتہ"),
    "g_key_113": MessageLookupByLibrary.simpleMessage("حذف کریں۔"),
    "g_key_115": MessageLookupByLibrary.simpleMessage("محفوظ کریں۔"),
    "g_key_119": MessageLookupByLibrary.simpleMessage("کاپی"),
    "g_key_12": MessageLookupByLibrary.simpleMessage("پرس بنائیں/درآمد کریں۔"),
    "g_key_126": MessageLookupByLibrary.simpleMessage("تھیم"),
    "g_key_127": MessageLookupByLibrary.simpleMessage("سسٹم"),
    "g_key_128": MessageLookupByLibrary.simpleMessage("روشنی"),
    "g_key_129": MessageLookupByLibrary.simpleMessage("اندھیرا"),
    ...
    "g_key_147": MessageLookupByLibrary.simpleMessage("ٹیسٹ نیٹ"),
    "g_key_148": MessageLookupByLibrary.simpleMessage("مین نیٹ"),
    "g_key_149": MessageLookupByLibrary.simpleMessage("سسٹم کی زبان"),
    ...
    "g_key_159": MessageLookupByLibrary.simpleMessage("شامل کریں۔"),
    "g_key_16": MessageLookupByLibrary.simpleMessage(
      "والٹ کی تصدیق کریں کو منتخب کریں۔",
    ),
    "g_key_163": MessageLookupByLibrary.simpleMessage("علامت"),
    "g_key_166": MessageLookupByLibrary.simpleMessage("چسپاں کریں۔"),
    "g_key_17": MessageLookupByLibrary.simpleMessage("چین کا انتخاب کریں۔"),
    "g_key_175": MessageLookupByLibrary.simpleMessage("لین دین ناکام ہو گیا۔"),
    "g_key_179": MessageLookupByLibrary.simpleMessage(
      "یہ میرے بٹوے کا پتہ ہے۔",
    ),
    "g_key_181": MessageLookupByLibrary.simpleMessage("دیگر"),
    "g_key_185": MessageLookupByLibrary.simpleMessage(
      "کامیابی کے ساتھ محفوظ ہو گیا۔",
    ),
    "g_key_191": MessageLookupByLibrary.simpleMessage("کامیابی"),
    "g_key_192": MessageLookupByLibrary.simpleMessage(
      "کیا آپ واقعی پرس کو حذف کرنا چاہتے ہیں؟",
    ),
    "g_key_193": MessageLookupByLibrary.simpleMessage("فعال"),
    "g_key_195": MessageLookupByLibrary.simpleMessage(
      "کیمرے تک رسائی کی اجازت نہیں ہے۔",
    ),
    "g_key_196": MessageLookupByLibrary.simpleMessage("ایکسپلورر"),
    "g_key_197": MessageLookupByLibrary.simpleMessage("زیادہ سے زیادہ"),
    "g_key_198": MessageLookupByLibrary.simpleMessage("اثاثے"),
    "g_key_2": MessageLookupByLibrary.simpleMessage("لیجر خالی ہے!"),
    "g_key_202": MessageLookupByLibrary.simpleMessage("لین دین کا جائزہ"),
    ...
    "g_key_207": MessageLookupByLibrary.simpleMessage("پرانا پاس ورڈ"),
    "g_key_208": MessageLookupByLibrary.simpleMessage(
      "بیلنس کی مطابقت پذیری...",
    ),
    ...
    "g_key_33": MessageLookupByLibrary.simpleMessage("وصول کریں۔"),
    "g_key_37": MessageLookupByLibrary.simpleMessage("منتقلی"),
    "g_key_38": MessageLookupByLibrary.simpleMessage("کو"),
    "g_key_4": MessageLookupByLibrary.simpleMessage("QR کوڈ اسکین کریں۔"),
    ...
    "g_key_48": MessageLookupByLibrary.simpleMessage("بھیجیں۔"),
    "g_key_5": MessageLookupByLibrary.simpleMessage("لوڈ کرنے میں ناکام!"),
    "g_key_6": MessageLookupByLibrary.simpleMessage("پرس"),
    "g_key_7": MessageLookupByLibrary.simpleMessage("بنائیں"),
    ...
    "g_key_aa_benefit_batch_desc": MessageLookupByLibrary.simpleMessage(
      "ایک لین دین میں منظوری اور تبادلہ کریں - مزید دو قدمی تصدیقات نہیں۔",
    ),
    ...
    "g_key_aa_benefit_gas_desc": MessageLookupByLibrary.simpleMessage(
      "ETH کے بجائے ERC-20 ٹوکن کے ساتھ لین دین کو سپانسر کریں یا فیس ادا کریں۔",
    ),
    "g_key_aa_benefit_gas_title": MessageLookupByLibrary.simpleMessage(
      "کسی بھی ٹوکن کے ساتھ گیس کی ادائیگی کریں۔",
    ),
    "g_key_aa_benefit_recovery_desc": MessageLookupByLibrary.simpleMessage(
      "اگر آپ اپنی نجی کلید کھو دیتے ہیں تو قابل اعتماد رابطوں کے ذریعے رسائی بحال کریں۔",
    ),
    ...
    "g_key_aa_by": MessageLookupByLibrary.simpleMessage("کی طرف سے"),
    "g_key_aa_chain": MessageLookupByLibrary.simpleMessage("زنجیر"),
    "g_key_aa_chain_id": MessageLookupByLibrary.simpleMessage("سلسلہ ID"),
    "g_key_aa_change": MessageLookupByLibrary.simpleMessage("تبدیلی"),
    ...
    "g_key_aa_error": MessageLookupByLibrary.simpleMessage("خرابی"),
    ...
    "g_key_aa_label": MessageLookupByLibrary.simpleMessage("لیبل"),
    ...
    "g_key_aa_onboard_step2": MessageLookupByLibrary.simpleMessage(
      "اسے فنڈ دیں - کوئی بھی EVM ٹوکن وصول کریں۔",
    ),
    "g_key_aa_onboard_step3": MessageLookupByLibrary.simpleMessage(
      "Paymaster کے ساتھ گیس کے بغیر لین دین کریں۔",
    ),
    "g_key_aa_operations": MessageLookupByLibrary.simpleMessage("آپریشنز"),
    "g_key_aa_owner": MessageLookupByLibrary.simpleMessage("مالک"),
    "g_key_aa_pay_gas_with_token": MessageLookupByLibrary.simpleMessage(
      "ٹوکن کے ساتھ گیس کی ادائیگی کریں۔",
    ),
    "g_key_aa_pay_gas_yourself": MessageLookupByLibrary.simpleMessage(
      "اپنے ETH سے گیس کی ادائیگی کریں۔",
    ),
    ...
    "g_key_aa_paymaster_description": MessageLookupByLibrary.simpleMessage(
      "منتخب کریں کہ آپ لین دین کی گیس فیس کی ادائیگی کیسے کرنا چاہتے ہیں۔",
    ),
    ...
    "g_key_aa_paymaster_unavailable": MessageLookupByLibrary.simpleMessage(
      "گیس فیس کی اسپانسرشپ ابھی دستیاب نہیں۔ براہ کرم اپنے اکاؤنٹ کے بیلنس سے گیس فیس ادا کریں۔",
    ),
    ...
    "g_key_aa_ready": MessageLookupByLibrary.simpleMessage("تیار"),
    ...
    "g_key_aa_revoke_confirm": MessageLookupByLibrary.simpleMessage(
      "کیا آپ واقعی اس سیشن کلید کو منسوخ کرنا چاہتے ہیں؟ مجاز DApp اب لین دین کو انجام دینے کے قابل نہیں رہے گا۔",
    ),
    "g_key_aa_revoke_session": MessageLookupByLibrary.simpleMessage(
      "سیشن کلید کو منسوخ کریں۔",
    ),
    "g_key_aa_revoked": MessageLookupByLibrary.simpleMessage(
      "سیشن کی کلید منسوخ کر دی گئی۔",
    ),
    ...
    "g_key_aa_session_full_warning": MessageLookupByLibrary.simpleMessage(
      "زیادہ خطرہ — صرف تصدیق شدہ DApps پر بھروسہ کریں۔",
    ),
    "g_key_aa_session_keys": MessageLookupByLibrary.simpleMessage("سیشن کیز"),
    "g_key_aa_session_keys_desc": MessageLookupByLibrary.simpleMessage(
      "اپنے سمارٹ اکاؤنٹ تک عارضی رسائی کے ساتھ DApps کو اختیار دیں۔",
    ),
    ...
    "g_key_address_3": MessageLookupByLibrary.simpleMessage(
      "براہ کرم سکے کی قسم منتخب کریں۔",
    ),
    ...
    "g_key_address_5": MessageLookupByLibrary.simpleMessage(
      "کامیابی کے ساتھ حذف ہو گیا۔",
    ),
    "g_key_address_6": MessageLookupByLibrary.simpleMessage("سکے منتخب کریں۔"),
    "g_key_address_7": MessageLookupByLibrary.simpleMessage("سکے تلاش کریں۔"),
    ...
    "g_key_airdrop_expired": MessageLookupByLibrary.simpleMessage("ختم شدہ"),
    "g_key_airdrop_no_airdrops": MessageLookupByLibrary.simpleMessage(
      "کوئی تصدیق شدہ مہم دستیاب نہیں",
    ),
    "g_key_airdrop_pending": MessageLookupByLibrary.simpleMessage("زیر التواء"),
    "g_key_airdrop_sources": MessageLookupByLibrary.simpleMessage("ذرائع"),
    "g_key_airdrop_sources_hint": MessageLookupByLibrary.simpleMessage(
      "فراہم کنندگان کی مرتب کردہ مہمات کی فہرستیں دیکھنے کے لیے ذرائع کھولیں۔",
    ),
    "g_key_airdrop_thirdparty_warning": MessageLookupByLibrary.simpleMessage(
      "تیسرے فریق کی مہمات بدنیتی پر مبنی ہو سکتی ہیں۔ دستخط کرنے سے پہلے منصوبے کے ڈومین اور ٹرانزیکشن کی تفصیلات کی تصدیق کریں۔",
    ),
    "g_key_airdrop_title": MessageLookupByLibrary.simpleMessage("ایئر ڈراپس"),
    "g_key_airdrop_upcoming": MessageLookupByLibrary.simpleMessage("آنے والے"),
    "g_key_badge_hot": MessageLookupByLibrary.simpleMessage("مقبول"),
    "g_key_badge_live": MessageLookupByLibrary.simpleMessage("براہِ راست"),
    ...
    "g_key_batch_confirm_title": MessageLookupByLibrary.simpleMessage(
      "بیچ ٹرانسفر کی تصدیق کریں۔",
    ),
    "g_key_batch_continue": MessageLookupByLibrary.simpleMessage("جاری رکھیں"),
    ...
    "g_key_batch_multicall_tip": MessageLookupByLibrary.simpleMessage(
      "کم گیس فیس کے لیے Multicall3 استعمال کریں۔",
    ),
    ...
    "g_key_block_explorer_optional": MessageLookupByLibrary.simpleMessage(
      "بلاک ایکسپلورر کا URL (اختیاری)",
    ),
    "g_key_bridge_chain_not_supported": MessageLookupByLibrary.simpleMessage(
      "سلسلہ تعاون یافتہ نہیں ہے۔",
    ),
    "g_key_bridge_cheapest": MessageLookupByLibrary.simpleMessage("سب سے سستا"),
    ...
    "g_key_bridge_history": MessageLookupByLibrary.simpleMessage("پل کی تاریخ"),
    "g_key_bridge_no_routes": MessageLookupByLibrary.simpleMessage(
      "کوئی راستہ دستیاب نہیں ہے۔",
    ),
    ...
    "g_key_bridge_route": MessageLookupByLibrary.simpleMessage("راستہ"),
    "g_key_bridge_search_chain": MessageLookupByLibrary.simpleMessage(
      "تلاش کا سلسلہ...",
    ),
    "g_key_bridge_select": MessageLookupByLibrary.simpleMessage("منتخب کریں۔"),
    "g_key_bridge_select_token": MessageLookupByLibrary.simpleMessage(
      "ٹوکن منتخب کریں۔",
    ),
    "g_key_bridge_slippage": MessageLookupByLibrary.simpleMessage("پھسلنا"),
    "g_key_bridge_status_completed": MessageLookupByLibrary.simpleMessage(
      "مکمل",
    ),
    "g_key_bridge_status_failed": MessageLookupByLibrary.simpleMessage("ناکام"),
    ...
    "g_key_btc_redeem_reminder": MessageLookupByLibrary.simpleMessage(
      "اپنی چھٹکارا جمع کرانے سے پہلے تصدیق کریں کہ لاک کی مدت ختم ہو گئی ہے۔",
    ),
    "g_key_btc_redeem_still_locked": MessageLookupByLibrary.simpleMessage(
      "بی ٹی سی اب بھی مقفل ہے۔",
    ),
    ...
    "g_key_btc_redeem_unlocked": MessageLookupByLibrary.simpleMessage(
      "غیر مقفل — بھنانے کے لیے تیار",
    ),
    "g_key_btc_stake_acknowledge": MessageLookupByLibrary.simpleMessage(
      "میں خطرات کو سمجھتا ہوں اور آگے بڑھنا چاہتا ہوں۔",
    ),
    ...
    "g_key_btc_stake_reminder": MessageLookupByLibrary.simpleMessage(
      "ٹائم لاک ختم ہونے تک BTC مقفل رہے گا۔ نیچے دیے گئے انٹرفیس میں اسٹیکنگ کا عمل مکمل کریں۔",
    ),
    "g_key_btc_stake_risk1": MessageLookupByLibrary.simpleMessage(
      "آپ کا BTC مکمل اسٹیکنگ مدت کے لیے مقفل کر دیا جائے گا۔ جلد واپسی ممکن نہیں ہے۔",
    ),
    "g_key_btc_stake_risk2": MessageLookupByLibrary.simpleMessage(
      "لاک کو Bitcoin OP_CHECKLOCKTIMEVERIFY (CLTV) کے ذریعے نافذ کیا گیا ہے اور اسے نظرانداز نہیں کیا جا سکتا۔",
    ),
    "g_key_btc_stake_risk3": MessageLookupByLibrary.simpleMessage(
      "سمارٹ معاہدے کا خطرہ: اگرچہ آڈٹ کیا گیا ہے، کوئی پروٹوکول مکمل طور پر خطرے سے پاک نہیں ہے۔",
    ),
    "g_key_btc_stake_risk4": MessageLookupByLibrary.simpleMessage(
      "کم از کم اسٹیکنگ: 0.001 BTC۔ کم از کم لاک پیریڈ: 0.125 دن (~3 گھنٹے)۔",
    ),
    ...
    "g_key_btc_stake_step1_desc": MessageLookupByLibrary.simpleMessage(
      "آپ کا BTC ٹائم لاک (CLTV) کے ساتھ 2-میں سے 2 ملٹی سیگ ایڈریس میں مقفل ہے، جسے آپ کی چابی اور N42 کنستر کی چابی سے محفوظ کیا گیا ہے۔",
    ),
    "g_key_btc_stake_step1_title": MessageLookupByLibrary.simpleMessage(
      "اپنے بی ٹی سی کو لاک کریں۔",
    ),
    "g_key_btc_stake_step2_desc": MessageLookupByLibrary.simpleMessage(
      "آن چین تصدیق کے بعد، vBTC 1:1 کے تناسب سے آپ کے بٹوے میں ٹکڑا جاتا ہے۔",
    ),
    ...
    "g_key_btc_stake_step3_desc": MessageLookupByLibrary.simpleMessage(
      "اسٹیکنگ انعامات حاصل کرنے کے لیے vBTC کو پکڑیں۔ vBTC ڈی فائی پروٹوکول میں بھی قابل استعمال ہے۔",
    ),
    ...
    "g_key_btc_stake_step4_desc": MessageLookupByLibrary.simpleMessage(
      "جب لاک کی مدت ختم ہو جائے، تو اپنا اصل BTC واپس حاصل کرنے کے لیے اپنے vBTC کو جلا دیں۔",
    ),
    ...
    "g_key_burn_got_it": MessageLookupByLibrary.simpleMessage("سمجھ گیا"),
    "g_key_burn_nft_step1": MessageLookupByLibrary.simpleMessage(
      "1. NFT سپورٹ کے ساتھ ایک ٹوکن منتخب کریں۔",
    ),
    "g_key_burn_nft_step2": MessageLookupByLibrary.simpleMessage(
      "2. NFT ٹیب پر جائیں۔",
    ),
    "g_key_burn_nft_step3": MessageLookupByLibrary.simpleMessage(
      "3. وہ NFT منتخب کریں جسے آپ جلانا چاہتے ہیں۔",
    ),
    "g_key_burn_nft_step4": MessageLookupByLibrary.simpleMessage(
      "4. \"برن\" بٹن کو تھپتھپائیں۔",
    ),
    "g_key_burn_nft_steps": MessageLookupByLibrary.simpleMessage("مراحل:"),
    ...
    "g_key_chain_presets": MessageLookupByLibrary.simpleMessage(
      "مقبول نیٹ ورک (تفصیلات بھرنے کے لیے دبائیں)",
    ),
    ...
    "g_key_dapp_connect_desc": MessageLookupByLibrary.simpleMessage(
      "یہ ویب سائٹ آپ کے والیٹ کا پتہ دیکھنے اور ٹرانزیکشنز تجویز کرنے کی اجازت مانگ رہی ہے۔ یہ آپ کی منظوری کے بغیر رقم منتقل نہیں کر سکتی۔",
    ),
    ...
    "g_key_dex_approve_unlimited_info": MessageLookupByLibrary.simpleMessage(
      "لامحدود منظوری: روٹر اس ٹوکن کو کسی بھی وقت خرچ کر سکتا ہے۔ معیاری مشق، لیکن اگر معاہدہ سے سمجھوتہ کیا جاتا ہے تو خطرہ ہوتا ہے۔",
    ),
    ...
    "g_key_dex_chain": MessageLookupByLibrary.simpleMessage("زنجیر"),
    "g_key_dex_confirm_title": MessageLookupByLibrary.simpleMessage(
      "تبادلہ کی تصدیق کریں۔",
    ),
    ...
    "g_key_dex_price_chart": MessageLookupByLibrary.simpleMessage("قیمت چارٹ"),
    ...
    "g_key_dex_quote_unavailable": MessageLookupByLibrary.simpleMessage(
      "سواپ کی قیمت فراہم کرنے والی سروس عارضی طور پر دستیاب نہیں۔ بعد میں دوبارہ کوشش کریں۔",
    ),
    ...
    "g_key_dex_status_failed": MessageLookupByLibrary.simpleMessage("ناکام"),
    ...
    "g_key_dex_swap_btn": MessageLookupByLibrary.simpleMessage("تبادلہ"),
    ...
    "g_key_dex_tokens_offline": MessageLookupByLibrary.simpleMessage(
      "ٹوکن سروس دستیاب نہیں۔ ایک محدود آف لائن فہرست دکھائی جا رہی ہے۔",
    ),
    "g_key_dex_untrusted_router": MessageLookupByLibrary.simpleMessage(
      "سواپ روک دیا گیا: راؤٹر کا پتہ قابلِ شناخت نہیں۔ آپ کی حفاظت کے لیے یہ ٹرانزیکشن منسوخ کر دی گئی۔",
    ),
    ...
    "g_key_earn_batch": MessageLookupByLibrary.simpleMessage("بیچ"),
    "g_key_earn_best_apy": MessageLookupByLibrary.simpleMessage(
      "بہترین سالانہ شرحِ منافع (APY)",
    ),
    ...
    "g_key_earn_perps": MessageLookupByLibrary.simpleMessage("دائمی فیوچرز"),
    ...
    "g_key_earn_stablecoin_desc": MessageLookupByLibrary.simpleMessage(
      "USDC / USDT / DAI پر روزانہ منافع کمائیں",
    ),
    "g_key_earn_stablecoin_empty": MessageLookupByLibrary.simpleMessage(
      "فی الحال کوئی اسٹیبل کوائن مارکیٹ دستیاب نہیں",
    ),
    "g_key_earn_stablecoin_title": MessageLookupByLibrary.simpleMessage(
      "اسٹیبل کوائن سے آمدنی",
    ),
    "g_key_earn_stake_eth_lido": MessageLookupByLibrary.simpleMessage(
      "Lido کے ساتھ ETH کو داؤ پر لگا دیں۔",
    ),
    "g_key_earn_swap": MessageLookupByLibrary.simpleMessage("تبادلہ"),
    "g_key_earn_title": MessageLookupByLibrary.simpleMessage("کمائیں"),
    ...
    "g_key_ens_advanced": MessageLookupByLibrary.simpleMessage("اعلی درجے کی"),
    "g_key_ens_annual_fee": MessageLookupByLibrary.simpleMessage("سالانہ فیس"),
    "g_key_ens_available": MessageLookupByLibrary.simpleMessage("دستیاب ہے۔"),
    "g_key_ens_base_price": MessageLookupByLibrary.simpleMessage("بنیادی قیمت"),
    ...
    "g_key_ens_days_left": MessageLookupByLibrary.simpleMessage("دن رہ گئے"),
    "g_key_ens_description": MessageLookupByLibrary.simpleMessage(
      "اپنے .eth ڈومین ناموں کو رجسٹر اور منظم کریں۔",
    ),
    ...
    "g_key_ens_is_yours": MessageLookupByLibrary.simpleMessage("اب تمہارا ہے!"),
    "g_key_ens_keep_app_open": MessageLookupByLibrary.simpleMessage(
      "براہ کرم رجسٹریشن کے دوران ایپ کو کھلا رکھیں",
    ),
    ...
    "g_key_ens_my_domains": MessageLookupByLibrary.simpleMessage("میرے ڈومینز"),
    "g_key_ens_name": MessageLookupByLibrary.simpleMessage("ENS کا نام"),
    "g_key_ens_new_expiry": MessageLookupByLibrary.simpleMessage("نئی میعاد"),
    ...
    "g_key_ens_processing": MessageLookupByLibrary.simpleMessage("پروسیسنگ..."),
    ...
    "g_key_ens_subdomain_owner_hint": MessageLookupByLibrary.simpleMessage(
      "موجودہ پرس استعمال کرنے کے لیے خالی چھوڑ دیں۔",
    ),
    ...
    "g_key_ens_transfer_warning": MessageLookupByLibrary.simpleMessage(
      "منتقلی ناقابل واپسی ہے۔ یقینی بنائیں کہ نئے مالک کا پتہ درست ہے۔",
    ),
    ...
    "g_key_ens_two_step_process": MessageLookupByLibrary.simpleMessage(
      "ENS رجسٹریشن ایک دو قدمی عمل ہے۔",
    ),
    "g_key_ens_unavailable": MessageLookupByLibrary.simpleMessage(
      "دستیاب نہیں۔",
    ),
    "g_key_ens_wait": MessageLookupByLibrary.simpleMessage("انتظار کرو"),
    "g_key_ens_wait_explanation": MessageLookupByLibrary.simpleMessage(
      "انتظار کی مدت سامنے سے چلنے والے حملوں کو روکتی ہے۔",
    ),
    ...
    "g_key_ens_warning": MessageLookupByLibrary.simpleMessage(
      "براہ کرم آگے بڑھنے سے پہلے حل شدہ پتے کی تصدیق کریں۔ ENS ناموں کو ان کے مالک کے ذریعے منتقل یا تبدیل کیا جا سکتا ہے۔",
    ),
    "g_key_ens_year": MessageLookupByLibrary.simpleMessage("سال"),
    ...
    "g_key_error_10": MessageLookupByLibrary.simpleMessage("ڈیو ایرر"),
    "g_key_error_11": MessageLookupByLibrary.simpleMessage(
      "نحوی غلطی کی درخواست کریں۔",
    ),
    "g_key_error_12": MessageLookupByLibrary.simpleMessage(
      "غیر مجاز، براہ کرم لاگ ان کریں۔",
    ),
    ...
    "g_key_error_16": MessageLookupByLibrary.simpleMessage("سرور غیر معمولی"),
    "g_key_error_17": MessageLookupByLibrary.simpleMessage(
      "سروس لاگو نہیں ہوئی۔",
    ),
    "g_key_error_18": MessageLookupByLibrary.simpleMessage("گیٹ وے کی خرابی۔"),
    "g_key_error_19": MessageLookupByLibrary.simpleMessage(
      "سروس دستیاب نہیں ہے۔",
    ),
    "g_key_error_20": MessageLookupByLibrary.simpleMessage("گیٹ وے ٹائم آؤٹ"),
    "g_key_error_21": MessageLookupByLibrary.simpleMessage(
      "HTTP ورژن تعاون یافتہ نہیں ہے۔",
    ),
    "g_key_error_22": MessageLookupByLibrary.simpleMessage(
      "درخواست ناکام ہوگئی، غلطی کا کوڈ:",
    ),
    "g_key_error_23": MessageLookupByLibrary.simpleMessage(
      "سسٹم مصروف ہے، براہ کرم بعد میں دوبارہ کوشش کریں۔",
    ),
    "g_key_error_24": MessageLookupByLibrary.simpleMessage(
      "درخواست کی فریکوئنسی بہت تیز ہے۔",
    ),
    "g_key_error_25": MessageLookupByLibrary.simpleMessage(
      "ڈی کوڈنگ ناکام ہو گئی۔",
    ),
    "g_key_error_26": MessageLookupByLibrary.simpleMessage(
      "لین دین پہلے سے ہی سلسلہ پر ہے۔",
    ),
    "g_key_error_27": MessageLookupByLibrary.simpleMessage(
      "سرٹیفکیٹ کی ترتیب کی خرابی!",
    ),
    "g_key_error_28": MessageLookupByLibrary.simpleMessage(
      "اسٹیٹس کوڈ کنفیگریشن کی خرابی!",
    ),
    "g_key_error_3": MessageLookupByLibrary.simpleMessage("نامعلوم غلطی!"),
    "g_key_error_4": MessageLookupByLibrary.simpleMessage(
      "نیٹ ورک کنکشن کا وقت ختم ہو گیا، براہ کرم نیٹ ورک کی ترتیبات چیک کریں!",
    ),
    "g_key_error_5": MessageLookupByLibrary.simpleMessage(
      "سرور غیر معمولی ہے۔ براہ کرم بعد میں دوبارہ کوشش کریں!",
    ),
    "g_key_error_8": MessageLookupByLibrary.simpleMessage(
      "درخواست منسوخ کر دی گئی ہے، براہ کرم دوبارہ درخواست کریں!",
    ),
    "g_key_ex_keystore": MessageLookupByLibrary.simpleMessage(
      "کیسٹور برآمد کریں۔",
    ),
    "g_key_ex_keystore_1": MessageLookupByLibrary.simpleMessage("بیک اپ ٹپس"),
    "g_key_ex_keystore_10": MessageLookupByLibrary.simpleMessage(
      "ذخیرہ کرنے کے لیے پاس ورڈ مینجمنٹ ٹول استعمال کریں۔",
    ),
    "g_key_ex_keystore_11": MessageLookupByLibrary.simpleMessage("کاپی"),
    "g_key_ex_keystore_12": MessageLookupByLibrary.simpleMessage(
      "کاپی منسوخ کر دی گئی۔",
    ),
    "g_key_ex_keystore_13": MessageLookupByLibrary.simpleMessage("شناختی پرس"),
    "g_key_ex_keystore_15": MessageLookupByLibrary.simpleMessage(
      "خفیہ کردہ نجی کلید فائل۔",
    ),
    ...
    "g_key_ex_keystore_18": MessageLookupByLibrary.simpleMessage(
      "براہ کرم کلیدی اسٹور کی معلومات درج کریں۔",
    ),
    "g_key_ex_keystore_19": MessageLookupByLibrary.simpleMessage(
      "PrivateKey برآمد کریں۔",
    ),
    "g_key_ex_keystore_2": MessageLookupByLibrary.simpleMessage(
      "کیسٹور اور پاس ورڈ حاصل کرنے سے ہولڈر کو والیٹ کے اثاثوں پر مکمل کنٹرول حاصل ہو جائے گا۔",
    ),
    "g_key_ex_keystore_3": MessageLookupByLibrary.simpleMessage(
      "احتیاط سے ریکارڈ کریں اور محفوظ جگہ پر اسٹور کریں۔ ایک سے زیادہ فزیکل کاپیاں رکھنا محفوظ ترین طریقہ ہے۔",
    ),
    "g_key_ex_keystore_4": MessageLookupByLibrary.simpleMessage(
      "اگر آپ کی نجی کلید کھو گئی ہے، تو اسے دوبارہ حاصل نہیں کیا جا سکتا۔ اس کا جسمانی طور پر بیک اپ لیں اور اسے محفوظ طریقے سے اسٹور کریں۔",
    ),
    "g_key_ex_keystore_5": MessageLookupByLibrary.simpleMessage(
      "آف لائن محفوظ کریں۔",
    ),
    "g_key_ex_keystore_6": MessageLookupByLibrary.simpleMessage(
      "کسی بھی میل باکس، نوٹ پیڈ، نیٹ ورک ڈسک یا چیٹ سافٹ ویئر میں محفوظ نہ کریں جو محفوظ نہ ہو۔",
    ),
    "g_key_ex_keystore_7": MessageLookupByLibrary.simpleMessage(
      "براہ کرم نیٹ ورک ٹرانسمیشن کا استعمال کریں۔",
    ),
    "g_key_ex_keystore_8": MessageLookupByLibrary.simpleMessage(
      "براہ کرم اسے نیٹ ورک ٹولز کے ذریعے منتقل کرنا یقینی بنائیں، ایک بار جب ہیکرز اسے حاصل کر لیں تو اس سے ناقابل تلافی معاشی نقصان ہو گا۔",
    ),
    "g_key_ex_keystore_9": MessageLookupByLibrary.simpleMessage(
      "بچانے کے لیے ٹولز استعمال کریں۔",
    ),
    "g_key_ex_keystore_confirm_risk": MessageLookupByLibrary.simpleMessage(
      "میں سمجھتا ہوں کہ جو بھی یہ فائل اور پاس ورڈ حاصل کرتا ہے اس کا میرے فنڈز پر مکمل کنٹرول ہے - نقصان مستقل اور ناقابل تلافی ہے۔",
    ),
    "g_key_ex_keystore_pwd_title": MessageLookupByLibrary.simpleMessage(
      "برآمد کی تصدیق کے لیے والیٹ پاس ورڈ درج کریں۔",
    ),
    ...
    "g_key_gas_alert_below": MessageLookupByLibrary.simpleMessage(
      "نیچے ہونے پر الرٹ کریں۔",
    ),
    "g_key_gas_alert_save": MessageLookupByLibrary.simpleMessage("محفوظ کریں۔"),
    ...
    "g_key_hw_connected": MessageLookupByLibrary.simpleMessage("جڑا ہوا"),
    ...
    "g_key_hw_trezor_connected": MessageLookupByLibrary.simpleMessage(
      "Trezor کامیابی سے منسلک ہو گیا۔",
    ),
    ...
    "g_key_hw_yesterday": MessageLookupByLibrary.simpleMessage("کل"),
    "g_key_keystore_19": MessageLookupByLibrary.simpleMessage(
      "موجودہ کرنسی والیٹ پہلے سے موجود ہے۔",
    ),
    ...
    "g_key_loyalty_history": MessageLookupByLibrary.simpleMessage("تاریخ"),
    "g_key_loyalty_invite_description": MessageLookupByLibrary.simpleMessage(
      "اپنا دعوتی کوڈ شیئر کریں",
    ),
    ...
    "g_key_loyalty_no_wallet": MessageLookupByLibrary.simpleMessage(
      "کوئی فعال والیٹ نہیں",
    ),
    "g_key_loyalty_referral": MessageLookupByLibrary.simpleMessage("دعوتیں"),
    ...
    "g_key_loyalty_used": MessageLookupByLibrary.simpleMessage("استعمال شدہ"),
    ...
    "g_key_m_15": MessageLookupByLibrary.simpleMessage("براؤزر"),
    "g_key_m_16": MessageLookupByLibrary.simpleMessage("ٹیلی گرام"),
    "g_key_m_17": MessageLookupByLibrary.simpleMessage("اختلاف"),
    "g_key_m_18": MessageLookupByLibrary.simpleMessage("یوٹیوب"),
    "g_key_m_19": MessageLookupByLibrary.simpleMessage("انسٹاگرام"),
    "g_key_m_2": MessageLookupByLibrary.simpleMessage("مارکیٹ کیپ"),
    "g_key_m_3": MessageLookupByLibrary.simpleMessage("تجارتی حجم"),
    "g_key_m_4": MessageLookupByLibrary.simpleMessage("کل سپلائی"),
    "g_key_m_5": MessageLookupByLibrary.simpleMessage("گردش میں"),
    "g_key_m_6": MessageLookupByLibrary.simpleMessage("کے بارے میں"),
    "g_key_m_7": MessageLookupByLibrary.simpleMessage("مزید"),
    "g_key_m_8": MessageLookupByLibrary.simpleMessage("لنکس"),
    "g_key_m_9": MessageLookupByLibrary.simpleMessage("ویب سائٹ"),
    "g_key_manage_chains": MessageLookupByLibrary.simpleMessage(
      "زنجیروں کا انتظام کریں۔",
    ),
    ...
    "g_key_msgsign_btn": MessageLookupByLibrary.simpleMessage("دستخط کریں"),
    "g_key_msgsign_empty": MessageLookupByLibrary.simpleMessage(
      "پہلے کوئی پیغام درج کریں",
    ),
    "g_key_msgsign_failed": MessageLookupByLibrary.simpleMessage(
      "دستخط ناکام ہو گئے",
    ),
    "g_key_msgsign_input_hint": MessageLookupByLibrary.simpleMessage(
      "دستخط کرنے کے لیے پیغام درج کریں",
    ),
    "g_key_msgsign_result": MessageLookupByLibrary.simpleMessage("دستخط"),
    "g_key_msgsign_title": MessageLookupByLibrary.simpleMessage(
      "پیغام پر دستخط کریں",
    ),
    "g_key_msgsign_unsupported": MessageLookupByLibrary.simpleMessage(
      "اس چین پر پیغام پر دستخط کرنے کی سہولت ابھی دستیاب نہیں",
    ),
    "g_key_msgsign_warning": MessageLookupByLibrary.simpleMessage(
      "صرف ان پیغامات پر دستخط کریں جن پر آپ کو مکمل اعتماد ہو۔ بدنیتی پر مبنی پیغام آپ کی جانب سے اقدامات کی اجازت دینے کے لیے استعمال ہو سکتا ہے۔",
    ),
    ...
    "g_key_nft_collection": MessageLookupByLibrary.simpleMessage("مجموعہ"),
    "g_key_nft_contract": MessageLookupByLibrary.simpleMessage("معاہدہ"),
    "g_key_nft_description": MessageLookupByLibrary.simpleMessage("تفصیل"),
    "g_key_nft_error_retry": MessageLookupByLibrary.simpleMessage(
      "NFTs لوڈ کرنے میں ناکام۔ دوبارہ کوشش کرنے کے لیے تھپتھپائیں۔",
    ),
    "g_key_nft_filter_all": MessageLookupByLibrary.simpleMessage("تمام"),
    "g_key_nft_filter_video": MessageLookupByLibrary.simpleMessage("ویڈیو"),
    "g_key_nft_floor_price": MessageLookupByLibrary.simpleMessage("فرش"),
    "g_key_nft_gallery": MessageLookupByLibrary.simpleMessage("NFT گیلری"),
    "g_key_nft_hide_spam": MessageLookupByLibrary.simpleMessage(
      "اسپیم چھپائیں",
    ),
    "g_key_nft_inscription": MessageLookupByLibrary.simpleMessage("نوشتہ #"),
    "g_key_nft_no_items": MessageLookupByLibrary.simpleMessage(
      "کوئی NFTs نہیں ملے",
    ),
    "g_key_nft_no_url": MessageLookupByLibrary.simpleMessage(
      "کوئی ایکسپلورر لنک دستیاب نہیں ہے۔",
    ),
    ...
    "g_key_nft_quantity": MessageLookupByLibrary.simpleMessage("مقدار"),
    "g_key_nft_search_hint": MessageLookupByLibrary.simpleMessage(
      "نام یا مجموعہ کے ذریعہ تلاش کریں۔",
    ),
    "g_key_nft_send": MessageLookupByLibrary.simpleMessage("NFT بھیجیں۔"),
    "g_key_nft_send_sol_unsupported": MessageLookupByLibrary.simpleMessage(
      "سولانا NFT ٹرانسفرز جلد آرہے ہیں۔",
    ),
    ...
    "g_key_nft_uncategorized": MessageLookupByLibrary.simpleMessage("دوسرے"),
    ...
    "g_key_perps_read_only": MessageLookupByLibrary.simpleMessage(
      "مارکیٹ کا ڈیٹا صرف دیکھا جا سکتا ہے۔ اس ورژن میں آرڈر دینے کی سہولت نہیں ہے۔",
    ),
    "g_key_personal_1": MessageLookupByLibrary.simpleMessage(
      "فون گیلری سے منتخب کریں۔",
    ),
    "g_key_pubkey": MessageLookupByLibrary.simpleMessage("عوامی کلید"),
    ...
    "g_key_retry": MessageLookupByLibrary.simpleMessage("دوبارہ کوشش کریں"),
    "g_key_scan_pay_unsupported": MessageLookupByLibrary.simpleMessage(
      "ادائیگی کی درخواست کا ٹوکن یا چین اس والیٹ میں موجود نہیں",
    ),
    ...
    "g_key_security_goplus_checking": MessageLookupByLibrary.simpleMessage(
      "معاہدے کی حفاظت کی جانچ ہو رہی ہے...",
    ),
    ...
    "g_key_share_link": MessageLookupByLibrary.simpleMessage("لنک شیئر کریں۔"),
    ...
    "g_key_stake_amount": MessageLookupByLibrary.simpleMessage("رقم"),
    "g_key_stake_amount_unstake": MessageLookupByLibrary.simpleMessage(
      "Unstake کرنے کے لئے رقم",
    ),
    ...
    "g_key_stake_broadcast_unsupported": MessageLookupByLibrary.simpleMessage(
      "ٹرانزیکشن تیار ہے، لیکن اس چین پر والیٹ سے اسے نشر کرنے کی سہولت ابھی دستیاب نہیں۔",
    ),
    ...
    "g_key_stake_liquid_tag": MessageLookupByLibrary.simpleMessage("مائع"),
    "g_key_stake_liquid_unstake_desc": MessageLookupByLibrary.simpleMessage(
      "آپ کے مائع ٹوکن کی براہ راست DEX پر تجارت کی جا سکتی ہے۔ اسے واپس مقامی اثاثہ میں تبدیل کرنے کے لیے Swap کا استعمال کریں۔",
    ),
    ...
    "g_key_stake_no_active_positions": MessageLookupByLibrary.simpleMessage(
      "غیر داغدار کرنے کے لیے کوئی فعال عہدہ نہیں۔",
    ),
    ...
    "g_key_stake_select_a_validator": MessageLookupByLibrary.simpleMessage(
      "ایک تصدیق کنندہ کو منتخب کریں۔",
    ),
    "g_key_stake_select_position": MessageLookupByLibrary.simpleMessage(
      "اتارنے کے لیے پوزیشن منتخب کریں۔",
    ),
    "g_key_stake_select_validator": MessageLookupByLibrary.simpleMessage(
      "توثیق کنندہ کو منتخب کریں۔",
    ),
    "g_key_stake_sort_by": MessageLookupByLibrary.simpleMessage("ترتیب دیں"),
    "g_key_stake_stake": MessageLookupByLibrary.simpleMessage("داؤ"),
    ...
    "g_key_stake_submitted": MessageLookupByLibrary.simpleMessage(
      "اسٹیکنگ کی ٹرانزیکشن ارسال کر دی گئی",
    ),
    ...
    "g_key_t_36": MessageLookupByLibrary.simpleMessage("گیس فیس کی شرح"),
    "g_key_t_37": MessageLookupByLibrary.simpleMessage(
      "تازہ ترین بلاک گیس فیس کی شرح اوسط",
    ),
    "g_key_t_4": MessageLookupByLibrary.simpleMessage("باہر منتقل"),
    "g_key_t_43": MessageLookupByLibrary.simpleMessage(
      "0 سے بڑا مکمل نمبر درج کریں۔",
    ),
    ...
    "g_key_t_47": MessageLookupByLibrary.simpleMessage("تلاش کریں۔"),
    "g_key_t_49": MessageLookupByLibrary.simpleMessage("کوئی حساب نہیں۔"),
    "g_key_t_5": MessageLookupByLibrary.simpleMessage("میں منتقل کریں۔"),
    "g_key_t_50": MessageLookupByLibrary.simpleMessage("غلط پتہ"),
    ...
    "g_key_tran_1": MessageLookupByLibrary.simpleMessage("لین دین کی تاریخ"),
    "g_key_tran_4": MessageLookupByLibrary.simpleMessage("لین دین کی تفصیل"),
    "g_key_tran_6": MessageLookupByLibrary.simpleMessage(
      "براہ کرم تاریخ میں لین دین کی رسیدیں دیکھیں",
    ),
    "g_key_tran_7": MessageLookupByLibrary.simpleMessage("رقم خرچ کریں۔"),
    "g_key_tran_8": MessageLookupByLibrary.simpleMessage("رقم حاصل کریں۔"),
    ...
    "g_key_tx_filter_direction": MessageLookupByLibrary.simpleMessage("سمت"),
    ...
    "g_key_v_k3": MessageLookupByLibrary.simpleMessage("نیا ورژن ملا"),
    ...
    "g_key_wallet_c14": MessageLookupByLibrary.simpleMessage("اکاؤنٹ بنائیں"),
    "g_key_wallet_c15": MessageLookupByLibrary.simpleMessage(
      "آپ سب کر چکے ہیں!",
    ),
    "g_key_wallet_c16": MessageLookupByLibrary.simpleMessage(
      "اب آپ اپنے بٹوے سے پوری طرح لطف اندوز ہو سکتے ہیں۔",
    ),
    "g_key_wallet_c17": MessageLookupByLibrary.simpleMessage("شروع کریں"),
    "g_key_wallet_c18": MessageLookupByLibrary.simpleMessage(
      "ابھی کے لیے چھوڑ دیں۔",
    ),
    "g_key_wallet_c19": MessageLookupByLibrary.simpleMessage(
      "آپ ابھی کے لیے بیج کے فقرے کا بیک اپ لینا چھوڑ سکتے ہیں، اور اگر آپ کو ضرورت ہو تو اسے کسی بھی وقت سیٹنگز میں دوبارہ کر سکتے ہیں۔",
    ),
    ...
    "g_key_wallet_c23": MessageLookupByLibrary.simpleMessage(
      "اگر آپ اپنے بٹوے کی تفصیل چیک کرنا چاہتے ہیں یا کی اسٹور ایکسپورٹ کرنا چاہتے ہیں، تو آپ سائڈبار> والیٹ کا نظم کریں پر جا سکتے ہیں۔ ",
    ),
    "g_key_wallet_c24": MessageLookupByLibrary.simpleMessage(
      "میرا کی اسٹور ایکسپورٹ کریں۔",
    ),
    "g_key_wallet_c25": MessageLookupByLibrary.simpleMessage(
      "اپنے بٹوے کا بیک اپ لے کر اسے محفوظ کریں۔",
    ),
    "g_key_wallet_c26": MessageLookupByLibrary.simpleMessage(
      "کی اسٹور سیکیورٹی سرٹیفکیٹس اور منسلک نجی کلیدوں کا ذخیرہ ہے۔",
    ),
    "g_key_wallet_c27": MessageLookupByLibrary.simpleMessage(
      "مرحلہ 1: والیٹ کا نظم کریں پر جائیں۔",
    ),
    "g_key_wallet_c28": MessageLookupByLibrary.simpleMessage(
      "مرحلہ 2: والیٹ کا پتہ منتخب کریں۔",
    ),
    "g_key_wallet_c29": MessageLookupByLibrary.simpleMessage(
      "مرحلہ 3: ایکسپورٹ کیسٹور کو دبائیں۔",
    ),
    "g_key_wallet_c30": MessageLookupByLibrary.simpleMessage(
      "پرس کا نظم کریں پر جائیں۔",
    ),
    ...
    "g_key_wallet_c33": MessageLookupByLibrary.simpleMessage(
      "بیج کے فقرے کا استعمال کرتے ہوئے ایک بٹوہ بنائیں۔",
    ),
    "g_key_wallet_c34": MessageLookupByLibrary.simpleMessage(
      "بٹوے کا نام درج کریں۔",
    ),
    "g_key_wallet_c35": MessageLookupByLibrary.simpleMessage(
      "آپ نے اپنے بٹوے کے بیج کے جملے کا بیک اپ نہیں لیا ہے!",
    ),
    "g_key_wallet_c36": MessageLookupByLibrary.simpleMessage(
      "ابھی بیک اپ کریں۔",
    ),
    "g_key_wallet_c37": MessageLookupByLibrary.simpleMessage(
      "والیٹ پاس ورڈ سیٹ کریں۔",
    ),
    "g_key_wallet_c38": MessageLookupByLibrary.simpleMessage("بیک اپ والیٹ"),
    "g_key_wallet_c39": MessageLookupByLibrary.simpleMessage(
      "براہ کرم مندرجہ ذیل بیج کا جملہ ریکارڈ کریں۔",
    ),
    "g_key_wallet_c4": MessageLookupByLibrary.simpleMessage("شروع کریں۔"),
    "g_key_wallet_c40": MessageLookupByLibrary.simpleMessage(
      "انٹرنیٹ سے منسلک آلات آپ کی معلومات کو ظاہر کر سکتے ہیں۔ ہم تجویز کرتے ہیں کہ آپ بیج کا جملہ لکھیں اور اسے محفوظ طریقے سے ذخیرہ کریں۔",
    ),
    "g_key_wallet_c41": MessageLookupByLibrary.simpleMessage(
      "انتباہ: اپنے بیج کے جملہ کو کسی کے سامنے ظاہر نہ کریں۔ N42Wallet آپ سے یہ معلومات کبھی نہیں پوچھے گا۔ براہ کرم انتہائی محتاط رہیں اور اسے محفوظ طریقے سے آف لائن اسٹور کریں۔ اگر آپ کے بیج کے فقرے کو بے نقاب کیا جاتا ہے، تو آپ اپنے تمام اثاثے کھو سکتے ہیں اور انہیں دوبارہ حاصل کرنے سے قاصر ہو سکتے ہیں۔",
    ),
    "g_key_wallet_c42": MessageLookupByLibrary.simpleMessage(
      "تنبیہ: بیج کا جملہ ہی آپ کے بٹوے کے اثاثوں کو بازیافت کرنے کا واحد طریقہ ہے۔",
    ),
    "g_key_wallet_c43": MessageLookupByLibrary.simpleMessage("اگلا مرحلہ"),
    "g_key_wallet_c44": MessageLookupByLibrary.simpleMessage(
      "بیج کا جملہ دیکھنے کے لیے کلک کریں۔",
    ),
    "g_key_wallet_c45": MessageLookupByLibrary.simpleMessage(
      "براہ کرم یقینی بنائیں کہ آس پاس کوئی اور لوگ یا کیمرے نہیں ہیں۔",
    ),
    "g_key_wallet_c46": MessageLookupByLibrary.simpleMessage(
      "بیج کے جملے کی تصدیق کریں۔",
    ),
    "g_key_wallet_c47": MessageLookupByLibrary.simpleMessage(
      "والیٹ کی معلومات",
    ),
    "g_key_wallet_c48": MessageLookupByLibrary.simpleMessage("بٹوے کا نام"),
    "g_key_wallet_c49": MessageLookupByLibrary.simpleMessage(
      "براہ کرم پہلے اپنے بٹوے کے بیج کے جملے کا بیک اپ لیں!",
    ),
    "g_key_wallet_c6": MessageLookupByLibrary.simpleMessage(
      "بیج کا جملہ چیک کریں۔",
    ),
    "g_key_wallet_c7": MessageLookupByLibrary.simpleMessage(
      "اب اپنے بیج کا جملہ درج کریں۔",
    ),
    "g_key_wallet_c8": MessageLookupByLibrary.simpleMessage("جملہ مقرر کریں۔"),
    "g_key_wallet_c9": MessageLookupByLibrary.simpleMessage(
      "براہ کرم یقینی بنائیں کہ آپ اپنے بیج کا جملہ ریکارڈ کریں اور اسے محفوظ طریقے سے ذخیرہ کریں۔ آپ کو اپنے کریپٹو کرنسی والیٹ کو درآمد کرنے یا بازیافت کرنے کے لیے اس کی ضرورت ہوگی۔",
    ),
    "g_key_wallet_edit": MessageLookupByLibrary.simpleMessage(
      "والیٹ میں ترمیم کریں۔",
    ),
    "g_key_wallet_k25": MessageLookupByLibrary.simpleMessage("وقت"),
    "g_key_wallet_k33": MessageLookupByLibrary.simpleMessage("نتیجہ"),
    "g_key_wallet_k37": MessageLookupByLibrary.simpleMessage("ٹرانزیکشن ہیش"),
    "g_key_wallet_k47": MessageLookupByLibrary.simpleMessage("شامل کریں۔"),
    "g_key_wallet_k53": MessageLookupByLibrary.simpleMessage("راستہ"),
    "g_key_wallet_k54": MessageLookupByLibrary.simpleMessage("بلاک"),
    "g_key_wallet_k55": MessageLookupByLibrary.simpleMessage("قدر"),
    ...
    "g_key_wallet_tx_replace_hint": MessageLookupByLibrary.simpleMessage(
      "ایک متبادل ٹرانزیکشن اسی nonce اور تقریباً 20٪ زیادہ گیس فیس کے ساتھ نشر کی جائے گی۔ یہ صرف اس وقت مؤثر ہوگی جب اصل ٹرانزیکشن ابھی زیرِ التوا ہو۔",
    ),
    "g_key_wallet_tx_replace_submitted": MessageLookupByLibrary.simpleMessage(
      "متبادل ٹرانزیکشن ارسال کر دی گئی",
    ),
    ...
    "g_key_watch_wallet": MessageLookupByLibrary.simpleMessage("پرس دیکھیں"),
    "g_key_watch_wallet_desc": MessageLookupByLibrary.simpleMessage(
      "نجی کلید کے بغیر کسی بھی ای وی ایم ایڈریس کو ٹریک کریں۔",
    ),
    ...
    "g_lock_key16": MessageLookupByLibrary.simpleMessage("اشاری پاس ورڈ"),
    "g_lock_key17": MessageLookupByLibrary.simpleMessage(
      "اشاری پاس ورڈ ترتیب دیں",
    ),
    "g_lock_key18": MessageLookupByLibrary.simpleMessage(
      "اپنا اشاری نمونہ بنائیں",
    ),
    ...
    "g_lock_key23": MessageLookupByLibrary.simpleMessage(
      "بہت زیادہ ناکام کوششیں، دوبارہ کوشش کریں",
    ),
    "g_lock_key24": MessageLookupByLibrary.simpleMessage(
      "والیٹ پاس ورڈ شامل کریں؟",
    ),
    "g_lock_key25": m50,
    "g_lock_key26": MessageLookupByLibrary.simpleMessage("منتقلی کی تصدیق"),
    "g_lock_key27": MessageLookupByLibrary.simpleMessage(
      "والیٹ کی ہر منتقلی کی تصدیق کے لیے بایومیٹرک شناخت (Face ID / فنگر پرنٹ) لازم کریں۔",
    ),
    "g_lock_key28": MessageLookupByLibrary.simpleMessage(
      "اشاری پاس ورڈ ترتیب نہیں دیا گیا",
    ),
    "g_lock_key29": MessageLookupByLibrary.simpleMessage(
      "ہر ٹرانسفر کی تصدیق کے لیے اشاری تصدیق ضروری ہے۔",
    ),
    ...
    "g_market_atl": MessageLookupByLibrary.simpleMessage("اے ٹی ایل"),
    ...
    "g_market_low_24h": MessageLookupByLibrary.simpleMessage("کم 24H"),
    "g_market_news": MessageLookupByLibrary.simpleMessage("خبریں"),
    "g_market_no_chart": MessageLookupByLibrary.simpleMessage(
      "کوئی چارٹ ڈیٹا نہیں ہے۔",
    ),
    "g_market_no_results": MessageLookupByLibrary.simpleMessage(
      "کوئی نتیجہ نہیں۔",
    ),
    "g_market_rank": MessageLookupByLibrary.simpleMessage("رینک"),
    "g_market_search": MessageLookupByLibrary.simpleMessage("تلاش کریں۔"),
    "g_market_search_hint": MessageLookupByLibrary.simpleMessage(
      "سکے تلاش کریں...",
    ),
    "g_market_trending": MessageLookupByLibrary.simpleMessage("ٹرینڈنگ"),
    "g_market_watchlist": MessageLookupByLibrary.simpleMessage("واچ لسٹ"),
    ...
    "g_mining_key33": MessageLookupByLibrary.simpleMessage("تصدیق کی ترتیبات"),
    "g_mining_key34": MessageLookupByLibrary.simpleMessage(
      "پس منظر کی توثیق موسیقی",
    ),
    "g_mining_key35": MessageLookupByLibrary.simpleMessage("طے شدہ"),
    "g_mining_key36": MessageLookupByLibrary.simpleMessage("خاموش"),
    "g_mining_key37": MessageLookupByLibrary.simpleMessage(
      "پس منظر کی توثیق فعال ہونے پر، موسیقی پس منظر میں چلے گی۔ اگر موسیقی رک جاتی ہے تو تصدیق بھی رک جائے گی۔",
    ),
    "g_mining_key38": MessageLookupByLibrary.simpleMessage("آپ کا ٹائر"),
    "g_mining_key46": MessageLookupByLibrary.simpleMessage(
      "سیٹ اپ کے لیے گیس کے لیے تھوڑی مقدار درکار ہے۔",
    ),
    "g_mining_key60": MessageLookupByLibrary.simpleMessage(
      "آپ N42Wallet پر ایک گروپ نوڈ میں کامیابی کے ساتھ شامل ہو گئے ہیں۔ دوستوں کو مدعو کرنے کے لیے لنک کا اشتراک کریں، نوڈ کو فعال کریں اور تصدیق شروع کریں!",
    ),
    ...
    "g_mining_key85": MessageLookupByLibrary.simpleMessage(
      "کلاؤڈ مائننگ کے لیے ٹیسٹ نیٹ اور مین نیٹ کے درمیان سوئچ کریں۔",
    ),
    "g_mining_key86": MessageLookupByLibrary.simpleMessage(
      "768s کے بعد چھٹکارا دستیاب ہے۔",
    ),
    "g_mining_key87": MessageLookupByLibrary.simpleMessage(
      "اس سے پہلے کی درخواستوں پر کارروائی نہیں کی جائے گی۔",
    ),
    "g_mining_key_1": MessageLookupByLibrary.simpleMessage("گھر"),
    "g_mining_key_10": MessageLookupByLibrary.simpleMessage("آج کا ثواب"),
    "g_mining_key_100": MessageLookupByLibrary.simpleMessage(
      "براہ کرم ذیل کے ڈیٹا کو ایک اہم کلید سمجھیں۔ ہم اسے فوری طور پر کسی قابل اعتماد مقام پر کاپی کرنے اور بیک اپ کرنے کی تجویز کرتے ہیں۔",
    ),
    ...
    "g_mining_key_106": MessageLookupByLibrary.simpleMessage(
      "پاس ورڈ خالی نہیں ہو سکتا!",
    ),
    "g_mining_key_107": MessageLookupByLibrary.simpleMessage(
      "ڈکرپشن ناکام ہو گیا۔ براہ کرم چیک کریں کہ آیا پاس ورڈ درست ہے!",
    ),
    ...
    "g_mining_key_112": MessageLookupByLibrary.simpleMessage(
      "براہ کرم خفیہ کردہ ڈیٹا درج کریں۔",
    ),
    "g_mining_key_113": MessageLookupByLibrary.simpleMessage(
      "درآمد کر رہا ہے...",
    ),
    "g_mining_key_114": MessageLookupByLibrary.simpleMessage("تصدیق"),
    ...
    "g_mining_key_13": MessageLookupByLibrary.simpleMessage("کل انعامات"),
    "g_mining_key_14": MessageLookupByLibrary.simpleMessage("کان کنی کی قیمت"),
    "g_mining_key_15": MessageLookupByLibrary.simpleMessage("ٹاسک کی تفصیل"),
    "g_mining_key_19": MessageLookupByLibrary.simpleMessage("خلاصہ"),
    ...
    "g_mining_key_32": MessageLookupByLibrary.simpleMessage(
      "غیر مقفل کرنے کی مدت: کسی بھی وقت غیر مقفل",
    ),
    "g_mining_key_33": MessageLookupByLibrary.simpleMessage(
      "سالانہ زیادہ سے زیادہ انعام",
    ),
    "g_mining_key_34": MessageLookupByLibrary.simpleMessage("انعامات کی تقسیم"),
    "g_mining_key_35": MessageLookupByLibrary.simpleMessage("روزانہ کی حد"),
    "g_mining_key_36": MessageLookupByLibrary.simpleMessage("رفتار"),
    "g_mining_key_37": MessageLookupByLibrary.simpleMessage("تصدیقی منصوبے"),
    "g_mining_key_38": MessageLookupByLibrary.simpleMessage(
      "ادائیگی کا طریقہ منتخب کریں۔",
    ),
    "g_mining_key_39": MessageLookupByLibrary.simpleMessage("ادائیگی کے طریقے"),
    "g_mining_key_40": MessageLookupByLibrary.simpleMessage(
      "N کا استعمال کرتے ہوئے ادائیگی کریں۔",
    ),
    "g_mining_key_42": MessageLookupByLibrary.simpleMessage("والیٹ بیلنس"),
    "g_mining_key_43": MessageLookupByLibrary.simpleMessage(
      "آپ کے پاس اس لین دین کے لیے کافی N نہیں ہے۔",
    ),
    "g_mining_key_45": MessageLookupByLibrary.simpleMessage(
      "کیا آپ واقعی نظر انداز کرنا چاہتے ہیں؟",
    ),
    "g_mining_key_46": MessageLookupByLibrary.simpleMessage(
      "آپ کو کوئی توثیقی انعامات اس وقت تک موصول نہیں ہوں گے جب تک کہ آپ 1 پلان کا انتخاب نہیں کر لیتے۔",
    ),
    "g_mining_key_47": MessageLookupByLibrary.simpleMessage("معذور"),
    "g_mining_key_48": MessageLookupByLibrary.simpleMessage("انعام"),
    "g_mining_key_49": MessageLookupByLibrary.simpleMessage("مزید دیکھیں"),
    "g_mining_key_5": MessageLookupByLibrary.simpleMessage("تصدیق کی حیثیت"),
    "g_mining_key_50": MessageLookupByLibrary.simpleMessage("کھولنے کے لیے"),
    "g_mining_key_52": MessageLookupByLibrary.simpleMessage("چھوڑیں۔"),
    "g_mining_key_58": MessageLookupByLibrary.simpleMessage("پچھلے 7 دن"),
    "g_mining_key_59": MessageLookupByLibrary.simpleMessage("جمع شدہ انعامات"),
    "g_mining_key_6": MessageLookupByLibrary.simpleMessage(
      "انعامات کی توثیق شروع کرنے کے لیے N کو مقفل کریں۔",
    ),
    "g_mining_key_60": MessageLookupByLibrary.simpleMessage(
      "انعامات موصول ہوئے۔",
    ),
    "g_mining_key_61": MessageLookupByLibrary.simpleMessage("اعلی درجے کی"),
    "g_mining_key_62": MessageLookupByLibrary.simpleMessage("داخلہ"),
    "g_mining_key_63": MessageLookupByLibrary.simpleMessage("پرو"),
    "g_mining_key_64": MessageLookupByLibrary.simpleMessage("مکمل نوڈ"),
    "g_mining_key_65": MessageLookupByLibrary.simpleMessage("منٹ/دن"),
    "g_mining_key_66": MessageLookupByLibrary.simpleMessage("اعلی درجے کی نوڈ"),
    "g_mining_key_67": MessageLookupByLibrary.simpleMessage("اندراج نوڈ"),
    "g_mining_key_68": MessageLookupByLibrary.simpleMessage("پرو نوڈ"),
    "g_mining_key_69": MessageLookupByLibrary.simpleMessage(
      "500 بلاکس فی دن ~ 70 منٹ",
    ),
    ...
    "g_mining_key_75": MessageLookupByLibrary.simpleMessage(
      "مسلسل چار دنوں تک کام مکمل کرنے میں ناکامی کے نتیجے میں کوئی کمائی نہیں ہوگی اور جرمانے کا خطرہ ہوگا۔",
    ),
    "g_mining_key_76": MessageLookupByLibrary.simpleMessage("رسک سکور"),
    "g_mining_key_77": MessageLookupByLibrary.simpleMessage("چھڑانا"),
    "g_mining_key_78": MessageLookupByLibrary.simpleMessage(
      "براہ کرم تصدیق کنندہ کے عوامی اور نجی کلید کے جوڑے کو پہلے محفوظ کریں۔",
    ),
    "g_mining_key_79": MessageLookupByLibrary.simpleMessage("برآمد کریں۔"),
    "g_mining_key_8": MessageLookupByLibrary.simpleMessage("آج کا تصدیقی وقت"),
    "g_mining_key_80": MessageLookupByLibrary.simpleMessage(
      "منتقلی کے لیے ناکافی فنڈز۔",
    ),
    ...
    "g_mining_key_82": MessageLookupByLibrary.simpleMessage(
      "توثیق کنندہ درآمد کریں۔",
    ),
    "g_mining_key_83": MessageLookupByLibrary.simpleMessage(
      "تصدیق کنندہ پہلے سے موجود ہے۔",
    ),
    "g_mining_key_84": MessageLookupByLibrary.simpleMessage("کم خطرہ"),
    "g_mining_key_85": MessageLookupByLibrary.simpleMessage("اعتدال کا خطرہ"),
    "g_mining_key_86": MessageLookupByLibrary.simpleMessage("7 دن کے انعامات"),
    "g_mining_key_87": MessageLookupByLibrary.simpleMessage("ہائی رسک"),
    "g_mining_key_88": MessageLookupByLibrary.simpleMessage(
      "معاہدہ لوڈ ہو رہا ہے اور اس وقت اس کی تصدیق نہیں ہو سکتی۔ براہ کرم ایک لمحہ انتظار کریں!",
    ),
    "g_mining_key_89": MessageLookupByLibrary.simpleMessage("حفاظتی نکات"),
    "g_mining_key_9": MessageLookupByLibrary.simpleMessage("پس منظر کی توثیق"),
    "g_mining_key_90": MessageLookupByLibrary.simpleMessage(
      "براہ کرم اپنی نجی کلید یا یادداشت کے جملہ کو محفوظ رکھیں۔",
    ),
    "g_mining_key_91": MessageLookupByLibrary.simpleMessage(
      "آپ کی پرائیویٹ کلید یا یادداشت کا جملہ ہی آپ کے بٹوے کے اثاثوں تک رسائی کے لیے واحد سند ہے۔",
    ),
    "g_mining_key_92": MessageLookupByLibrary.simpleMessage(
      "براہ کرم اسے محفوظ جگہ پر رکھیں (کاغذ، پاس ورڈ مینیجر، وغیرہ)۔",
    ),
    "g_mining_key_93": MessageLookupByLibrary.simpleMessage(
      "اسکرین شاٹس نہ لیں، انہیں انٹرنیٹ پر اپ لوڈ نہ کریں، یا انہیں کسی کے ساتھ شیئر نہ کریں۔",
    ),
    "g_mining_key_94": MessageLookupByLibrary.simpleMessage(
      "ایک بار گم ہو جانے یا سمجھوتہ کرنے کے بعد، آپ کے بٹوے کے اثاثے دوبارہ حاصل نہیں کیے جا سکتے۔",
    ),
    ...
    "g_mining_key_96": MessageLookupByLibrary.simpleMessage(
      "پاس ورڈ سیٹ کریں اور انکرپٹ کریں۔",
    ),
    ...
    "g_mining_node_key2": MessageLookupByLibrary.simpleMessage("نوڈ ID"),
    ...
    "g_phishing_warning_body": MessageLookupByLibrary.simpleMessage(
      "اس ویب سائٹ کی شناخت ممکنہ طور پر نقصان دہ کے طور پر کی گئی ہے۔ ہو سکتا ہے یہ آپ کے کرپٹو اثاثوں یا نجی چابیاں چرانے کی کوشش کر رہا ہو۔",
    ),
    ...
    "g_pnl_add_trade": MessageLookupByLibrary.simpleMessage("تجارت شامل کریں۔"),
    "g_pnl_avg_cost": MessageLookupByLibrary.simpleMessage("اوسط لاگت"),
    ...
    "g_portfolio_gainers": MessageLookupByLibrary.simpleMessage("ٹاپ گائنرز"),
    "g_portfolio_losers": MessageLookupByLibrary.simpleMessage("ٹاپ لوزرز"),
    ...
    "g_portfolio_others": MessageLookupByLibrary.simpleMessage("دوسرے"),
    ...
    "g_pred_err_invalid_state": MessageLookupByLibrary.simpleMessage(
      "مارکیٹ کا تصفیہ ہو چکا ہے، اس عمل کی اجازت نہیں",
    ),
    ...
    "g_pred_err_not_resolver": MessageLookupByLibrary.simpleMessage(
      "صرف یہ مارکیٹ بنانے والا میزبان یہ عمل کر سکتا ہے",
    ),
    ...
    "g_share_v2_key_5": MessageLookupByLibrary.simpleMessage("شیئر کریں۔"),
    "g_share_v3_key_2": MessageLookupByLibrary.simpleMessage("حوالہ"),
    "g_share_v3_key_3": MessageLookupByLibrary.simpleMessage(
      "دوستوں سے رجوع کریں اور N ٹوکن حاصل کریں!",
    ),
    "g_share_v3_key_4": MessageLookupByLibrary.simpleMessage("تم اٹھو "),
    "g_share_v3_key_5": MessageLookupByLibrary.simpleMessage(
      " N جب آپ کے حوالہ کی تصدیق شروع ہوتی ہے!",
    ),
    ...
    "g_swap_key_16": MessageLookupByLibrary.simpleMessage(
      "آگے بڑھ کر، آپ درج ذیل سے اتفاق کرتے ہیں۔ ",
    ),
    "g_swap_key_17": MessageLookupByLibrary.simpleMessage("شرائط و ضوابط۔"),
    "g_swap_key_18": MessageLookupByLibrary.simpleMessage("ختم کرنا"),
    ...
    "g_swap_key_22": MessageLookupByLibrary.simpleMessage("ختم"),
    "g_swap_key_23": MessageLookupByLibrary.simpleMessage("بلا معاوضہ"),
    "g_swap_key_24": MessageLookupByLibrary.simpleMessage("ادائیگی کی تصدیق"),
    "g_swap_key_25": MessageLookupByLibrary.simpleMessage("تقسیم کیا جائے۔"),
    "g_swap_key_28": MessageLookupByLibrary.simpleMessage("تبادلہ کا خلاصہ"),
    ...
    "g_swap_key_33": MessageLookupByLibrary.simpleMessage("N میں تبدیل کریں۔"),
    "g_swap_key_35": MessageLookupByLibrary.simpleMessage("تبادلہ"),
    "g_swap_key_4": MessageLookupByLibrary.simpleMessage("آپ حاصل کریں"),
    "g_swap_key_5": MessageLookupByLibrary.simpleMessage("پیش نظارہ سویپ"),
    "g_swap_key_6": MessageLookupByLibrary.simpleMessage("دوبارہ کوشش کریں۔"),
    "g_theme_accent_color": MessageLookupByLibrary.simpleMessage("لہجے کا رنگ"),
    "g_theme_accent_reset": MessageLookupByLibrary.simpleMessage(
      "ڈیفالٹ پر ری سیٹ کریں۔",
    ),
    "g_theme_mode": MessageLookupByLibrary.simpleMessage("ظاہری شکل"),
    "g_theme_style": MessageLookupByLibrary.simpleMessage("انداز"),
    "g_theme_style_custom": MessageLookupByLibrary.simpleMessage("حسب ضرورت"),
    "g_token_m_key_1": m71,
    ...
    "g_token_m_key_11": MessageLookupByLibrary.simpleMessage("ٹوکنز"),
    "g_token_m_key_12": MessageLookupByLibrary.simpleMessage("ٹوکن تلاش کریں۔"),
    "g_token_m_key_13": MessageLookupByLibrary.simpleMessage("سلسلہ کا نام"),
    "g_token_m_key_14": MessageLookupByLibrary.simpleMessage("زنجیر کی علامت"),
    ...
    "g_token_m_key_2": MessageLookupByLibrary.simpleMessage("0~18 یونٹ"),
    ...
    "g_token_m_key_6": MessageLookupByLibrary.simpleMessage("ٹوکن ایڈریس"),
    "g_token_m_key_7": MessageLookupByLibrary.simpleMessage("ٹوکن کی علامت"),
    "g_token_m_key_8": MessageLookupByLibrary.simpleMessage("ٹوکن اعشاریہ"),
    "g_token_m_key_9": MessageLookupByLibrary.simpleMessage("درآمد کریں۔"),
    "g_token_m_key_chainid_conflict": MessageLookupByLibrary.simpleMessage(
      "یہ Chain ID پہلے سے کسی دوسرے نیٹ ورک کے استعمال میں ہے۔",
    ),
    ...
    "g_ui_backup_invalid_file": MessageLookupByLibrary.simpleMessage(
      "یہ درست N42Wallet بیک اپ فائل نہیں",
    ),
    ...
    "g_ui_coins_load_failed": MessageLookupByLibrary.simpleMessage(
      "کوائن لوڈ نہیں ہو سکے۔ دوبارہ کوشش کریں۔",
    ),
    ...
    "g_ui_create_wallet": MessageLookupByLibrary.simpleMessage("والیٹ بنائیں"),
    "g_ui_csv_header_only": MessageLookupByLibrary.simpleMessage(
      "ڈیٹا کی کوئی قطار نہیں ملی (صرف عنوان کی قطار ملی ہے)۔",
    ),
    "g_ui_csv_missing_fields": m81,
    "g_ui_csv_no_data": MessageLookupByLibrary.simpleMessage(
      "تبصرے ہٹانے کے بعد کوئی ڈیٹا نہیں ملا۔",
    ),
    "g_ui_custom_tag": MessageLookupByLibrary.simpleMessage(
      "اپنی مرضی کا ٹیگ…",
    ),
    "g_ui_days": m82,
    "g_ui_destination_tag": MessageLookupByLibrary.simpleMessage("منزل کا ٹیگ"),
    "g_ui_device_connected": m83,
    "g_ui_dex_description": MessageLookupByLibrary.simpleMessage(
      "Uniswap / 1inch / Jupiter کے ذریعے ٹوکن تبدیل کریں",
    ),
    "g_ui_email_code_accepted": MessageLookupByLibrary.simpleMessage(
      "تصدیقی کوڈ قبول ہو گیا",
    ),
    "g_ui_email_code_sent": MessageLookupByLibrary.simpleMessage(
      "تصدیقی کوڈ کی درخواست بھیج دی گئی",
    ),
    "g_ui_ens_price_failed": MessageLookupByLibrary.simpleMessage(
      "ENS کی تجدید کی قیمتیں لوڈ نہیں ہو سکیں۔ دوبارہ کوشش کریں۔",
    ),
    "g_ui_ens_renew_failed": MessageLookupByLibrary.simpleMessage(
      "ENS کی تجدید ناکام ہو گئی۔ دوبارہ کوشش کریں۔",
    ),
    "g_ui_entry_price": MessageLookupByLibrary.simpleMessage(
      "پوزیشن کھولنے کی قیمت",
    ),
    "g_ui_expires_in": MessageLookupByLibrary.simpleMessage("مدتِ اعتبار:"),
    "g_ui_fear_greed": MessageLookupByLibrary.simpleMessage("خوف اور لالچ"),
    "g_ui_file_picker_failed": MessageLookupByLibrary.simpleMessage(
      "فائل منتخب کرنے کا آلہ نہیں کھل سکا۔ دوبارہ کوشش کریں۔",
    ),
    "g_ui_file_read_failed": MessageLookupByLibrary.simpleMessage(
      "منتخب فائل پڑھی نہیں جا سکی۔ دوبارہ کوشش کریں۔",
    ),
    "g_ui_free_margin": MessageLookupByLibrary.simpleMessage("دستیاب"),
    "g_ui_gas_prediction": MessageLookupByLibrary.simpleMessage(
      "اگلے بلاک کی گیس فیس کی پیش گوئی",
    ),
    "g_ui_gas_value": m84,
    "g_ui_hours": m85,
    ...
    "g_ui_issues_label": MessageLookupByLibrary.simpleMessage("مسائل:"),
    "g_ui_keystone_paired": MessageLookupByLibrary.simpleMessage(
      "Keystone کامیابی سے پیئر ہو گیا",
    ),
    "g_ui_limit_orders": MessageLookupByLibrary.simpleMessage(
      "حد قیمت والے آرڈرز",
    ),
    "g_ui_limit_price": MessageLookupByLibrary.simpleMessage("حد قیمت"),
    ...
    "g_ui_memo": MessageLookupByLibrary.simpleMessage("یادداشت"),
    "g_ui_mempool": MessageLookupByLibrary.simpleMessage(
      "زیرِ التوا ٹرانزیکشنز کا پول",
    ),
    "g_ui_message": MessageLookupByLibrary.simpleMessage("پیغام"),
    "g_ui_min_balance_value": m90,
    "g_ui_mnemonic_wallet": MessageLookupByLibrary.simpleMessage(
      "بازیابی کے الفاظ والا والیٹ",
    ),
    "g_ui_mpc_intro": MessageLookupByLibrary.simpleMessage(
      "محفوظ MPC والیٹ بنانے کے لیے اپنے سوشل اکاؤنٹ سے سائن اِن کریں۔ آپ کی نجی کلید مرموز حصوں میں تقسیم ہوتی ہے، اس لیے بازیابی کے الفاظ کھونے کا خطرہ نہیں۔",
    ),
    "g_ui_mpc_no_phrase": MessageLookupByLibrary.simpleMessage(
      "بازیابی کے الفاظ کی ضرورت نہیں",
    ),
    "g_ui_mpc_security": MessageLookupByLibrary.simpleMessage(
      "MPC-TSS استعمال ہوتا ہے۔ آپ کی کلید 3 مرموز حصوں میں تقسیم ہو کر آپ کی ڈیوائس، ہمارے سرورز اور بازیابی کے بیک اپ میں رکھی جاتی ہے۔",
    ),
    "g_ui_new_email": MessageLookupByLibrary.simpleMessage("نیا ای میل پتہ"),
    "g_ui_no_cached_email": MessageLookupByLibrary.simpleMessage(
      "اس ڈیوائس پر کوئی ای میل محفوظ نہیں",
    ),
    "g_ui_no_coins": MessageLookupByLibrary.simpleMessage(
      "ابھی کوئی کوائن نہیں",
    ),
    "g_ui_no_dapps": MessageLookupByLibrary.simpleMessage("کوئی DApp نہیں"),
    "g_ui_no_limit_orders": MessageLookupByLibrary.simpleMessage(
      "کوئی حد قیمت والا آرڈر نہیں",
    ),
    ...
    "g_ui_no_wallet": MessageLookupByLibrary.simpleMessage(
      "ابھی کوئی والیٹ نہیں",
    ),
    "g_ui_optional": MessageLookupByLibrary.simpleMessage("اختیاری"),
    ...
    "g_ui_orders_load_failed": MessageLookupByLibrary.simpleMessage(
      "حد قیمت والے آرڈرز لوڈ نہیں ہو سکے",
    ),
    ...
    "g_ui_paste_connection": MessageLookupByLibrary.simpleMessage(
      "کنکشن کا لنک پیسٹ کریں",
    ),
    "g_ui_pending_mempool": MessageLookupByLibrary.simpleMessage(
      "زیرِ التوا (ٹرانزیکشن پول)",
    ),
    "g_ui_popular_tokens": MessageLookupByLibrary.simpleMessage("مقبول ٹوکن"),
    "g_ui_position_size": MessageLookupByLibrary.simpleMessage("مقدار"),
    "g_ui_positions_count": m92,
    "g_ui_private_key_wallet": MessageLookupByLibrary.simpleMessage(
      "نجی کلید والا والیٹ",
    ),
    "g_ui_read_only": MessageLookupByLibrary.simpleMessage("صرف دیکھنے کے لیے"),
    "g_ui_recipients_count": m93,
    "g_ui_room_id": MessageLookupByLibrary.simpleMessage("کمرے کی ID"),
    "g_ui_save_failed": MessageLookupByLibrary.simpleMessage(
      "محفوظ کرنا ناکام ہو گیا۔ دوبارہ کوشش کریں۔",
    ),
    "g_ui_send_code": MessageLookupByLibrary.simpleMessage("کوڈ بھیجیں"),
    ...
    "g_ui_swap_mode": MessageLookupByLibrary.simpleMessage(
      "سواپ کا طریقہ منتخب کریں",
    ),
    "g_ui_tags": MessageLookupByLibrary.simpleMessage("ٹیگز"),
    ...
    "g_ui_token_lookup": MessageLookupByLibrary.simpleMessage(
      "ٹوکن کی معلومات تلاش کی جا رہی ہیں…",
    ),
    "g_ui_token_manual": MessageLookupByLibrary.simpleMessage(
      "ٹوکن فہرست میں نہیں ملا؛ علامت اور اعشاری مقامات کی تعداد خود درج کریں",
    ),
    "g_ui_token_value": m95,
    "g_ui_trade_delete_failed": MessageLookupByLibrary.simpleMessage(
      "تجارت کا ریکارڈ حذف نہیں ہو سکا۔ دوبارہ کوشش کریں۔",
    ),
    "g_ui_trade_save_failed": MessageLookupByLibrary.simpleMessage(
      "تجارت کا ریکارڈ محفوظ نہیں ہو سکا۔ دوبارہ کوشش کریں۔",
    ),
    "g_ui_transaction_hash_value": m96,
    "g_ui_unknown_status": MessageLookupByLibrary.simpleMessage("نامعلوم حالت"),
    "g_ui_update": MessageLookupByLibrary.simpleMessage("اپ ڈیٹ کریں"),
    ...
    "g_wc_no_sessions_desc": MessageLookupByLibrary.simpleMessage(
      "DApp سے جڑنے کے لیے QR کوڈ اسکین کریں۔",
    ),
    "g_wc_proposal_timeout": MessageLookupByLibrary.simpleMessage(
      "کنکشن کی درخواست کا وقت ختم ہو گیا۔",
    ),
    ...
    "push_bg_delivery_dialog_content": MessageLookupByLibrary.simpleMessage(
      "یہ ڈیوائس پس منظر میں چلنے والی ایپس پر پابندیاں لگاتی ہے، اس لیے ایپ کے پس منظر میں ہونے یا بند ہونے پر آپ سے چیٹ کے پیغامات اور منتقلی کی اطلاعات چھوٹ سکتی ہیں۔\n\nپس منظر میں سرگرمی کی اجازت دینے کے لیے «ترتیبات پر جائیں» دبائیں، پھر اس ایپ کے لیے خودکار آغاز فعال کریں۔",
    ),
    "push_bg_delivery_dialog_title": MessageLookupByLibrary.simpleMessage(
      "پس منظر میں اطلاعات کی ترسیل محدود ہو سکتی ہے",
    ),
    ...
    "w_item_2": MessageLookupByLibrary.simpleMessage(
      "اگر میں اپنے بیج کے فقرے کو ظاہر کرتا ہوں یا کسی کو بتاتا ہوں تو میرے فنڈز چوری ہو سکتے ہیں۔",
    ),
    "w_item_3": MessageLookupByLibrary.simpleMessage(
      "یہ میری ذمہ داری ہے کہ میں اپنے بیج کے جملہ کو محفوظ رکھوں۔",
    ),
    "w_key_12": MessageLookupByLibrary.simpleMessage("بیج کا جملہ غلط ہے۔"),
    "w_key_8": MessageLookupByLibrary.simpleMessage(
      "آپ جس بٹوے کو درآمد کرنا چاہتے ہیں اس کے لیے بیج کا جملہ درج کریں۔",
    ),
  };
}
