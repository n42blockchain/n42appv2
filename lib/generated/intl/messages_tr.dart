...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m22(value) => "${value}. satırda geçersiz adres";

  static String m23(value) => "${value}. satırda geçersiz miktar";

  static String m24(value) => "Maksimum ${value} alıcı";
  ...
  static String m30(address) => "Hesap ${address} eklendi";
  ...
  static String m34(value) => "Hesap içe aktarılamadı: ${value}";

  static String m35(date) => "Last connected: ${date}";

  static String m36(value) => "Lütfen cihazınızda ${value} uygulamasını açın";

  static String m37(app) =>
  ...
  static String m41(value) => "Sonraki seviye için ${value} puan";
  ...
  static String m46(value) => "${value} gün kaldı";

  static String m47(value) => "${value} days remaining";

  static String m48(value) => "Yeterli \"${value}\" bakiyeniz yok";

  static String m49(value) => "\"${value}\" hesabı alınamadı";

  static String m50(value) => "İlk transfer için minimum ${value} XRP";
  ...
  static String m55(value) => "${value} zinciri eklenmedi.";

  static String m56(value) =>
      "${value} için tamamlanmamış işlemler var, lütfen daha sonra tekrar deneyin.";

  static String m57(value) => "${value} için adres bulunamadı.";

  static String m58(value) => "${value} bakiyesi yetersiz.";
  ...
  static String m67(value) => "İçe aktarma başarısız:${value}";
  ...
  static String m70(value) => "${value} karakter olmalı";

  static String m71(value) => "${value} Yetersiz Bakiye.";

  static String m72(value) => "${value} geliyor...";
  ...
  static String m74(value) => "Maksimum ${value} karakter";
  ...
  static String m77(value) => "${value} adres test bağlantısı başarısız!";

  static String m78(value) =>
      "Uygulama ${value} saniye içinde kilidini açacak.";

  static String m79(value) =>
      "Desen şifresi giriş hatası, ${value} hakkınız kaldı";

  static String m80(value) => "Şifre giriş hatası, ${value} hakkınız kaldı";

  static String m81(value) => "Şifre giriş hatası, ${value} hakkınız kaldı";

  static String m82(value) => "${value} şifresini girin";
