...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m27(value) => "연락처 ${value}을(를) 삭제하시겠습니까?";

  static String m28(value) => "${value}d unbond";

  static String m29(value) => "${value}일 남음";
  ...
  static String m33(value) => "첫 송금 시 최소 ${value} XRP 필요";
  ...
  static String m38(value) => "${value} 체인이 추가되지 않았습니다.";

  static String m39(value) => "${value}에 미완료 거래가 있습니다. 나중에 다시 시도하세요.";

  static String m40(value) => "${value}에 대한 주소를 찾을 수 없습니다.";

  static String m41(value) => "${value} 잔액이 부족합니다.";
  ...
  static String m45(value) => "패턴 비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m46(value) => "패턴 비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m47(value) => "${value}을(를) 성공적으로 설정했으며 N42Wallet으로 검증을 시작합니다!";

  static String m48(value) =>
      "@N42Wallet에서 내 ${value} 그룹에 참여하여 레이어 1 체인의 초기 채굴자가 되고, 폰으로 암호화폐를 받으세요!";

  static String m49(value) => "검증자를 실행하려면 ${value} N을 잠그세요.";

  static String m50(value) => "가져오기 실패:${value}";

  static String m51(value) => "보상을 받으려면 최소 ${value}의 스테이킹 잔액이 필요합니다.";

  static String m52(value, value1) => "${value1}블록 채굴 시 ${value} N";
  ...
  static String m61(value) => "${value}초 후 앱이 잠금 해제됩니다.";

  static String m62(value) => "패턴 비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m63(value) => "비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m64(value) => "비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m65(value) => "${value} 비밀번호 입력";

  static String m66(value) => "0~${value}자";
