...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m27(value) => "보상을 받으려면 최소 ${value}의 스테이킹 잔액이 필요합니다.";

  static String m28(value, value1) => "${value1}블록 채굴 시 ${value} N";

  static String m29(value) => "${value}자여야 합니다";

  static String m30(value) => "${value} 잔액이 부족합니다.";

  static String m31(value) => "${value} 입금 중...";

  static String m32(value) =>
      "앱 내에서 스왑된 ${value}은(는) 곧 지갑으로 분배되며 이 프로세스를 통해 판매할 수 없습니다. 노드 운영에 사용할 수 있습니다.";

  static String m33(value) => "최대 ${value}자";

  static String m34(value) => "${value} 체인은 앱에서 이미 지원됩니다!";

  static String m35(value) => "${value} 체인은 앱에서 이미 지원됩니다. 추가하시겠습니까?";

  static String m36(value) => "${value} 주소 테스트 링크 실패!";

  static String m37(value) => "${value}초 후 앱이 잠금 해제됩니다.";

  static String m38(value) => "패턴 비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m39(value) => "비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m40(value) => "비밀번호 입력 오류, ${value}번의 기회가 남았습니다";

  static String m41(value) => "${value} 비밀번호 입력";

  static String m42(value) => "0~${value}자";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "code_403":
            MessageLookupByLibrary.simpleMessage("계정이 하루 동안 일시적으로 잠겼습니다"),
        "code_err_tips":
            MessageLookupByLibrary.simpleMessage("코드가 올바르지 않습니다. 다시 시도하세요."),
        ...
        "email_verification_message2":
            MessageLookupByLibrary.simpleMessage("이메일 인증을 추가하시겠습니까?"),
        ...
        "g_browser_key14":
            MessageLookupByLibrary.simpleMessage("DApp 연결을 확인하세요"),
        ...
        "g_chat_key_14":
            MessageLookupByLibrary.simpleMessage("최소 2명의 연락처를 선택하세요"),
        ...
        "g_chat_key_34":
            MessageLookupByLibrary.simpleMessage("채팅 기록을 삭제하시겠습니까?"),
        ...
        "g_chat_key_57":
            MessageLookupByLibrary.simpleMessage("신고했습니다 - 클릭하여 보기"),
        ...
        "g_connect_key14":
            MessageLookupByLibrary.simpleMessage("페어링 중, 잠시 기다려 주세요."),
        ...
        "g_face_10":
            MessageLookupByLibrary.simpleMessage("인증을 위해 지문 또는 얼굴을 스캔하세요."),
        ...
        "g_face_7":
            MessageLookupByLibrary.simpleMessage("계속하려면 얼굴 또는 지문을 스캔하세요."),
        "g_face_8": MessageLookupByLibrary.simpleMessage("돌아가기"),
        "g_face_9":
            MessageLookupByLibrary.simpleMessage("생체 인식을 다시 활성화하는 것이 좋습니다."),
        ...
        "g_face_match_key17":
            MessageLookupByLibrary.simpleMessage("이 지갑에 얼굴 데이터를 연결했습니다."),
        ...
        "g_face_match_key22":
            MessageLookupByLibrary.simpleMessage("왜 얼굴 바인딩이 필요한가요?"),
        ...
        "g_face_match_key24":
            MessageLookupByLibrary.simpleMessage("내 얼굴 데이터는 어떻게 저장되며 안전한가요?"),
        ...
        "g_face_match_key26":
            MessageLookupByLibrary.simpleMessage("얼굴 바인딩이 계정 보안에 어떤 영향을 미치나요?"),
        ...
        "g_face_match_key28":
            MessageLookupByLibrary.simpleMessage("내 얼굴 데이터는 안전한가요?"),
        ...
        "g_face_match_key34":
            MessageLookupByLibrary.simpleMessage("얼굴 데이터 인증 실패!"),
        "g_face_match_key35":
            MessageLookupByLibrary.simpleMessage("얼굴 데이터 바인딩 해제 실패!"),
        ...
        "g_key_203":
            MessageLookupByLibrary.simpleMessage("링크 오류, QR 코드를 다시 스캔하세요."),
        ...
        "g_key_46": m9,
        "g_key_47":
            MessageLookupByLibrary.simpleMessage("이 거래를 처리하기에 잔액이 부족합니다."),
        ...
        "g_key_error_12":
            MessageLookupByLibrary.simpleMessage("인증되지 않음, 로그인하세요"),
        "g_key_error_13": MessageLookupByLibrary.simpleMessage("접근 거부"),
        "g_key_error_1301":
            MessageLookupByLibrary.simpleMessage("계정 또는 비밀번호가 틀렸습니다"),
        ...
        "g_key_error_21":
            MessageLookupByLibrary.simpleMessage("HTTP 버전이 지원되지 않음"),
        "g_key_error_22": MessageLookupByLibrary.simpleMessage("요청 실패, 오류 코드:"),
        "g_key_error_23":
            MessageLookupByLibrary.simpleMessage("시스템이 바쁩니다. 나중에 다시 시도하세요"),
        "g_key_error_24":
            MessageLookupByLibrary.simpleMessage("요청 빈도가 너무 빠릅니다"),
        "g_key_error_25": MessageLookupByLibrary.simpleMessage("디코딩 실패"),
        "g_key_error_26":
            MessageLookupByLibrary.simpleMessage("거래가 이미 체인에 있습니다"),
        ...
        "g_key_error_5":
            MessageLookupByLibrary.simpleMessage("서버 이상입니다. 나중에 다시 시도하세요!"),
        "g_key_error_8":
            MessageLookupByLibrary.simpleMessage("요청이 취소되었습니다. 다시 요청하세요!"),
        ...
        "g_key_ex_keystore_10":
            MessageLookupByLibrary.simpleMessage("비밀번호 관리 도구를 사용하여 저장하세요."),
        ...
        "g_key_ex_keystore_15":
            MessageLookupByLibrary.simpleMessage("암호화된 개인키 파일."),
        ...
        "g_key_ex_keystore_18":
            MessageLookupByLibrary.simpleMessage("키스토어 정보를 입력하세요."),
        "g_key_ex_keystore_19":
            MessageLookupByLibrary.simpleMessage("개인키 내보내기"),
        ...
        "g_key_ex_keystore_7":
            MessageLookupByLibrary.simpleMessage("네트워크 전송을 사용하세요"),
        "g_key_ex_keystore_8": MessageLookupByLibrary.simpleMessage(
            "네트워크 도구를 통해 전송하세요. 해커가 획득하면 복구할 수 없는 경제적 손실이 발생합니다"),
        "g_key_ex_keystore_9":
            MessageLookupByLibrary.simpleMessage("도구를 사용하여 저장"),
        "g_key_feedback": MessageLookupByLibrary.simpleMessage("피드백"),
        "g_key_feedback_1":
            MessageLookupByLibrary.simpleMessage("피드백 정보를 입력하세요"),
        "g_key_feedback_2":
            MessageLookupByLibrary.simpleMessage("업로드되지 않은 첨부 파일이 있습니다"),
        ...
        "g_key_keystore_19":
            MessageLookupByLibrary.simpleMessage("현재 통화 지갑이 이미 존재합니다."),
        "g_key_keystore_21":
            MessageLookupByLibrary.simpleMessage("키스토어를 읽을 수 없습니다"),
        ...
        "g_key_personal_1":
            MessageLookupByLibrary.simpleMessage("휴대폰 갤러리에서 선택"),
        ...
        "g_key_squad_k11":
            MessageLookupByLibrary.simpleMessage("파일이 너무 커서 업로드할 수 없습니다"),
        "g_key_squad_k15": m10,
        ...
        "g_key_t_33":
            MessageLookupByLibrary.simpleMessage("지갑 비밀번호는 비워둘 수 없습니다"),
        ...
        "g_key_t_37":
            MessageLookupByLibrary.simpleMessage("최신 블록 가스 수수료 비율 평균"),
        ...
        "g_key_tran_6":
            MessageLookupByLibrary.simpleMessage("거래 영수증은 내역에서 확인하세요"),
        ...
        "g_key_u_7":
            MessageLookupByLibrary.simpleMessage("아티스트 신청을 하려면 여기를 클릭하세요"),
        ...
        "g_key_user_p3":
            MessageLookupByLibrary.simpleMessage("개인정보 처리방침 및 개인정보 수집 안내"),
        ...
        "g_key_wallet_c11":
            MessageLookupByLibrary.simpleMessage("시드 문구를 기록하고 안전하게 보관하세요."),
        "g_key_wallet_c12":
            MessageLookupByLibrary.simpleMessage("시드 문구를 다시 입력하세요."),
        ...
        "g_key_wallet_c16":
            MessageLookupByLibrary.simpleMessage("이제 지갑을 마음껏 사용할 수 있습니다."),
        ...
        "g_key_wallet_c25":
            MessageLookupByLibrary.simpleMessage("백업하여 지갑을 보호하세요"),
        "g_key_wallet_c26": MessageLookupByLibrary.simpleMessage(
            "키스토어는 보안 인증서와 관련 개인키의 저장소입니다."),
        "g_key_wallet_c27":
            MessageLookupByLibrary.simpleMessage("1단계: 지갑 관리로 이동합니다."),
        "g_key_wallet_c28":
            MessageLookupByLibrary.simpleMessage("2단계: 지갑 주소를 선택합니다."),
        "g_key_wallet_c29":
            MessageLookupByLibrary.simpleMessage("3단계: 키스토어 내보내기를 누릅니다."),
        ...
        "g_key_wallet_c33":
            MessageLookupByLibrary.simpleMessage("시드 문구를 사용하여 지갑을 생성합니다."),
        "g_key_wallet_c34": MessageLookupByLibrary.simpleMessage("지갑 이름 입력"),
        "g_key_wallet_c35":
            MessageLookupByLibrary.simpleMessage("지갑 시드 문구를 백업하지 않았습니다!"),
        ...
        "g_key_wallet_c39":
            MessageLookupByLibrary.simpleMessage("다음 시드 문구를 기록하세요"),
        ...
        "g_key_wallet_c44":
            MessageLookupByLibrary.simpleMessage("클릭하여 시드 문구 보기"),
        "g_key_wallet_c45":
            MessageLookupByLibrary.simpleMessage("주변에 다른 사람이나 카메라가 없는지 확인하세요"),
        ...
        "g_key_wallet_c49":
            MessageLookupByLibrary.simpleMessage("먼저 지갑 시드 문구를 백업하세요!"),
        "g_key_wallet_c6": MessageLookupByLibrary.simpleMessage("시드 문구 확인"),
        "g_key_wallet_c7":
            MessageLookupByLibrary.simpleMessage("시드 문구를 입력하세요."),
        ...
        "g_key_wallet_m1": m14,
        "g_key_wallet_m11":
            MessageLookupByLibrary.simpleMessage("계정을 탈퇴하시겠습니까?"),
        "g_key_wallet_m13": MessageLookupByLibrary.simpleMessage("로그아웃 확인"),
        "g_key_wallet_m17":
            MessageLookupByLibrary.simpleMessage("Google 인증 코드를 입력하세요."),
        "g_key_wallet_m19": m15,
        "g_key_wallet_m2":
            MessageLookupByLibrary.simpleMessage("현재 토큰이 추가되지 않았습니다."),
        "g_key_wallet_m21":
            MessageLookupByLibrary.simpleMessage("단어 사이에 공백을 두고 시드 문구를 입력하세요"),
        "g_key_wallet_m22": MessageLookupByLibrary.simpleMessage("지갑 가져오기"),
        "g_key_wallet_m3": m16,
        "g_key_wallet_m4":
            MessageLookupByLibrary.simpleMessage("현재 토큰 잔액이 부족합니다."),
        "g_key_wallet_m5": m17,
        "g_key_wallet_m6": MessageLookupByLibrary.simpleMessage("서명 오류"),
        "g_key_wallet_m8": MessageLookupByLibrary.simpleMessage("계정 탈퇴"),
        "g_key_wallet_m9":
            MessageLookupByLibrary.simpleMessage("이메일 인증 코드를 입력하세요."),
        ...
        "g_lock_key1":
            MessageLookupByLibrary.simpleMessage("Touch ID 및 Face ID"),
        ...
        "g_lock_key18":
            MessageLookupByLibrary.simpleMessage("계정 보안을 위해 그룹 비밀번호를 설정하세요"),
        "g_lock_key19":
            MessageLookupByLibrary.simpleMessage("패턴 비밀번호 두 번째 그리기"),
        ...
        "g_lock_key24":
            MessageLookupByLibrary.simpleMessage("지갑 비밀번호를 추가하시겠습니까?"),
        "g_lock_key25": m22,
        ...
        "g_lock_key7":
            MessageLookupByLibrary.simpleMessage("생체 인식이 활성화되지 않았습니다"),
        ...
        "g_mining_key46":
            MessageLookupByLibrary.simpleMessage("설정에는 소량의 가스가 필요합니다."),
        ...
        "g_mining_key87":
            MessageLookupByLibrary.simpleMessage("그 전의 요청은 처리되지 않습니다."),
        ...
        "g_mining_key_105":
            MessageLookupByLibrary.simpleMessage("암호화된 데이터는 비워둘 수 없습니다!"),
        "g_mining_key_106":
            MessageLookupByLibrary.simpleMessage("비밀번호는 비워둘 수 없습니다!"),
        "g_mining_key_107":
            MessageLookupByLibrary.simpleMessage("복호화 실패. 비밀번호가 올바른지 확인하세요!"),
        "g_mining_key_108":
            MessageLookupByLibrary.simpleMessage("지원되지 않는 암호화 데이터 형식입니다!"),
        ...
        "g_mining_key_43":
            MessageLookupByLibrary.simpleMessage("이 거래에 필요한 N이 부족합니다"),
        ...
        "g_mining_key_6":
            MessageLookupByLibrary.simpleMessage("N을 잠그고 검증 보상을 시작하세요."),
        ...
        "g_mining_key_78":
            MessageLookupByLibrary.simpleMessage("먼저 검증자의 공개키와 개인키 쌍을 저장하세요."),
        "g_mining_key_79": MessageLookupByLibrary.simpleMessage("내보내기"),
        "g_mining_key_80":
            MessageLookupByLibrary.simpleMessage("송금에 필요한 자금이 부족합니다."),
        ...
        "g_mining_key_90":
            MessageLookupByLibrary.simpleMessage("개인키 또는 시드 문구를 안전하게 보관하세요."),
        ...
        "g_mining_key_96":
            MessageLookupByLibrary.simpleMessage("비밀번호 설정 및 암호화"),
        "g_mining_key_97":
            MessageLookupByLibrary.simpleMessage("암호화 비밀번호를 입력하세요"),
        "g_mining_key_98": m29,
        "g_mining_key_99":
            MessageLookupByLibrary.simpleMessage("비밀번호가 올바른지 확인하기 위해 다시 입력하세요"),
        ...
        "g_share_v3_key_3":
            MessageLookupByLibrary.simpleMessage("친구를 추천하고 N 토큰을 받으세요!"),
        "g_share_v3_key_4": MessageLookupByLibrary.simpleMessage("최대 "),
        "g_share_v3_key_5":
            MessageLookupByLibrary.simpleMessage(" 추천인이 검증을 시작하면 N을 받습니다!"),
        ...
        "g_swap_key_16":
            MessageLookupByLibrary.simpleMessage("진행 시 다음에 동의하게 됩니다 "),
        "g_swap_key_17": MessageLookupByLibrary.simpleMessage("이용약관."),
        "g_swap_key_18": MessageLookupByLibrary.simpleMessage("완료"),
        "g_swap_key_19":
            MessageLookupByLibrary.simpleMessage("스왑이 곧 분배됩니다. 잠시만 기다려 주세요."),
        "g_swap_key_20": m31,
        ...
        "g_unlock_key10": m37,
        "g_unlock_key2":
            MessageLookupByLibrary.simpleMessage("지문 또는 얼굴 인식이 활성화되지 않았습니까?"),
        ...
        "google_verification":
            MessageLookupByLibrary.simpleMessage("Google 인증"),
        "google_verification_message10":
            MessageLookupByLibrary.simpleMessage("연결"),
        "google_verification_message11":
            MessageLookupByLibrary.simpleMessage("Google Authenticator 다운로드"),
        "google_verification_message12":
            MessageLookupByLibrary.simpleMessage("안내"),
        "google_verification_message13":
            MessageLookupByLibrary.simpleMessage("Google Authenticator를 엽니다."),
        "google_verification_message14":
            MessageLookupByLibrary.simpleMessage("화면에 6자리 인증 코드가 표시됩니다."),
        ...
        "google_verification_message17":
            MessageLookupByLibrary.simpleMessage("백업 키"),
        "google_verification_message18":
            MessageLookupByLibrary.simpleMessage("키를 Google Authenticator에 복사"),
        "google_verification_message19":
            MessageLookupByLibrary.simpleMessage("Google 인증 코드 입력"),
        "google_verification_message20":
            MessageLookupByLibrary.simpleMessage("이메일 인증 코드 입력"),
        "google_verification_message21": m41,
        "google_verification_message3":
            MessageLookupByLibrary.simpleMessage("Google 키 가져오기 실패"),
        "google_verification_message5":
            MessageLookupByLibrary.simpleMessage("2단계 인증(2FA)"),
        ...
        "google_verification_message8":
            MessageLookupByLibrary.simpleMessage("다운로드 및 설치"),
        ...
        "login_invite_code_title":
            MessageLookupByLibrary.simpleMessage("추천 코드"),
        ...
        "login_message_7":
            MessageLookupByLibrary.simpleMessage("코드가 성공적으로 전송되었습니다"),
        ...
        "selected_user_protocol":
            MessageLookupByLibrary.simpleMessage("약관을 읽고 확인하세요"),
        "verification": MessageLookupByLibrary.simpleMessage("인증"),
        ...
        "w_key_8":
            MessageLookupByLibrary.simpleMessage("가져오려는 지갑의 시드 문구를 입력하세요.")
      };
}
