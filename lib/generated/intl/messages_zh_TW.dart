...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m54(symbol) => "投入金額（${symbol}）";

  static String m55(amount, symbol) => "餘額：${amount} ${symbol}";

  static String m56(label) => "判定「${label}」獲勝並結算？此操作不可撤銷。";

  static String m57(n) => "${n} 分鐘";

  static String m58(n) => "結果 ${n}";

  static String m59(label, pct) => "${label} 獲勝（${pct}%）";
  ...
  static String m62(n) => "賣出 ${n}";

  static String m63(value) => "${value} 餘額不足。";

  static String m64(value) => "${value} 即將轉入...";

  static String m65(value) =>
      "在 App 內兌換的 ${value} 將很快發放到您的錢包，且無法透過此流程出售。它可用於運行節點。";

  static String m66(value) => "最大 ${value} 個字符";

  static String m67(value) => "已支援${value}鏈APP！";

  static String m68(value) => "已支援${value}鏈APP，是否要新增？";

  static String m69(value) => "${value}地址測試連結失敗！";

  static String m70(value) => "0~${value} 個字符";
