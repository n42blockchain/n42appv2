...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(value) => "Otwórz aplikację ${value} na urządzeniu";

  static String m21(value) => "Earn ${value} points";

  static String m22(value) => "Earn ${value} points for each friend who joins!";

  static String m23(value) => "${value} punktów do następnego poziomu";

  static String m24(value) => "Czy na pewno chcesz usunąć kontakt ${value}?";

  static String m25(value) => "${value}d unbond";

  static String m26(value) => "Pozostało ${value} dni";

  static String m27(value) => "${value} days remaining";

  static String m28(value) => "Nie masz wystarczającej ilości \"${value}\"";

  static String m29(value) => "Nie udało się pobrać konta \"${value}\"";

  static String m30(value) => "Minimum ${value} XRP dla pierwszego transferu";
  ...
  static String m35(value) => "Nie dodano sieci ${value}.";

  static String m36(value) =>
      "${value} ma niezakończone transakcje, spróbuj ponownie później.";

  static String m37(value) => "Nie znaleziono adresu dla ${value}.";

  static String m38(value) => "Niewystarczające saldo ${value}.";
  ...
  static String m46(value) => "Zablokuj ${value} N, aby uruchomić walidatora.";

  static String m47(value) => "Import nie powiódł się:${value}";
  ...
  static String m50(value) => "Musi mieć ${value} znaków";

  static String m51(value) => "Niewystarczające saldo ${value}.";

  static String m52(value) => "${value} w drodze...";
  ...
  static String m54(value) => "Maks. ${value} znaków";
  ...
  static String m60(value) => "Błąd wprowadzenia hasła, masz ${value} prób";

  static String m61(value) => "Błąd wprowadzenia hasła, masz ${value} próbę";

  static String m62(value) => "Wprowadź hasło ${value}";
