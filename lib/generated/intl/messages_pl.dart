...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(value) => "Jestem ${value}";

  static String m2(value) => "Członek czatu (${value})";
  ...
  static String m5(value) => "Powiązanie udane. Adres powiązania: ${value}";

  static String m6(value) => "Brak sieci N42chain w portfelu ${value}!";

  static String m7(value) => "Dopasowanie udane. Adres:${value}.";

  static String m8(value) => "Kwota większa niż ${value}.";

  static String m9(value) =>
      "Portfel już istnieje, nazwa portfela to \"${value}\"";

  static String m10(value) => "Wprowadź kwotę większą niż ${value}.";
  ...
  static String m16(value) => "Pozostało ${value} dni";

  static String m17(value) => "Zduplikowany adres w wierszu ${value}";

  static String m18(value) => "Nieprawidłowy adres w wierszu ${value}";

  static String m19(value) => "Nieprawidłowa kwota w wierszu ${value}";

  static String m20(value) => "Maksymalnie ${value} odbiorców";
  ...
  static String m26(address) => "Konto ${address} dodane";
  ...
  static String m30(value) => "Nie udało się zaimportować konta: ${value}";

  static String m31(date) => "Last connected: ${date}";

  static String m32(value) => "Otwórz aplikację ${value} na urządzeniu";
  ...
  static String m37(value) => "${value} punktów do następnego poziomu";

  static String m38(amount, token) => "≈ ${amount}${token}";

  static String m39(amount) => "≈ ${amount} USDT";

  static String m40(value) => "Czy na pewno chcesz usunąć kontakt ${value}?";

  static String m41(value) => "${value}d unbond";

  static String m42(value) => "Pozostało ${value} dni";

  static String m43(value) => "${value} days remaining";

  static String m44(value) => "Nie masz wystarczającej ilości \"${value}\"";

  static String m45(value) => "Nie udało się pobrać konta \"${value}\"";

  static String m46(value) => "Minimum ${value} XRP dla pierwszego transferu";
  ...
  static String m51(value) => "Nie dodano sieci ${value}.";

  static String m52(value) =>
      "${value} ma niezakończone transakcje, spróbuj ponownie później.";

  static String m53(value) => "Nie znaleziono adresu dla ${value}.";
  ...
  static String m62(value) => "Zablokuj ${value} N, aby uruchomić walidatora.";

  static String m63(value) => "Import nie powiódł się:${value}";
  ...
  static String m66(value) => "Musi mieć ${value} znaków";

  static String m67(value) => "Niewystarczające saldo ${value}.";

  static String m68(value) => "${value} w drodze...";
  ...
  static String m70(value) => "Maks. ${value} znaków";
  ...
  static String m76(value) => "Błąd wprowadzenia hasła, masz ${value} prób";

  static String m77(value) => "Błąd wprowadzenia hasła, masz ${value} próbę";

  static String m78(value) => "Wprowadź hasło ${value}";

  static String m79(value) => "0~${value} znaków";
