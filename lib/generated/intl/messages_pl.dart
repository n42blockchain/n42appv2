...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(value) => "Pozostało ${value} dni";

  static String m11(value) => "Zduplikowany adres w wierszu ${value}";
  ...
  static String m17(value) => "Otwórz aplikację ${value} na urządzeniu";

  static String m18(value) => "${value} punktów do następnego poziomu";

  static String m19(value) => "Czy na pewno chcesz usunąć kontakt ${value}?";

  static String m20(value) => "${value}d unbond";

  static String m21(value) => "Pozostało ${value} dni";

  static String m22(value) => "${value} days remaining";

  static String m23(value) => "Nie masz wystarczającej ilości \"${value}\"";

  static String m24(value) => "Nie udało się pobrać konta \"${value}\"";

  static String m25(value) => "Minimum ${value} XRP dla pierwszego transferu";

  static String m26(value) => "Verification code sent to ${value}";

  static String m27(value) => "Nie dodano sieci ${value}.";

  static String m28(value) =>
      "${value} ma niezakończone transakcje, spróbuj ponownie później.";

  static String m29(value) => "Nie znaleziono adresu dla ${value}.";
  ...
  static String m38(value) => "Zablokuj ${value} N, aby uruchomić walidatora.";

  static String m39(value) => "Import nie powiódł się:${value}";
  ...
  static String m42(value) => "Musi mieć ${value} znaków";

  static String m43(value) => "Niewystarczające saldo ${value}.";

  static String m44(value) => "${value} w drodze...";
  ...
  static String m46(value) => "Maks. ${value} znaków";
  ...
  static String m52(value) => "Błąd wprowadzenia hasła, masz ${value} prób";

  static String m53(value) => "Błąd wprowadzenia hasła, masz ${value} próbę";

  static String m54(value) => "Wprowadź hasło ${value}";

  static String m55(value) => "0~${value} znaków";
