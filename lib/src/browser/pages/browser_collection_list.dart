...
import 'package:n42_wallet/src/browser/pages/browser_collection_info.dart';
        ...
        return InkWell(
          onTap: ()async{
            if(widget.type==0){
              ...
              String? edit=await Navigator.push(context, MaterialPageRoute(builder: (context)=>BrowserCollectionInfo(bcm)));
              if(edit != null){
                if(edit == "delete"){
