...
import 'package:n42_wallet/src/wallet/api/chain_api/apt_api.dart';
import 'package:n42_wallet/src/wallet/api/chain_api/atom_api.dart';
import 'package:n42_wallet/src/wallet/api/chain_api/btc_api.dart';
import 'package:n42_wallet/src/wallet/api/chain_api/dot_api.dart';
...
import 'package:n42_wallet/src/wallet/api/chain_api/ton_api.dart';
...
import 'package:n42_wallet/src/wallet/utils/validation/signature_validator.dart';
...
class TransferApi {
  ...
  //tron 转账
  Future<MessageModel> transferTrx(String fromAddress, String toAddress, double value,
      int decimals, String path,
  ...
  //trx提交
  Future<MessageModel> transferTrxSend(String fromAddress, String toAddress, BigInt valuePrice, String path,BigInt totalGasPrice,
      {String contractAddress = "",String isTest="main",String? privateKey})async{
    //签名
