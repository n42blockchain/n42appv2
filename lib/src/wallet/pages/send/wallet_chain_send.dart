...
class WalletChainSend extends StatefulWidget {
  CoinModel coinModel;
  WalletChainSend(this.coinModel,{super.key});

  @override
  State<WalletChainSend> createState() => _WalletChainSendState();
}

class _WalletChainSendState extends State<WalletChainSend> {
