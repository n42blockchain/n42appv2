...
class MiningToken extends GeneratedContract {
  ...
  MiningToken.init(
      ...
      : super(
      DeployedContract(
          ContractAbi.fromJson(abiString, 'Token'), address),
      client,
      chainId);

  /// 质押 deposit
  Future deposit(String pubKey, String signature, BigInt value,
    ...
    var tx = Transaction(
      value: EtherAmount.inWei(astNum),
    );
