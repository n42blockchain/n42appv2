...
class AAConfig {
  ...
  static String getSimpleAccountFactory({EntryPointVersion? version}) {
    final v = version ?? defaultVersion;
    return v == EntryPointVersion.v08
        ? simpleAccountFactoryV08
        : simpleAccountFactoryV07;
  }
  ...
  @Deprecated(
    'Bundler requests now go through server proxy with automatic failover',
  )
  ...
  static AAChainConfig? getTestnetConfig(
    String symbol, {
  ...
  @Deprecated(
    'API key migrated to server proxy. Use ProxyConfig.bundler() instead.',
  )
...
class AAChainConfig {
  ...
  String? get simple7702AccountFactory => version == EntryPointVersion.v08
