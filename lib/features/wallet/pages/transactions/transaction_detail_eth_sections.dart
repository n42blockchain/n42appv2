...
extension _TransactionDetailEthSections on _TransactionDetailEthState {
          ...
          children: [
            Expanded(
              child: OutlinedButton(
                onPressed: _navigateToRetry,
                style: OutlinedButton.styleFrom(
                  side: BorderSide(color: accent),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(su.setWidth(8)),
                  ),
                  minimumSize: Size(double.infinity, su.setWidth(88)),
                ),
                child: Text(s.g_key_79,
                    style: TextStyle(fontSize: su.setSp(28), color: accent)),
              ),
            ),
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.bolt_rounded,
                        color: Colors.white, size: su.setWidth(28)),
                    SizedBox(width: su.setWidth(6)),
                    Text(s.g_key_wallet_k57,
                        style: TextStyle(fontSize: su.setSp(28), color: Colors.white)),
                  ],
                ),
              ),
            ),
  ...
  Future<void> _navigateToRetry() async {
