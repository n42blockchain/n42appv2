...
Map<String, dynamic> walletChainConfigsPart1 = {
  CoinType.N.name: <String, dynamic>{
    ...
    "mainnets": <String, dynamic>{
      "0XD44F4FDB883994A5BA529D76FE58E2D16575A1D1": <String, dynamic>{
        "mKey": "0XD44F4FDB883994A5BA529D76FE58E2D16575A1D1",
        "blockchainType": BlockchainType.Ethereum.name,
        "coinType": CoinType.N.name,
        "icon": "assets/wallet/s_coin.png",
        "name": "S Coin",
        "miniName": "S Coin",
        "unit": "S Coin",
        "symbol": "11X",
        ...
        "chainId": 94,
        "chainId_test": 1142,
        "contract": "0xD44F4fdB883994a5bA529d76Fe58e2D16575a1d1",
        "contract_test": "",
        "canEdit": false,
        "rules": "ERC20",
      },
  ...
  CoinType.SOL.name: <String, dynamic>{
    ...
    "mainnets": <String, dynamic>{},
    "mainnetContract": {},
    "testnetContract": {"SOL": "7ViD4q77VfADUiE2euhBVmrvYrrMJW3bFbjcgvujmAyZ"},
  },
  ...
  CoinType.SUI.name: {
    ...
    "testnets": [
      {
        "testnetWS": "",
        "testnetRPC": "https://fullnode.testnet.sui.io",
        "testnetChainID": 0,
        "testnetContract": {},
      },
    ],
  ...
  CoinType.APT.name: {
    ...
    "testnets": [
      {
        "testnetWS": "",
        "testnetRPC": "https://fullnode.testnet.aptoslabs.com",
        "testnetChainID": 2,
        "testnetContract": {},
      },
    ],
