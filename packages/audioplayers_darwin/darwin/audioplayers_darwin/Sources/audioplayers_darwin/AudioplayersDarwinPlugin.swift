...
public class AudioplayersDarwinPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    #if os(iOS)
      // iOS 27 beta currently crashes during this Swift plugin registration
      // before Dart starts. Keep the app launchable on beta devices; audio
      // playback from audioplayers will remain unavailable on this OS until
      // the upstream plugin or Flutter runtime supports it.
