...
class ChatBloc extends Bloc<ChatEvent, ChatState> {
  ...
  /// 最大重试次数（引用 AppConstants 保持一致）
  static const int _maxRetryCount = AppConstants.maxRetryCount;
  ...
  ChatBloc({
    ...
    on<SendCodeBlockMessage>(onSendCodeBlockMessage);
    on<SendTipMessage>(onSendTipMessage);
    ...
    on<MarkViewOnceConsumed>(onMarkViewOnceConsumed);
