...
class TokenGateRule extends Equatable {
  ...
  factory TokenGateRule.fromJson(Map<String, dynamic> json) => TokenGateRule(
        ...
        minBalance: BigInt.tryParse(json['min_balance'] as String? ?? '0') ?? BigInt.zero,
...
class TokenGateConfig extends Equatable {
  ...
  @override
  List<Object?> get props => [enabled, rules, operator, setBy, setAt, denialMessage];
  ...
  factory TokenGateConfig.fromJson(Map<String, dynamic> json) => TokenGateConfig(
