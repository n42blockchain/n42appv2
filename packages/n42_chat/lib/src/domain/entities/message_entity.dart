...
class MessageEntity extends Equatable {
  ...
  /// 查看一次：仅允许接收端查看一次后即失效（全局视图）。
  final bool viewOnce;

  /// 查看一次：是否已经被消费（本地+服务端同步的最终态）。
  ...
  MessageEntity copyWith({
    ...
    return MessageEntity(
      ...
      viewOnceConsumed: viewOnceConsumed ?? this.viewOnceConsumed,
...
class MessageMetadata extends Equatable {
  ...
  /// 贴纸资源类型：image / gif / webp / apng / lottie
  final String? stickerKind;
  ...
  /// Lottie 静态回退缩略图 URL（HTTP），供不支持 Lottie 的客户端回退。
  final String? stickerFallbackHttpUrl;

  // ============================================
  // 代码块属性
  // ============================================

  /// 代码语言（如 dart, python, javascript，用于语法高亮）
