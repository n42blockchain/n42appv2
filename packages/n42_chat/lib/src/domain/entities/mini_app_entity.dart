...
class MiniAppEntity extends Equatable {
  ...
  factory MiniAppEntity.fromJson(Map<String, dynamic> json) => MiniAppEntity(
        id: json['id'] as String,
        name: json['name'] as String? ?? '',
        description: json['description'] as String? ?? '',
        url: json['url'] as String? ?? '',
        iconUrl: json['icon_url'] as String? ?? '',
        category: MiniAppCategory.values.firstWhere(
          (c) => c.name == json['category'],
          orElse: () => MiniAppCategory.tools,
        ),
        permissions: (json['permissions'] as List?)
                ?.map((p) => MiniAppPermission.values.firstWhere(
                      (e) => e.name == p,
                      orElse: () => MiniAppPermission.chatRead,
                    ))
                .toList() ??
            const [],
