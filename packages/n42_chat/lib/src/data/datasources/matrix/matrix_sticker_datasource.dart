      ...
      images.forEach((key, value) {
        if (value is Map<String, dynamic>) {
          ...
          if (url != null) {
            ...
            // 识别 Lottie 贴纸：mimetype=application/lottie+json 或
            // 自定义命名空间 org.n42.sticker.kind=lottie
            final n42 = value['org.n42.sticker'] as Map<String, dynamic>?;
            final kindStr = n42?['kind'] as String?;
            StickerAssetKind? kind;
            if (kindStr != null) {
              kind = StickerAssetKind.values.firstWhere(
                (k) => k.name == kindStr,
                orElse: () => StickerAssetKind.image,
              );
            }
            final fallback = n42?['fallback_http_url'] as String? ??
                (value['org.n42.sticker.thumbnail'] as String?);
            stickers.add(
              Sticker(
                id: key,
                url: url,
