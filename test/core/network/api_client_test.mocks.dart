...
// in n42_wallet/test/core/network/api_client_test.dart.
...
import 'package:n42_wallet/core/security/secure_storage.dart' as _i8;
...
class MockSecureStorage extends _i1.Mock implements _i8.SecureStorage {
  ...
  @override
  _i9.Future<void> saveUuid(String? uuid) => (super.noSuchMethod(
    Invocation.method(#saveUuid, [uuid]),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);

  @override
  _i9.Future<String?> getUuid() => (super.noSuchMethod(
    Invocation.method(#getUuid, []),
    returnValue: _i9.Future<String?>.value(),
  ) as _i9.Future<String?>);

  @override
  _i9.Future<void> deleteUuid() => (super.noSuchMethod(
    Invocation.method(#deleteUuid, []),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);
  ...
  @override
  _i9.Future<void> saveUserInfo(Map<String, dynamic>? userInfo) =>
      (super.noSuchMethod(
  ...
  @override
  _i9.Future<Map<String, dynamic>?> getUserInfo() => (super.noSuchMethod(
    Invocation.method(#getUserInfo, []),
    returnValue: _i9.Future<Map<String, dynamic>?>.value(),
  ) as _i9.Future<Map<String, dynamic>?>);

  @override
  _i9.Future<void> saveWalletCredentials({
    required String? address,
    required Map<String, dynamic>? credentials,
  }) => (super.noSuchMethod(
    Invocation.method(#saveWalletCredentials, [], {
      #address: address,
  ...
  @override
  _i9.Future<Map<String, dynamic>?> getWalletCredentials(String? address) =>
      (super.noSuchMethod(
        Invocation.method(#getWalletCredentials, [address]),
        returnValue: _i9.Future<Map<String, dynamic>?>.value(),
      ) as _i9.Future<Map<String, dynamic>?>);

  @override
  _i9.Future<void> deleteWalletCredentials(String? address) =>
      (super.noSuchMethod(
        Invocation.method(#deleteWalletCredentials, [address]),
        returnValue: _i9.Future<void>.value(),
        returnValueForMissingStub: _i9.Future<void>.value(),
      ) as _i9.Future<void>);

  @override
  _i9.Future<void> saveMnemonic({
    required String? walletId,
    required String? mnemonic,
  }) => (super.noSuchMethod(
    Invocation.method(#saveMnemonic, [], {
      #walletId: walletId,
      #mnemonic: mnemonic,
    }),
    returnValue: _i9.Future<void>.value(),
  ...
  @override
  _i9.Future<String?> getMnemonic(String? walletId) => (super.noSuchMethod(
    Invocation.method(#getMnemonic, [walletId]),
    returnValue: _i9.Future<String?>.value(),
  ) as _i9.Future<String?>);

  @override
  _i9.Future<void> deleteMnemonic(String? walletId) => (super.noSuchMethod(
    Invocation.method(#deleteMnemonic, [walletId]),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);

  @override
  _i9.Future<void> savePrivateKey({
    required String? address,
  ...
  @override
  _i9.Future<String?> getPrivateKey(String? address) => (super.noSuchMethod(
    Invocation.method(#getPrivateKey, [address]),
    returnValue: _i9.Future<String?>.value(),
  ) as _i9.Future<String?>);

  @override
  _i9.Future<void> deletePrivateKey(String? address) => (super.noSuchMethod(
    Invocation.method(#deletePrivateKey, [address]),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);

  @override
  _i9.Future<void> setBiometricEnabled(bool? enabled) => (super.noSuchMethod(
  ...
  @override
  _i9.Future<bool> isBiometricEnabled() => (super.noSuchMethod(
    Invocation.method(#isBiometricEnabled, []),
    returnValue: _i9.Future<bool>.value(false),
  ) as _i9.Future<bool>);

  @override
  _i9.Future<void> saveDeviceId(String? deviceId) => (super.noSuchMethod(
  ...
  @override
  _i9.Future<String?> getDeviceId() => (super.noSuchMethod(
    Invocation.method(#getDeviceId, []),
    returnValue: _i9.Future<String?>.value(),
  ) as _i9.Future<String?>);

  @override
  _i9.Future<void> savePasskeyCredentials(String? credentialsJson) =>
      (super.noSuchMethod(
        Invocation.method(#savePasskeyCredentials, [credentialsJson]),
        returnValue: _i9.Future<void>.value(),
        returnValueForMissingStub: _i9.Future<void>.value(),
      ) as _i9.Future<void>);

  @override
  _i9.Future<String?> getPasskeyCredentials() => (super.noSuchMethod(
    Invocation.method(#getPasskeyCredentials, []),
    returnValue: _i9.Future<String?>.value(),
  ) as _i9.Future<String?>);

  @override
  _i9.Future<void> deletePasskeyCredentials() => (super.noSuchMethod(
    Invocation.method(#deletePasskeyCredentials, []),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);

  @override
  _i9.Future<void> setPasskeyEnabled(bool? enabled) => (super.noSuchMethod(
    Invocation.method(#setPasskeyEnabled, [enabled]),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);

  @override
  _i9.Future<bool> isPasskeyEnabled() => (super.noSuchMethod(
    Invocation.method(#isPasskeyEnabled, []),
    returnValue: _i9.Future<bool>.value(false),
  ) as _i9.Future<bool>);
  ...
  @override
  _i9.Future<void> saveIdHubToken(String? did, String? tokenJson) =>
      (super.noSuchMethod(
        Invocation.method(#saveIdHubToken, [did, tokenJson]),
        returnValue: _i9.Future<void>.value(),
        returnValueForMissingStub: _i9.Future<void>.value(),
      ) as _i9.Future<void>);

  @override
  _i9.Future<String?> getIdHubToken(String? did) => (super.noSuchMethod(
    Invocation.method(#getIdHubToken, [did]),
    returnValue: _i9.Future<String?>.value(),
  ) as _i9.Future<String?>);

  @override
  _i9.Future<void> deleteIdHubToken(String? did) => (super.noSuchMethod(
    Invocation.method(#deleteIdHubToken, [did]),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);
  ...
  @override
  _i9.Future<bool> hasCredentials() => (super.noSuchMethod(
...
class MockDio extends _i1.Mock implements _i7.Dio {
  ...
  @override
  _i9.Future<_i6.Response<T>> query<T>(
    String? path, {
    Object? data,
    Map<String, dynamic>? queryParameters,
    _i2.Options? options,
  ...
  @override
  _i9.Future<_i6.Response<T>> queryUri<T>(
    Uri? uri, {
    Object? data,
    _i2.Options? options,
    _i10.CancelToken? cancelToken,
