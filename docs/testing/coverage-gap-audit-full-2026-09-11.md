...
|---|---:|---:|---:|---:|
| `overall` | 19.73% | 19.82% | 24143 / 121822 | +0.09 |

## 模块与本批重点范围（这些范围有包含关系，不可相加）

| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `wallet_home` | 73.23% | 77.15% | 770 / 998 | +3.93 |
| `wallet_refresh` | 52.90% | 60.45% | 379 / 627 | +7.55 |
...
| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `core` | 58.10% | 58.07% | 2500 / 4305 | -0.02 |
...
| `lib/features/wallet/pages/wallet_coin_item.dart` | 91.77% | 91.77% | 145 / 158 | +0.00 |
...
| `lib/features/wallet/pages/wallet_page_helpers.dart` | 43.04% | 77.01% | 67 / 87 | +33.97 |
| `lib/features/wallet/provider/wallet_action_provider.dart` | 20.95% | 21.33% | 45 / 211 | +0.37 |
| `lib/features/wallet/provider/wallet_action_provider_market.dart` | 54.59% | 64.35% | 148 / 230 | +9.76 |
