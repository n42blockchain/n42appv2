...
|---|---:|---:|---:|---:|
| `overall` | 20.30% | 20.35% | 24874 / 122234 | +0.05 |
...
| `wallet_aggregate` | 85.90% | 85.90% | 603 / 702 | +0.00 |
...
| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `core` | 58.10% | 59.06% | 2579 / 4367 | +0.96 |
...
| `features/wallet` | 20.26% | 20.26% | 10699 / 52798 | +0.00 |
| `features/wallet_connect` | 31.54% | 31.54% | 628 / 1991 | +0.00 |
| `features/widgets` | 13.88% | 13.88% | 197 / 1419 | +0.00 |
| `generated` | 15.57% | 15.57% | 5949 / 38202 | +0.00 |
| `main.dart` | 1.07% | 1.02% | 2 / 196 | -0.05 |
...
| `lib/features/wallet/services/aggregated_balance_reader.dart` | 100.00% | 100.00% | 73 / 73 | +0.00 |
...
| `lib/features/wallet_connect/pages/wallet_connect_widgets_mixin.dart` | 65.99% | 65.99% | 196 / 297 | +0.00 |
