...
|---|---:|---:|---:|---:|
| `overall` | 18.59% | 18.78% | 22848 / 121651 | +0.19 |

## 模块与本批重点范围（这些范围有包含关系，不可相加）

| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `solana` | 0.00% | 96.46% | 218 / 226 | +96.46 |
...
| `lib/features/wallet/api/sender/sol_sender.dart` | 0.00% | 94.34% | 100 / 106 | +94.34 |
