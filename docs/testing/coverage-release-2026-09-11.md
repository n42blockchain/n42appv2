...
|---|---:|---:|---:|---:|
| `overall` | 20.35% | 45.09% | 58930 / 130685 | +24.74 |
...
| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `core` | 59.06% | 59.08% | 2580 / 4367 | +0.02 |
| `features/ai_assistant` | 28.25% | 27.90% | 89 / 319 | -0.35 |
| `features/airdrop` | 69.55% | 69.55% | 201 / 289 | +0.00 |
| `features/auth` | 100.00% | 100.00% | 52 / 52 | +0.00 |
| `features/bridge` | 45.76% | 45.76% | 723 / 1580 | +0.00 |
| `features/browser` | 22.63% | 22.62% | 489 / 2162 | -0.01 |
| `features/component` | 2.61% | 2.61% | 8 / 306 | +0.00 |
| `features/earn` | 3.33% | 3.31% | 29 / 875 | -0.01 |
| `features/hardware_wallet` | 25.18% | 25.14% | 676 / 2689 | -0.04 |
| `features/home` | 25.74% | 25.53% | 604 / 2366 | -0.22 |
| `features/identity` | 66.82% | 66.51% | 282 / 424 | -0.32 |
| `features/live` | 23.24% | 23.21% | 611 / 2633 | -0.04 |
...
| `features/wallet` | 20.27% | 21.09% | 11162 / 52930 | +0.82 |
| `features/wallet_connect` | 31.54% | 31.54% | 628 / 1991 | +0.00 |
| `features/widgets` | 13.88% | 17.83% | 253 / 1419 | +3.95 |
| `generated` | 15.57% | 84.94% | 39485 / 46486 | +69.37 |
...
| `lib/features/wallet/models/dex/dex_limit_order_model.dart` | 83.33% | 62.50% | 15 / 24 | -20.83 |
...
| `lib/features/wallet/pages/dex_swap/dex_limit_orders_page.dart` | 98.10% | 97.14% | 170 / 175 | -0.96 |
...
| `lib/features/wallet_connect/pages/wallet_connect_widgets_mixin.dart` | 65.99% | 66.22% | 196 / 296 | +0.22 |
