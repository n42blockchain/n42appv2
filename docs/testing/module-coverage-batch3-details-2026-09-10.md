...
|---|---:|---:|---:|---:|
| `overall` | 18.40% | 18.59% | 22600 / 121580 | +0.19 |
...
| `security` | 76.35% | 88.36% | 1093 / 1237 | +12.01 |
| `bridge` | 45.76% | 45.76% | 723 / 1580 | +0.00 |
| `wallet_connect` | 18.73% | 18.73% | 373 / 1991 | +0.00 |
| `security_setup` | 30.78% | 38.01% | 195 / 513 | +7.23 |
...
| `security/totp` | 17.07% | 100.00% | 55 / 55 | +82.93 |
| `security/goplus_client` | 11.43% | 89.58% | 43 / 48 | +78.15 |
| `security/phishing_dialog` | 0.00% | 100.00% | 86 / 86 | +100.00 |
| `security_setup/google_auth` | 69.30% | 100.00% | 117 / 117 | +30.70 |

## 完整功能模块台账

| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `core` | 54.13% | 57.72% | 2485 / 4305 | +3.59 |
...
| `features/home` | 24.12% | 25.70% | 604 / 2350 | +1.59 |
...
| `features/wallet` | 17.10% | 17.10% | 8944 / 52302 | +0.00 |
| `features/wallet_connect` | 18.73% | 18.73% | 373 / 1991 | +0.00 |
| `features/widgets` | 13.25% | 13.25% | 188 / 1419 | +0.00 |
| `generated` | 15.13% | 15.19% | 5789 / 38115 | +0.06 |
| `main.dart` | 0.53% | 0.53% | 1 / 187 | +0.00 |
| `presentation` | 97.12% | 97.12% | 135 / 139 | +0.00 |
| `shared` | 57.52% | 59.40% | 158 / 266 | +1.88 |
...
| `lib/core/security/goplus_security_service.dart` | 11.43% | 89.58% | 43 / 48 | +78.15 |
| `lib/core/security/phishing_detector.dart` | 53.93% | 53.93% | 48 / 89 | +0.00 |
| `lib/core/security/phishing_warning_dialog.dart` | 0.00% | 100.00% | 86 / 86 | +100.00 |
...
| `lib/core/security/totp_util.dart` | 17.07% | 100.00% | 55 / 55 | +82.93 |
...
| `lib/features/home/setting/security/google_auth_setup_page.dart` | 69.30% | 100.00% | 117 / 117 | +30.70 |
