...
|---|---:|---:|---:|---:|
| `overall` | 19.02% | 19.22% | 23389 / 121704 | +0.20 |

## 模块与本批重点范围（这些范围有包含关系，不可相加）

| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `wallet_refresh` | 5.61% | 45.76% | 248 / 542 | +40.15 |
...
| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `core` | 57.72% | 57.79% | 2488 / 4305 | +0.07 |
...
| `lib/features/wallet/provider/wallet_action_provider.dart` | 14.01% | 18.57% | 39 / 210 | +4.56 |
| `lib/features/wallet/provider/wallet_action_provider_market.dart` | 0.00% | 41.55% | 86 / 207 | +41.55 |
| `lib/features/wallet/widgets/wallet_board.dart` | 0.00% | 98.40% | 123 / 125 | +98.40 |
