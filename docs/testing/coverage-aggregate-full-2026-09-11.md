...
|---|---:|---:|---:|---:|
| `overall` | 19.82% | 20.30% | 24795 / 122163 | +0.48 |

## 模块与本批重点范围（这些范围有包含关系，不可相加）

| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `wallet_aggregate` | — | 85.90% | 603 / 702 | — |
| `wallet_home` | 77.15% | 77.79% | 781 / 1004 | +0.63 |
| `wallet_refresh` | 60.45% | 64.01% | 402 / 628 | +3.57 |
...
| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `core` | 58.07% | 58.10% | 2501 / 4305 | +0.02 |
...
| `features/wallet` | 19.26% | 20.26% | 10698 / 52798 | +1.00 |
| `features/wallet_connect` | 31.54% | 31.54% | 628 / 1991 | +0.00 |
| `features/widgets` | 13.88% | 13.88% | 197 / 1419 | +0.00 |
| `generated` | 15.42% | 15.57% | 5949 / 38202 | +0.15 |
| `main.dart` | 1.07% | 1.07% | 2 / 187 | +0.00 |
...
| `lib/features/wallet/models/aggregated_coin_model.dart` | — | 98.33% | 118 / 120 | — |
...
| `lib/features/wallet/provider/wallet_action_provider.dart` | 21.33% | 21.80% | 46 / 211 | +0.47 |
| `lib/features/wallet/provider/wallet_action_provider_aggregated.dart` | — | 100.00% | 64 / 64 | — |
| `lib/features/wallet/provider/wallet_action_provider_market.dart` | 64.35% | 73.59% | 170 / 231 | +9.25 |
