...
|---|---:|---:|---:|---:|
| `overall` | 45.09% | 45.17% | 59032 / 130694 | +0.07 |

## 模块与本批重点范围（这些范围有包含关系，不可相加）

| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `deep_links` | 94.78% | 94.78% | 236 / 249 | +0.00 |
| `wallet_aggregate` | 85.92% | 85.92% | 604 / 703 | +0.00 |
| `wallet_home` | 77.79% | 77.79% | 781 / 1004 | +0.00 |
| `wallet_refresh` | 64.01% | 64.01% | 402 / 628 | +0.00 |
| `solana` | 96.46% | 96.46% | 218 / 226 | +0.00 |
| `history` | 99.04% | 99.04% | 414 / 418 | +0.00 |
| `dex` | 72.66% | 72.66% | 1414 / 1946 | +0.00 |
| `security` | 88.36% | 88.36% | 1093 / 1237 | +0.00 |
| `bridge` | 45.76% | 45.76% | 723 / 1580 | +0.00 |
| `wallet_connect` | 31.54% | 36.50% | 730 / 2000 | +4.96 |
| `security_setup` | 37.94% | 37.94% | 195 / 514 | +0.00 |
| `history/data` | 100.00% | 100.00% | 151 / 151 | +0.00 |
| `history/ui` | 98.50% | 98.50% | 263 / 267 | +0.00 |
| `dex/swap_page` | 72.18% | 72.18% | 397 / 550 | +0.00 |
| `dex/limit_orders` | 98.58% | 98.58% | 347 / 352 | +0.00 |
...
| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `core` | 59.08% | 59.08% | 2580 / 4367 | +0.00 |
| `features/ai_assistant` | 27.90% | 27.90% | 89 / 319 | +0.00 |
| `features/airdrop` | 69.55% | 69.55% | 201 / 289 | +0.00 |
| `features/auth` | 100.00% | 100.00% | 52 / 52 | +0.00 |
| `features/bridge` | 45.76% | 45.76% | 723 / 1580 | +0.00 |
| `features/browser` | 22.62% | 22.62% | 489 / 2162 | +0.00 |
| `features/component` | 2.61% | 2.61% | 8 / 306 | +0.00 |
| `features/earn` | 3.31% | 3.31% | 29 / 875 | +0.00 |
| `features/hardware_wallet` | 25.14% | 25.14% | 676 / 2689 | +0.00 |
| `features/home` | 25.53% | 25.53% | 604 / 2366 | +0.00 |
| `features/identity` | 66.51% | 66.51% | 282 / 424 | +0.00 |
| `features/live` | 23.21% | 23.21% | 611 / 2633 | +0.00 |
| `features/loyalty` | 69.50% | 69.50% | 294 / 423 | +0.00 |
| `features/mining` | 28.31% | 28.31% | 77 / 272 | +0.00 |
| `features/mining_v1` | 1.04% | 1.04% | 28 / 2683 | +0.00 |
...
| `features/wallet` | 21.09% | 21.09% | 11162 / 52930 | +0.00 |
| `features/wallet_connect` | 31.54% | 36.50% | 730 / 2000 | +4.96 |
| `features/widgets` | 17.83% | 17.83% | 253 / 1419 | +0.00 |
| `generated` | 84.94% | 84.94% | 39485 / 46486 | +0.00 |
| `main.dart` | 1.03% | 1.03% | 2 / 195 | +0.00 |
...
| 范围 | 基线 | 当前 | 已覆盖 / 可执行行 | 变化（百分点） |
|---|---:|---:|---:|---:|
| `lib/core/platform/deep_link_service.dart` | 97.18% | 97.18% | 138 / 142 | +0.00 |
| `lib/core/routing/deep_link_handler.dart` | 100.00% | 100.00% | 67 / 67 | +0.00 |
...
| `lib/features/home/setting/security/security_setting.dart` | 0.49% | 0.49% | 1 / 204 | +0.00 |
...
| `lib/features/wallet/models/aggregated_coin_model.dart` | 98.33% | 98.33% | 118 / 120 | +0.00 |
| `lib/features/wallet/models/aggregated_token.dart` | 94.12% | 94.12% | 16 / 17 | +0.00 |
| `lib/features/wallet/models/dex/dex_history_model.dart` | 100.00% | 100.00% | 18 / 18 | +0.00 |
| `lib/features/wallet/models/dex/dex_limit_order_model.dart` | 62.50% | 62.50% | 15 / 24 | +0.00 |
...
| `lib/features/wallet/pages/dex_swap/dex_limit_order_form.dart` | 100.00% | 100.00% | 177 / 177 | +0.00 |
| `lib/features/wallet/pages/dex_swap/dex_limit_orders_page.dart` | 97.14% | 97.14% | 170 / 175 | +0.00 |
...
| `lib/features/wallet/pages/wallet_aggregate_detail_page.dart` | 91.78% | 91.78% | 134 / 146 | +0.00 |
| `lib/features/wallet/pages/wallet_coin_item.dart` | 95.12% | 95.12% | 156 / 164 | +0.00 |
| `lib/features/wallet/pages/wallet_coin_list_header.dart` | 76.24% | 76.24% | 231 / 303 | +0.00 |
| `lib/features/wallet/pages/wallet_coin_list_section.dart` | 28.31% | 28.31% | 47 / 166 | +0.00 |
| `lib/features/wallet/pages/wallet_page_helpers.dart` | 77.01% | 77.01% | 67 / 87 | +0.00 |
| `lib/features/wallet/provider/wallet_action_provider.dart` | 21.80% | 21.80% | 46 / 211 | +0.00 |
| `lib/features/wallet/provider/wallet_action_provider_aggregated.dart` | 100.00% | 100.00% | 64 / 64 | +0.00 |
| `lib/features/wallet/provider/wallet_action_provider_market.dart` | 73.59% | 73.59% | 170 / 231 | +0.00 |
| `lib/features/wallet/provider/wallet_action_provider_sort.dart` | 35.59% | 35.59% | 42 / 118 | +0.00 |
| `lib/features/wallet/provider/wallet_price_refresh_scheduler.dart` | 100.00% | 100.00% | 18 / 18 | +0.00 |
| `lib/features/wallet/services/aggregated_balance_reader.dart` | 100.00% | 100.00% | 74 / 74 | +0.00 |
| `lib/features/wallet/widgets/feature_entry_cards.dart` | 96.55% | 96.55% | 112 / 116 | +0.00 |
| `lib/features/wallet/widgets/wallet_board.dart` | 100.00% | 100.00% | 168 / 168 | +0.00 |
...
| `lib/features/wallet_connect/provider/wallet_connect_gas_limit.dart` | — | 100.00% | 10 / 10 | — |
| `lib/features/wallet_connect/provider/wallet_connect_provider.dart` | 44.76% | 45.71% | 48 / 105 | +0.95 |
| `lib/features/wallet_connect/provider/wallet_connect_session.dart` | 7.16% | 15.04% | 63 / 419 | +7.88 |
| `lib/features/wallet_connect/provider/wallet_connect_signing.dart` | 0.00% | 17.68% | 58 / 328 | +17.68 |
