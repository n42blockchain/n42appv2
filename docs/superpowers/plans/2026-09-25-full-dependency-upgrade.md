...
Native SDK ordering note: [the SDK audit](../../testing/dependency-completion-2026-09-25/native-sdk-audit.md) found a compiled/runtime Android MobileSdk mismatch and reachable Go 1.19.4 binaries outside prior Maven/server-module scans. Address these after the current Chat push fix review and before exact-asset QR migration. Official release identity is an input to compatibility testing, not proof of runtime or store acceptance.
