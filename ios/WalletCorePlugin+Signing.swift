...
extension WalletCorePlugin {
    ...
    func signCosmosTransaction(wallet: HDWallet?,path:String,txData: [String: Any],pk: PrivateKey?)-> String?{
        ...
        let feeMap = txData["fee"] as! [String: Any]
        let gas : UInt64 = UInt64((feeMap["gas"] as! String))!
        let feeAmount : String = feeMap["amount"] as! String
        let feeDenom : String = feeMap["denom"] as! String
        let amountMap = txData["amount"] as! [String: Any]
        let amount : String = amountMap["amount"] as! String
        let amountDenom : String = amountMap["denom"] as! String
        let accountNumber : UInt64 = UInt64((txData["accountNumber"] as! String))!
    ...
    func signTezosTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],pk: PrivateKey?) -> String? {
        ...
        let counter: Int64 = Int64(txData["counter"] as! Int)
        let amount: Int64 = Int64(txData["amount"] as! Int)
        let toAddress: String = txData["toAddress"] as! String
        let fee : Int64 = Int64(txData["fee"] as! Int)
        let gasLimit : Int64 = Int64(txData["gasLimit"] as! Int)
        let storageLimit : Int64 = Int64(txData["storageLimit"] as! Int)
    ...
    func signXrpTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],pk: PrivateKey?) -> String? {
        ...
        let sequence : Int32 = Int32(txData["sequence"] as! Int)
        let ledgerIndex : Int32 = Int32(txData["ledgerIndex"] as! Int)
...
//                    $0.amount=Data(hexString: amount)!
       ...
       let cmd = txData["cmd"] as! String
        ...
        case "TRC20":
                ...
                let input = TronSigningInput.with {
                    $0.transaction = TronTransaction.with {
                        $0.feeLimit = Int64(txData["feeLimit"] as! Int)
                        $0.transferTrc20Contract = contract
                        $0.timestamp = Int64(txData["timestamp"] as! Int)
                        $0.blockHeader = TronBlockHeader.with {
                            $0.timestamp = Int64(txData["blockTime"] as! Int)
                            $0.number = Int64(txData["number"] as! Int)
                            $0.version = Int32(txData["version"] as! Int)
        ...
        case "FREEZE":
            let contract = TronFreezeBalanceContract.with {
                $0.frozenBalance = Int64(txData["frozenBalance"] as! Int)
                $0.frozenDuration = Int64(txData["frozenDuration"] as! Int)
                $0.ownerAddress = txData["ownerAddress"] as! String
    ...
    func signAlgorandTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],coinType:CoinType,privateKey: PrivateKey?) -> String? {
        ...
        let fee : UInt64 = UInt64(txData["fee"] as! Int)
        let round : UInt64 = UInt64(txData["round"] as! Int)
        let toAddress : String = txData["toAddress"] as! String
    ...
    func signFilecoinTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],coinType:CoinType,privateKey: PrivateKey?) -> String? {
        ...
        var input : FilecoinSigningInput = FilecoinSigningInput.with{
            ...
            $0.gasFeeCap = Data(hexString: gasFeeCap)!
            $0.gasPremium = Data(hexString: gasPremium)!
        }
    ...
    func signPolkadotTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],coinType:CoinType,privateKey: PrivateKey?) -> String? {
        ...
        let genesisHashStr : String = (txData["genesisHash"] as! String).replacingOccurrences(of: "0x", with: "")
        let genesisHash : Data = Data(hexString: genesisHashStr)!
        let blockHash : String = txData["blockHash"] as! String
        let nonce : UInt64 = UInt64(txData["nonce"] as! Int)
        let specVersion : UInt32 = UInt32(txData["specVersion"] as! Int)
        let transactionVersion : UInt32 = UInt32(txData["transactionVersion"] as! Int)
        let blockNumber : UInt64 = UInt64(txData["blockNumber"] as! Int)
        let toAddress : String = txData["toAddress"] as! String

        let input : PolkadotSigningInput = PolkadotSigningInput.with{
            $0.privateKey = pk.data
            $0.genesisHash = genesisHash
            $0.blockHash = Data(hexString: blockHash.replacingOccurrences(of: "0x", with: ""))!
            $0.nonce = nonce
            ...
            $0.balanceCall.transfer = PolkadotBalance.Transfer.with{
                $0.toAddress = toAddress
                $0.value = Data(hexString : amount.replacingOccurrences(of: "0x", with: ""))!
            }
        }
    ...
    func signSuiTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],privateKey: PrivateKey?) -> String? {
        ...
        let referenceGasPrice : UInt64 = UInt64(txData["referenceGasPrice"] as! Int)
        let gasBudget : UInt64 = UInt64(txData["gasBudget"] as! Int)
        let toAddress : String = txData["toAddress"] as! String
        let amount : UInt64 = UInt64(txData["amount"] as! Int)
        let utxos: [[String: Any]] = txData["utxo"] as! [[String: Any]]
        ...
        for utx in utxos {
            inputCoins.append(
                SuiObjectRef.with{
                    ...
                    $0.version = UInt64(utx["version"] as! String)!
    ...
    func signTonTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],privateKey: PrivateKey?) -> String? {
        ...
        let expireAt : UInt32 = UInt32(txData["expireAt"] as! Int)
        let sequenceNumber : UInt32 = UInt32(txData["sequenceNumber"] as! Int)
        let toAddress : String = txData["toAddress"] as! String
        ...
        if contractAddress==""{
            ...
            let jettonTransfer = TheOpenNetworkJettonTransfer.with {
                $0.jettonAmount = Data(hexString: amount)!
                $0.toOwner = toAddress
                $0.responseAddress = fromAddress
                $0.forwardAmount = Data(hexString: maxGasAmount)!
            }
    ...
    func signZilTransaction(wallet: HDWallet?, path: String, txData:  [String: Any],privateKey: PrivateKey?) -> String? {
        ...
        var pk: PrivateKey
        if privateKey == nil{
            pk=wallet!.getKey(coin: CoinType.zilliqa, derivationPath: path)
        }else{
            pk = privateKey!
        }
        let toAddress : String = txData["toAddress"] as! String
        ...
        let gasLimit : String = txData["gasLimit"] as! String
        let nonce : UInt64 = UInt64(txData["nonce"] as! Int)
        let version : UInt32 = UInt32(txData["version"] as! Int)
    ...
    func signNearTransaction(wallet: HDWallet?, path: String, txData: [String: Any], privateKey: PrivateKey?) -> String? {
        var pk: PrivateKey
        if privateKey == nil {
            pk = wallet!.getKey(coin: CoinType.near, derivationPath: path)
        } else {
            pk = privateKey!
        }
        ...
        let transfer = NEARTransfer.with {
            $0.deposit = Data(hexString: amount)!
        }
